...
function Versions(props) {
  ...
  const repoUrl = `https://github.com/${siteConfig.organizationName}/opencti`;
  return (
    <div className="docMainWrapper wrapper">
      <Container className="mainContainer versionsContainer">
        <div className="post">
          <header className="postHeader">
            <h1 style={{marginTop: 0}}>OpenCTI versions</h1>
          </header>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <a
                    href={`${siteConfig.baseUrl}${siteConfig.docsUrl}next/getting-started/introduction`}>
                    Documentation
                  </a>
                </td>
                <td>
