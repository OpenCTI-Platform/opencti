...
class Note(ListObjectsMixin, ListFilesMixin, StixObjectOrRelationshipMixin, Entity):
    ...
    OVERRIDES = {
        "queries": {
            "relation_add": "noteEdit(id: $id) { relationAdd(input: $input) { id } }",
            "relation_delete": (
                "noteEdit(id: $id) { relationDelete(toId: $toId, relationship_type: $relationship_type) { id } }"
            ),
        },
    }
    ...
    def create(self, **kwargs):
        ...
        :param revoked: (optional) whether the note is revoked
        :type revoked: bool
        ...
        :param abstract: (optional) abstract summary
        :type abstract: str
        :param content: the content of the Note (required)
        :type content: str
        :param authors: (optional) list of authors
        :type authors: list
        :param note_types: (optional) list of note types
        :type note_types: list
        :param likelihood: (optional) likelihood value
        :type likelihood: int
