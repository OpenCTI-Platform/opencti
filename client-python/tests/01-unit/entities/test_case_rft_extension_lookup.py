...
def test_case_rft_import_bulk_copies_ordinary_extension_fields():
    opencti = _OpenCTI()
    case_rft = CaseRft(opencti)
    case_rft.create = lambda **kwargs: kwargs
    stix_object = {
        "id": "case-rft--benchmark",
        "type": "case-rft",
        "name": "Benchmark Case RFT",
        ...
        "extensions": {
            _PRIMARY_EXTENSION: {
                ...
                "workflow_id": "workflow--case-rft",
            }
        },
    }

    result = case_rft.import_from_stix2(stixObject=stix_object)
    ...
    assert result["x_opencti_workflow_id"] == "workflow--case-rft"
