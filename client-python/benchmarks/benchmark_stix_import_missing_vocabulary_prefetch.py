"""Benchmark redundant vocabulary reads after bundle prefetch proves misses."""
...
class _OpenCTI:
    def __init__(self, request_delay_ms: float):
        ...
        self.app_logger = logging.getLogger(
            "benchmark_stix_import_missing_vocabulary_prefetch"
        )
    ...
    def logger_class(_name):
        return logging.getLogger(
            "benchmark_stix_import_missing_vocabulary_prefetch.worker"
        )
...
def _run_once(
    ...
    return (
        ...
        opencti.vocabulary.read_calls,
        opencti.vocabulary.create_calls,
    )
