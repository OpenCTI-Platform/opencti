...
You can find all the details on collected data and associated usage in the [data telemetry documentation](https://docs.opencti.io/latest/reference/data-telemetry/).
