const i18n = {
  messages: {
    fr: {
      ...
      'Origins of this intrusion set': 'Origines de ce mode opératoire',
      ...
      'Origins of this campaign': 'Origines de cette campagne',
