...
export const threatActorsCardsQuery = graphql`
    query ThreatActorsCardsPaginationQuery($count: Int!, $cursor: ID, $orderBy: ThreatActorsOrdering, $orderMode: OrderingMode) {
        ...ThreatActorsCards_data @arguments(count: $count, cursor: $cursor, orderBy: $orderBy, orderMode: $orderMode)
    }
`;
...
export default withStyles(styles)(createPaginationContainer(
  ...
  {
    data: graphql`
        fragment ThreatActorsCards_data on Query @argumentDefinitions(
