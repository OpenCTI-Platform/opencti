...
const campaignMutationFieldPatch = graphql`
    mutation CampaignEditionOverviewFieldPatchMutation($id: ID!, $input: EditInput!) {
        campaignEdit(id: $id) {
...
const campaignMutationRelationAdd = graphql`
    mutation CampaignEditionOverviewRelationAddMutation($id: ID!, $input: RelationAddInput!) {
        campaignEdit(id: $id) {
...
const campaignMutationRelationDelete = graphql`
    mutation CampaignEditionOverviewRelationDeleteMutation($id: ID!, $relationId: ID!) {
        campaignEdit(id: $id) {
...
class CampaignEditionOverviewComponent extends Component {
  ...
  handleSubmitField(name, value) {
    campaignValidation(this.props.t).validateAt(name, { [name]: value }).then(() => {
      commitMutation({
...
const CampaignEditionOverview = createFragmentContainer(CampaignEditionOverviewComponent, {
  campaign: graphql`
