...
export const sectorsCardsQuery = graphql`
    query SectorsCardsPaginationQuery($count: Int!, $cursor: ID, $orderBy: SectorsOrdering, $orderMode: OrderingMode) {
        ...SectorsCards_data @arguments(count: $count, cursor: $cursor, orderBy: $orderBy, orderMode: $orderMode)
    }
`;
...
export default withStyles(styles)(createPaginationContainer(
  ...
  {
    data: graphql`
        fragment SectorsCards_data on Query @argumentDefinitions(
