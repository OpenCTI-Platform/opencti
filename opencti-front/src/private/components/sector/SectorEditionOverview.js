...
const sectorMutationFieldPatch = graphql`
    mutation SectorEditionOverviewFieldPatchMutation($id: ID!, $input: EditInput!) {
        sectorEdit(id: $id) {
...
const sectorMutationRelationAdd = graphql`
    mutation SectorEditionOverviewRelationAddMutation($id: ID!, $input: RelationAddInput!) {
        sectorEdit(id: $id) {
...
const sectorMutationRelationDelete = graphql`
    mutation SectorEditionOverviewRelationDeleteMutation($id: ID!, $relationId: ID!) {
        sectorEdit(id: $id) {
...
class SectorEditionOverviewComponent extends Component {
  ...
  handleSubmitField(name, value) {
    sectorValidation(this.props.t).validateAt(name, { [name]: value }).then(() => {
      commitMutation({
...
const SectorEditionOverview = createFragmentContainer(SectorEditionOverviewComponent, {
  sector: graphql`
