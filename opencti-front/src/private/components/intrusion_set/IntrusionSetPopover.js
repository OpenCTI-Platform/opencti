  ...
  submitDelete() {
    ...
    commitMutation({
      ...
      onCompleted: () => {
        ...
        this.handleClose();
        this.props.history.push('/dashboard/knowledge/intrusionSets');
      },
    });
  }
    ...
    return (
      <div className={classes.container}>
        ...
        >
          <DialogContent>
            <DialogContentText>
              {t('Do you want to delete this intrusionSet?')}
            </DialogContentText>
          </DialogContent>
          <DialogActions>
        ...
        <Drawer open={this.state.displayEdit} anchor='right' classes={{ paper: classes.drawerPaper }} onClose={this.handleCloseEdit.bind(this)}>
          <QueryRenderer
            ...
            render={({ props }) => {
              if (props) { // Done
                return <IntrusionSetEditionContainer me={props.me} intrusionSet={props.intrusionSet}
