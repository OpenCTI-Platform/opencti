...
const toolMutationRelationAdd = graphql`
    mutation ToolEditionOverviewRelationAddMutation($id: ID!, $input: RelationAddInput!) {
        toolEdit(id: $id) {
...
const toolMutationRelationDelete = graphql`
    mutation ToolEditionOverviewRelationDeleteMutation($id: ID!, $relationId: ID!) {
        toolEdit(id: $id) {
...
class ToolEditionOverviewComponent extends Component {
  ...
  handleSubmitField(name, value) {
    toolValidation(this.props.t).validateAt(name, { [name]: value }).then(() => {
      commitMutation({
...
const ToolEditionOverview = createFragmentContainer(ToolEditionOverviewComponent, {
  tool: graphql`
