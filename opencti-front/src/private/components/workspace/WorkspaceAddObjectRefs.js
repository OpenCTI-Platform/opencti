...
import WorkspaceAddObjectRefsLines, { workspaceAddObjectRefsLinesQuery } from './WorkspaceAddObjectRefsLines';
...
class WorkspaceAddObjectRefs extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const {
      t, classes, workspaceId, workspaceObjectRefs,
    } = this.props;
                ...
                if (props) {
                  return (
                    <WorkspaceAddObjectRefsLines
                      ...
                      workspaceObjectRefs={workspaceObjectRefs}
                      data={props}
                    />
                  );
                }
...
WorkspaceAddObjectRefs.propTypes = {
