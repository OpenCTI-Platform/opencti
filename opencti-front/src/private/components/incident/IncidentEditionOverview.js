...
const incidentMutationFieldPatch = graphql`
    mutation IncidentEditionOverviewFieldPatchMutation($id: ID!, $input: EditInput!) {
        incidentEdit(id: $id) {
...
const incidentMutationRelationAdd = graphql`
    mutation IncidentEditionOverviewRelationAddMutation($id: ID!, $input: RelationAddInput!) {
        incidentEdit(id: $id) {
...
const incidentMutationRelationDelete = graphql`
    mutation IncidentEditionOverviewRelationDeleteMutation($id: ID!, $relationId: ID!) {
        incidentEdit(id: $id) {
...
class IncidentEditionOverviewComponent extends Component {
  ...
  handleSubmitField(name, value) {
    incidentValidation(this.props.t).validateAt(name, { [name]: value }).then(() => {
      commitMutation({
...
const IncidentEditionOverview = createFragmentContainer(IncidentEditionOverviewComponent, {
  incident: graphql`
