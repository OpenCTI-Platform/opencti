      ...
      >
        ...
        <MenuList component="nav">
          <MenuItem
            ...
            selected={
              location.pathname
              === `/dashboard/explore/victimology/${threatId}/distribution`
            }
            dense={false}
          >
          ...
          <MenuItem
            ...
            component={Link}
            disabled={!threatId}
            to={`/dashboard/explore/victimology/${threatId}/time`}
            selected={
              location.pathname
              === `/dashboard/explore/victimology/${threatId}/time`
            }
            dense={false}
          >
            <ListItemIcon classes={{ root: classes.listIcon }}>
          ...
          <MenuItem
            ...
            component={Link}
            disabled={!threatId}
            to={`/dashboard/explore/victimology/${threatId}/compare`}
            selected={
              location.pathname
              === `/dashboard/explore/victimology/${threatId}/compare`
            }
            dense={false}
          >
            <ListItemIcon classes={{ root: classes.listIcon }}>
