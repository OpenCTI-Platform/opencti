...
class ProfileOverviewComponent extends Component {
  ...
  render() {
    ...
    const initialValues = pick(['name', 'description', 'email', 'firstname', 'lastname', 'language'], me);
    return (
      <div>
        ...
        <Paper classes={{ root: classes.panel }} elevation={2}>
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <pre>
                            GET /graphql/reports<br/>
                            Content-Type: application/json<br/>
                            Authorization: Bearer {me.token}
                        </pre>
            <Button variant='contained' color='primary' component='a' href='/graphql' style={{ marginTop: 20 }}>
              {t('Playground')}
            </Button>
          </div>
        </Paper>
          ...
          <Formik
            ...
            render={({ submitForm, isSubmitting }) => (
              <Form style={{ margin: '20px 0 20px 0' }}>
                ...
                <div style={{ marginTop: 20 }}>
                  <Button variant='contained' type='button' color='primary' onClick={submitForm} disabled={isSubmitting} classes={{ root: classes.button }}>
                    {t('Update')}
                  </Button>
                </div>
              </Form>
