...
import StixDomainEntityAddObjectRefsLines, { stixDomainEntityAddObjectRefsLinesQuery } from './StixDomainEntityAddObjectRefsLines';
...
class StixDomainEntityAddObjectRefs extends Component {
  ...
  render() {
    const {
      t, classes, stixDomainEntityId, stixDomainEntityObjectRefs,
    } = this.props;
