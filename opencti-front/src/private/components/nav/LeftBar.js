            ...
            <ClickAwayListener onClickAway={this.handleClickAway.bind(this)}>
                ...
                >
                    ...
                    <MenuList component='nav' classes={{root: classes.menuList}}>
                        <MenuItem component={Link} to='/dashboard' onClick={this.handleClickAway.bind(this)} selected={location.pathname === '/dashboard'} dense={true} disableGutters={true}>
                        ...
                        <MenuItem component={Link} to='/dashboard/campaigns' onClick={this.handleClickAway.bind(this)} selected={location.pathname.includes('/dashboard/campaigns')}
                                  dense={true}
                                  disableGutters={true}>
                            <ListItemIcon classes={{root: classes.listIcon}}>
                                <AlarmLight/>
                        ...
                        <MenuItem component={Link} to='/dashboard/vulnerabilities' onClick={this.handleClickAway.bind(this)}
                                  selected={location.pathname.includes('/dashboard/vulnerabilities')}
                        ...
                        <MenuItem onClick={this.toggle.bind(this)} dense={true} disableGutters={true} style={{position: 'absolute', bottom: 10, width: '100%'}}>
                            <ListItemIcon classes={{root: classes.listIcon}}>
