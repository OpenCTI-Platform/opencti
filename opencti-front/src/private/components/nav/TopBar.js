                    ...
                    return (
                        <Toolbar>
                            ...
                            <div>
                                ...
                                >
                                    <MenuItem component={Link} to='/dashboard/profile' onClick={this.handleCloseMenu.bind(this)}><T>Profile</T></MenuItem>
                                    {R.pathOr(false, ['me', 'admin'], props) ? <MenuItem component={Link} to='/admin' onClick={this.adminClick.bind(this)}><T>Admin</T></MenuItem> : ''}
