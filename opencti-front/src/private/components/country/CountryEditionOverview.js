...
const countryMutationFieldPatch = graphql`
    mutation CountryEditionOverviewFieldPatchMutation($id: ID!, $input: EditInput!) {
        countryEdit(id: $id) {
...
const countryMutationRelationAdd = graphql`
    mutation CountryEditionOverviewRelationAddMutation($id: ID!, $input: RelationAddInput!) {
        countryEdit(id: $id) {
...
const countryMutationRelationDelete = graphql`
    mutation CountryEditionOverviewRelationDeleteMutation($id: ID!, $relationId: ID!) {
        countryEdit(id: $id) {
...
const CountryEditionOverview = createFragmentContainer(CountryEditionOverviewComponent, {
  country: graphql`
