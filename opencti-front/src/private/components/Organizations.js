...
import OrganizationsLines, { organizationsLinesQuery } from './organization/OrganizationsLines';
...
const exportOrganizationsQuery = graphql`
    query OrganizationsExportOrganizationsQuery($count: Int!, $cursor: ID, $orderBy: OrganizationsOrdering, $orderMode: OrderingMode) {
...
class Organizations extends Component {
  ...
  handleDownloadCSV() {
    ...
    fetchQuery(exportOrganizationsQuery, { count: 2147483647, ...paginationOptions }).then((data) => {
      ...
      <div>
        ...
        <List classes={{ root: classes.linesContainer }}>
          ...
          <QueryRenderer
            ...
            render={({ props }) => {
              if (props) {
                return <OrganizationsLines data={props} paginationOptions={paginationOptions} searchTerm={this.state.searchTerm}/>;
              }
              return <OrganizationsLines data={null} dummy={true} searchTerm={this.state.searchTerm}/>;
            }}
          />
        </List>
        ...
        >
          ...
          <DialogActions>
            ...
            {this.state.exportCsvData !== null
              ? <Button component={CSVLink} data={this.state.exportCsvData} separator={';'} enclosingCharacter={'"'} color='primary' filename={`${t('Organizations')}.csv`}>
                {t('Download')}
              </Button>
              : ''}
          </DialogActions>
