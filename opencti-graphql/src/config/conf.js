...
export const BUS_TOPICS = {
  ...
  Organization: {
    EDIT_TOPIC: 'ORGANIZATION_EDIT_TOPIC',
    ADDED_TOPIC: 'ORGANIZATION_ADDED_TOPIC'
  },
  Sector: {
    EDIT_TOPIC: 'SECTOR_EDIT_TOPIC',
    ADDED_TOPIC: 'SECTOR_ADDED_TOPIC'
  },
  City: {
    EDIT_TOPIC: 'CITY_EDIT_TOPIC',
    ADDED_TOPIC: 'CITY_ADDED_TOPIC'
  },
  Country: {
    EDIT_TOPIC: 'COUNTRY_EDIT_TOPIC',
    ADDED_TOPIC: 'COUNTRY_ADDED_TOPIC'
  },
  Group: {
  ...
  Campaign: {
    EDIT_TOPIC: 'CAMPAIGN_EDIT_TOPIC',
    ADDED_TOPIC: 'CAMPAIGN_ADDED_TOPIC'
  },
  Incident: {
    EDIT_TOPIC: 'INCIDENT_EDIT_TOPIC',
    ADDED_TOPIC: 'INCIDENT_ADDED_TOPIC'
  },
  Malware: {
  ...
  Tool: {
    EDIT_TOPIC: 'TOOL_EDIT_TOPIC',
    ADDED_TOPIC: 'TOOL_ADDED_TOPIC'
  },
  Vulnerability: {
    EDIT_TOPIC: 'VULNERABILITY_EDIT_TOPIC',
    ADDED_TOPIC: 'VULNERABILITY_ADDED_TOPIC'
  },
  Report: {
