...
public class Tool extends BaseEntity {
    private static final String PROPERTIES = """
            ...
            revoked confidence created modified name description aliases tool_types tool_version
            killChainPhases { id standard_id entity_type kill_chain_name phase_name x_opencti_order }
            """;

    public Tool(OpenCTIApiClient client) { super(client); }
    @Override protected String getEntityType() { return "Tool"; }
    @Override protected String getEntityName() { return "tool"; }
    @Override protected String getEntityNamePlural() { return "tools"; }
    @Override protected String getProperties() { return PROPERTIES; }
    @Override protected String getOrderingEnum() { return "ToolsOrdering"; }
    ...
    public Map<String, Object> create(String name, Object... params) {
        ...
        input.put("name", name);
        String mutation = "mutation ToolAdd($input: ToolAddInput!) { toolAdd(input: $input) { id standard_id entity_type parent_types } }";
        Map<String, Object> result = client.query(mutation, Map.of("input", input));
        Map<String, Object> data = (Map<String, Object>) result.get("data");
        return client.processMultipleFields((Map<String, Object>) data.get("toolAdd"));
    }
}
