...
@Slf4j
public class StixDomainObject extends BaseEntity {
    ...
    public StixDomainObject(OpenCTIApiClient client) { super(client); }
    @Override protected String getEntityType() { return "StixDomainObject"; }
    @Override protected String getEntityName() { return "stixDomainObject"; }
    @Override protected String getEntityNamePlural() { return "stixDomainObjects"; }
    @Override protected String getProperties() { return PROPERTIES; }
    @Override protected String getOrderingEnum() { return "StixDomainObjectsOrdering"; }
}
