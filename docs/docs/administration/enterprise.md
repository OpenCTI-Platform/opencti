...
OpenCTI playbooks are flexible automated data processing flows which can be fully customized and enabled by platform administrators to enrich, filter and modify the data created or updated in the platform. Please read the [Playbook automation page](../usage/playbook-automation.md) to get all information.
