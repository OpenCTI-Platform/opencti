...
| app:allow_http_resources                            | APP__ALLOW_HTTP_RESOURCES                              | true                                                                                                                               | When set to false, prevents the application from loading insecure (HTTP) resources (images, manifests, connections, objects) |
