...
| app:rate_protection:max_requests                    | APP__RATE_PROTECTION__MAX_REQUEST                      | 10000                                                                                                                              | Maximum of request allow per IP and per window duration, 0 will deny all                                            |
| app:rate_protection:time_window                     | APP__RATE_PROTECTION__TIME_WINDOW                      | 1                                                                                                                                  | Time window for rate protection in seconds                                                                          |
| app:rate_protection:ip_allow_list                   | APP__RATE_PROTECTION__IP_ALLOW_LIST                    | no default value                                                                                                                   | List of IP that are allowed to bypass the rate protection                                                           |
