...
| app:disable_upgrade_insecure_request                | APP__DISABLE_UPGRADE_INSECURE_REQUEST                  | false                                                                                                                              | Production setup should be set to false. When set to true, it allows to run the platform with HTTP protocol and preventbrowser to redirect to HTTPS |
