...
| ingestion_manager:uri_deny_list                      | INGESTION_MANAGER__URI_DENY_LIST                      | `[]`                             | JSON array of URI patterns to block for all ingestion feeds. See [Automated import](../usage/import/getting-started.md) |
| -                                                    | -                                                     | -                                | -                                                                                                                       |
