...
| app:allow_http_resources                            | APP__ALLOW_HTTP_RESOURCES                              | true                                                                                                                               | When set to false, the application prevent to follow non secure (HTTP) link for images or any other content         |
