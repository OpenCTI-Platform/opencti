...
Starting from 7.260728.0, each OpenCTI release includes an SBOM file in the [release assets section (listed at the end of the assets list)](https://github.com/OpenCTI-Platform/opencti/releases). This file is generated by the CI workflow `.github/workflows/cd-build-rolling-images-on-merge.yml`.
...
- verify which components are included in the released platform package,
