...
- [OpenCTI Map Dark mode style (filigran-dark3.json)](https://raw.githubusercontent.com/FiligranHQ/deployment-mapserver/main/styles/filigran-dark3.json)
- [OpenCTI Map Light mode style (filigran-light3.json)](https://raw.githubusercontent.com/FiligranHQ/deployment-mapserver/main/styles/filigran-light3.json)
