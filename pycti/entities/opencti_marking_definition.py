...
class MarkingDefinition:
    ...
    def create_raw(self, **kwargs):
        ...
        if definition is not None and definition_type is not None:
            ...
            return self.opencti.process_multiple_fields(result['data']['markingDefinitionAdd'])
        else:
            self.opencti.log('error', '[opencti_marking_definition] Missing parameters: definition and definition_type')
