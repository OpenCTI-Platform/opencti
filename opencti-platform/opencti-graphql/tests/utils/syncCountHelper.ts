...
testCreatedCounter.file = 4;
testCreatedCounter.grouping = 1;
testCreatedCounter.identity = 38;
testCreatedCounter.incident = 2;
testCreatedCounter.indicator = 38;
testCreatedCounter['internal-relationship'] = 8;
...
testCreatedCounter.location = 16;
testCreatedCounter.malware = 49;
testCreatedCounter['malware-analysis'] = 2;
testCreatedCounter['marking-definition'] = 20;
...
testCreatedCounter.relationship = 138;
testCreatedCounter.report = 45;
testCreatedCounter.sighting = 4;
testCreatedCounter.software = 1;
testCreatedCounter['threat-actor'] = 18;
...
testUpdatedCounter.identity = 23;
...
testUpdatedCounter.indicator = 6;
...
testMergedCounter.file = 2;
testMergedCounter.artifact = 1;

export const testDeletedCounter: Record<string, number> = {};
testDeletedCounter.report = 34;
testDeletedCounter['marking-definition'] = 9;
...
testDeletedCounter.identity = 22;
testDeletedCounter.file = 1;
testDeletedCounter['intrusion-set'] = 2;
testDeletedCounter.indicator = 10;
...
testDeletedCounter['internal-relationship'] = 2;
testDeletedCounter.vulnerability = 1;
testDeletedCounter['domain-name'] = 3;
