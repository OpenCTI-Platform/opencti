...
export const ROLE_SECURITY: Role = {
  ...
  capabilities: ['KNOWLEDGE_KNUPDATE_KNDELETE', 'EXPLORE_EXUPDATE_EXDELETE', 'INVESTIGATION_INUPDATE_INDELETE', 'SETTINGS_SETACCESSES', 'SETTINGS_SECURITYACTIVITY', 'AUTOMATION_AUTOMATIONMANAGE']
};
