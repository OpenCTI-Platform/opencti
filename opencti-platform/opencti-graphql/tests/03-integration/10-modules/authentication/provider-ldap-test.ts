...
import { computeLdapGroups, computeLdapOrganizations, computeLdapUserInfo } from '../../../../src/modules/authenticationProvider/provider-ldap';
import { encryptAuthValue } from '../../../../src/modules/authenticationProvider/authenticationProvider-domain';
...
describe('LDAP Single sign on Provider coverage tests', () => {
  ...
  describe('LDAP groups and org mapping coverage', () => {
    it('should LDAP group mapping be computed correctly with default group attribute', async () => {
      ...
      const result = computeLdapGroups(ssoEntity as BasicStoreEntityAuthenticationProvider, ldapProfile);
    ...
    it('should LDAP org mapping be computed correctly with default attribute', async () => {
      ...
      const result = computeLdapOrganizations(ssoEntity as BasicStoreEntityAuthenticationProvider, ldapProfile, undefined);
