...
import type { BasicStoreEntityAuthenticationProvider, GroupsMapping, OrganizationsMapping } from '../../../../src/modules/authenticationProvider/authenticationProvider-types';
import { computeOpenIdUserInfo, computeOpenIdGroupsMapping, computeOpenIdOrganizationsMapping } from '../../../../src/modules/authenticationProvider/provider-oidc';
...
describe('OpenID Single sign on Provider coverage tests', () => {
  ...
  describe('OpenID groups and org mapping coverage', () => {
    it('should OpenID group mapping be computed correctly with default', async () => {
      ...
      const groupManagementConfig: GroupsMapping = {
    ...
    it('should OpenID org mapping be computed correctly with default', async () => {
      ...
      const orgManagementConfig: OrganizationsMapping = {
