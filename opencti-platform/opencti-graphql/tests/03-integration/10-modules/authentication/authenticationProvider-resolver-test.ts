...
import { SECRET_TYPE } from '../../../../src/modules/authenticationProvider/authenticationProvider-domain';
...
describe('SSO: Local strategy dedicated behaviour', () => {
  ...
  it('should delete Local Strategy', async () => {
    await deleteElementById(testContext, ADMIN_USER, localStrategyId, ENTITY_TYPE_AUTHENTICATION_PROVIDER);
