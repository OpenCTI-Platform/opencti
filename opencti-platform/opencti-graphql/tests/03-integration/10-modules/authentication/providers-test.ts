...
import { parseValueAsType, registerLocalStrategy } from '../../../../src/modules/authenticationProvider/providers';
import { ADMIN_USER, testContext } from '../../../utils/testQuery';
import * as providerConfig from '../../../../src/modules/authenticationProvider/providers-configuration';
import { isAuthenticationActivatedByIdentifier, type ProviderConfiguration, PROVIDERS } from '../../../../src/modules/authenticationProvider/providers-configuration';
import { clearProvider } from './authenticationProvider-test-utils';
import { initEnterpriseAuthenticationProviders } from '../../../../src/modules/authenticationProvider/authenticationProvider-init';
import { waitInSec } from '../../../../src/database/utils';
import { deleteSingleSignOn, encryptAuthValue, addAuthenticationProvider, SECRET_TYPE } from '../../../../src/modules/authenticationProvider/authenticationProvider-domain';
...
describe('Single sign on Provider coverage tests', () => {
  describe('initialization coverage', () => {
    ...
    it('should existing SSO in database be loaded', async () => {
      ...
      const saml1 = await addAuthenticationProvider(testContext, ADMIN_USER, newSAMLInput, true);
      ...
      const saml2 = await addAuthenticationProvider(testContext, ADMIN_USER, newSAMLDisabledInput, true);
