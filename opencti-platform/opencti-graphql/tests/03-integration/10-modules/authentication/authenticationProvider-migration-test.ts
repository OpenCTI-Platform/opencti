...
import { parseAuthenticationProviderConfiguration } from '../../../../src/modules/authenticationProvider/authenticationProvider-migration';
import { ADMIN_USER, testContext } from '../../../utils/testQuery';
import { deleteSingleSignOn } from '../../../../src/modules/authenticationProvider/authenticationProvider-domain';
import { EnvStrategyType, MIGRATED_STRATEGY } from '../../../../src/modules/authenticationProvider/providers-configuration';
...
describe('Migration of SSO environment test coverage', () => {
  describe('Dry run of LOCAL migrations', () => {
    it('should default configuration with only local works', async () => {
      ...
      const result = await parseAuthenticationProviderConfiguration(testContext, ADMIN_USER, configuration, true);
  ...
  describe('Dry run of SAML migrations', () => {
    ...
    it('should SAML with several SAML config works', async () => {
      ...
      const multiSamlConfigurations = await parseAuthenticationProviderConfiguration(testContext, ADMIN_USER, configuration, true);
  ...
  describe('Dry run of OpenId migrations', () => {
    ...
    it('should OpenId with several OpenId config works', async () => {
      ...
      const multiOicConfigurations = await parseAuthenticationProviderConfiguration(testContext, ADMIN_USER, configuration, true);
  ...
  describe('Actual run of migrations', () => {
    it('should SAML configuration works', async () => {
      ...
      const result = await parseAuthenticationProviderConfiguration(testContext, ADMIN_USER, configuration, false);
