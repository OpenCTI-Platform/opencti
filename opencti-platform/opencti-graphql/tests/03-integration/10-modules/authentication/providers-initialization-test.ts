...
import { initializeEnvAuthenticationProviders } from '../../../../src/modules/authenticationProvider/providers-initialization';
import * as providerConfig from '../../../../src/modules/authenticationProvider/providers-configuration';
import * as providerInit from '../../../../src/modules/authenticationProvider/providers-initialization';
...
import { clearProvider, clearAuthenticationProviderDatabase } from './authenticationProvider-test-utils';
...
describe('Providers initialization coverage', () => {
  ...
  describe('New platform startup coverage', () => {
    beforeEach(async () => {
      ...
      await clearAuthenticationProviderDatabase();
    });
