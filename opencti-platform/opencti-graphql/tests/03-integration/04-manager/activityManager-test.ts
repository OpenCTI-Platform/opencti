...
import type { SseEvent, ActivityStreamEvent } from '../../../src/types/event';
...
// Timestamp used in event ids - must be in milliseconds unix format
...
describe('Activity manager - buildActivityHistoryElements', () => {
  ...
  it('should correctly process multiple events and filter prevent_indexing', async () => {
    ...
    // The 3rd event (prevent_indexing=true) is excluded
