...
const frontendSCORelationships = {
  ...
  'Domain-Name_Domain-Name': ['resolves-to', 'obs_resolves-to'],
  'Domain-Name_IPv4-Addr': ['resolves-to', 'obs_resolves-to'],
  'Domain-Name_IPv6-Addr': ['resolves-to', 'obs_resolves-to'],
  ...
  'IPv4-Addr_Autonomous-System': ['belongs-to', 'obs_belongs-to'],
  'IPv4-Addr_Mac-Addr': ['resolves-to', 'obs_resolves-to'],
  'IPv4-Addr_Network-Traffic': ['src', 'dst'],
  'IPv6-Addr_Autonomous-System': ['belongs-to', 'obs_belongs-to'],
  'IPv6-Addr_Mac-Addr': ['resolves-to', 'obs_resolves-to'],
