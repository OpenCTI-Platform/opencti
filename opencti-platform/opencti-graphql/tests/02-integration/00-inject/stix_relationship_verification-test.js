...
const openctiRelationshipException = {
  'threat-actor-group_sector': ['attributed-to', 'impersonates'],
};
...
const frontendSDORelationships = {
  ...
  'Threat-Actor-Group_Attack-Pattern': ['uses'],
  'Threat-Actor-Group_City': ['located-at', 'targets'],
  'Threat-Actor-Group_Country': ['located-at', 'targets'],
  'Threat-Actor-Group_Individual': ['attributed-to', 'impersonates', 'targets'],
  'Threat-Actor-Group_Infrastructure': ['compromises', 'hosts', 'owns', 'uses'],
  'Threat-Actor-Group_Malware': ['uses'],
  'Threat-Actor-Group_Organization': ['attributed-to', 'impersonates', 'targets'],
  'Threat-Actor-Group_Position': ['located-at', 'targets'],
  'Threat-Actor-Group_Region': ['located-at', 'targets'],
  'Threat-Actor-Group_Sector': ['targets'],
  'Threat-Actor-Group_Threat-Actor-Group': ['part-of'],
  'Threat-Actor-Group_Tool': ['uses'],
  'Threat-Actor-Group_Vulnerability': ['targets'],
