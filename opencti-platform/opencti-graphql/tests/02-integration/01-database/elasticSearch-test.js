...
describe('Elasticsearch pagination', () => {
  it('should entity paginate everything', async () => {
    ...
    expect(data.edges.length).toEqual(405);
  ...
  it('should entity paginate everything after', async () => {
    ...
    expect(data).not.toBeNull();
    expect(data.edges.length).toEqual(335);
  });
  ...
  it('should entity paginate with field not exist filter', async () => {
    ...
    // Updated because we have add two entitySettings and removed one
    expect(data.edges.length).toEqual(398);
  });
  ...
  it('should entity paginate with dates filter', async () => {
    ...
    expect(data.edges.length).toEqual(278);
    filters = [
  ...
  it('should relation paginate everything', async () => {
    ...
    expect(groupByIndices[`${ES_INDEX_PREFIX}_internal_relationships-000001`].length).toEqual(25);
    ...
    expect(data.edges.length).toEqual(162);
    ...
    expect(data).not.toBeNull();
    expect(data.length).toEqual(162);
