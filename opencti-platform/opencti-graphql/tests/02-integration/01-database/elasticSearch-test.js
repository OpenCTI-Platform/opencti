...
describe('Elasticsearch pagination', () => {
  ...
  it('should relation paginate everything', async () => {
    ...
    expect(groupByIndices[`${ES_INDEX_PREFIX}_internal_relationships-000001`].length).toEqual(49);
    ...
    expect(data.edges.length).toEqual(204);
    ...
    expect(data).not.toBeNull();
    expect(data.length).toEqual(204);
