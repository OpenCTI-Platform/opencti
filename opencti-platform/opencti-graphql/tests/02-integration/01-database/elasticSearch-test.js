...
describe('Elasticsearch pagination', () => {
  ...
  it('should entity paginate with field not exist filter', async () => {
    ...
    expect(entityTypeMap.get('User')).toBe(entitiesCounter.User);
    expect(entityTypeMap.get('Vocabulary')).toBe(entitiesCounter.Vocabulary);
    expect(data.edges.length).toEqual(209 + entitiesCounter.Vocabulary);
  });
  ...
  it('should entity paginate with date ordering', async () => {
    ...
    expect(entityTypeMap.get('Kill-Chain-Phase')).toBe(entitiesCounter.KillChainPhase);
    expect(entityTypeMap.get('External-Reference')).toBe(entitiesCounter.ExternalReference);
    expect(data.edges.length).toEqual(220 + entitiesCounter.Vocabulary);
  ...
  it('should relation paginate everything', async () => {
    ...
    expect(internalRelationshipsByType['member-of'].length).toEqual(relationsCounter['member-of']);
    expect(internalRelationshipsByType['participate-to'].length).toEqual(relationsCounter['participate-to']);
    ...
    expect(stixCoreRelationshipsByType['attributed-to'].length).toEqual(relationsCounter['attributed-to']);
    expect(stixCoreRelationshipsByType.indicates.length).toEqual(relationsCounter.indicates);
    expect(stixCoreRelationshipsByType['located-at'].length).toEqual(relationsCounter['located-at']);
    expect(stixCoreRelationshipsByType.mitigates.length).toEqual(relationsCounter.mitigates);
    expect(stixCoreRelationshipsByType['part-of'].length).toEqual(relationsCounter['part-of']);
    expect(stixCoreRelationshipsByType['related-to'].length).toEqual(relationsCounter['related-to']);
    expect(stixCoreRelationshipsByType.targets.length).toEqual(relationsCounter.targets);
    expect(stixCoreRelationshipsByType.uses.length).toEqual(relationsCounter.uses);
    ...
    expect(stixMetaRelationshipsByType['created-by'].length).toEqual(relationsCounter['created-by']);
    expect(stixMetaRelationshipsByType['external-reference'].length).toEqual(relationsCounter['external-reference']);
    expect(stixMetaRelationshipsByType['kill-chain-phase'].length).toEqual(relationsCounter['kill-chain-phase']);
    expect(stixMetaRelationshipsByType['object-label'].length).toEqual(relationsCounter['object-label']);
    ...
    expect(metaByEntityType.object.length).toEqual(relationsCounter.object);
    expect(metaByEntityType['object-label'].length).toEqual(relationsCounter['object-label']);
    expect(metaByEntityType['created-by'].length).toEqual(relationsCounter['created-by']);
    expect(metaByEntityType['external-reference'].length).toEqual(relationsCounter['external-reference']);
    ...
    expect(entityTypeMap.get('member-of')).toBe(relationsCounter['member-of']);
    expect(entityTypeMap.get('has-role')).toBe(relationsCounter['has-role']);
    expect(entityTypeMap.get('participate-to')).toBe(relationsCounter['participate-to']);
    expect(entityTypeMap.get('uses')).toBe(relationsCounter.uses);
    expect(entityTypeMap.get('part-of')).toBe(relationsCounter['part-of']);
    expect(entityTypeMap.get('indicates')).toBe(relationsCounter.indicates);
    expect(entityTypeMap.get('located-at')).toBe(relationsCounter['located-at']);
    expect(entityTypeMap.get('targets')).toBe(relationsCounter.targets);
    expect(entityTypeMap.get('mitigates')).toBe(relationsCounter.mitigates);
    expect(entityTypeMap.get('related-to')).toBe(relationsCounter['related-to']);
    expect(entityTypeMap.get('attributed-to')).toBe(relationsCounter['attributed-to']);
