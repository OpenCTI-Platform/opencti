...
import { bundle } from './playbook-components/playbook-components-bundles';
...
describe('playbook sharing component', () => {
  ...
  it('should share report and contained entities', async () => {
      ...
      objects: [
        {
          ...
          extensions: {
            'extension-definition--ea279b3e-5c71-4632-ac08-831c66a786ba': {
              ...
              granted_refs: [
                externalOrganizationEntity.standard_id
              ],
