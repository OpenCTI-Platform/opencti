...
describe('Raw streams tests', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(createEventsByTypes.indicator.length).toBe(38 + 0);
      ...
      expect(createEvents.length).toBe(831 + 0);
      ...
      expect(deleteEvents.length).toBe(174 + 0);
      ...
      expect(events.length).toBe(RAW_EVENTS_SIZE + 0);
    },
    FIVE_MINUTES
  );
});
