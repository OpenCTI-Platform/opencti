...
describe('Raw streams tests', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(createEventsByTypes.relationship.length).toBe(134);
      ...
      expect(createEventsByTypes.report.length).toBe(32);
      ...
      expect(updateEventsByTypes['report'].length).toBe(9);
      ...
      expect(updateEvents.length).toBe(168);
