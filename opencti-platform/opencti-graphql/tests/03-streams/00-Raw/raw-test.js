...
describe('Raw streams tests', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(createEventsByTypes.indicator.length).toBe(49);
      ...
      expect(createEvents.length).toBe(851);
      ...
      expect(updateEvents.length).toBe(207);
      ...
      expect(deleteEvents.length).toBe(200);
