...
describe('Raw streams tests', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(createEvents.length).toBe(845);
      ...
      expect(updateEventsByTypes['identity'].length).toBe(26);
      ...
      expect(updateEventsByTypes['report'].length).toBe(28);
      expect(updateEventsByTypes['ipv4-addr'].length).toBe(7);
      ...
      expect(updateEvents.length).toBe(212);
      ...
      expect(deleteEvents.length).toBe(188);
