...
describe('Raw streams tests', () => {
  ...
  it(
    ...
    async () => {
      ...
      expect(createEventsByTypes.indicator.length).toBe(38 + 1);
      ...
      expect(createEvents.length).toBe(831 + 1);
      ...
      expect(deleteEvents.length).toBe(174 + 1);
      ...
      expect(events.length).toBe(RAW_EVENTS_SIZE + 2);
    },
    FIVE_MINUTES
  );
});
