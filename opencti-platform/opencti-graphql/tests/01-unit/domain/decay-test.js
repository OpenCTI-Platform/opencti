...
import { BUILT_IN_DECAY_RULES, computeLivePoints, computeLiveScore, computeNextScoreReactionDate, computeScoreFromExpectedTime, computeTimeFromExpectedScore, FALLBACK_DECAY_RULE, findDecayRuleForIndicator } from '../../../src/modules/indicator/decay-domain';
import { computeIndicatorDecayPatch } from '../../../src/modules/indicator/indicator-domain';
...
describe('Decay formula testing', () => {
    ...
    it('should find the right rule for indicator type', () => {
        ...
        let decayRule = findDecayRuleForIndicator('', BUILT_IN_DECAY_RULES);
...
describe('Decay update testing', () => {
    it('should move to next score and update next reaction date for default rule', () => {
        ...
        // THEN
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.revoked, 'This indicator should not be revoked.').toBeUndefined();
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.x_opencti_score, 'This indicator should be updated to next score (50 -> 40).').toBe(40);
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_next_reaction_date, 'This indicator should have a new reaction date.').toBeDefined();
        expect((_a = patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_history) === null || _a === void 0 ? void 0 : _a.length, 'This indicator should have one more history data.').toBe(2);
        expect((_c = (_b = patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_history) === null || _b === void 0 ? void 0 : _b.at(1)) === null || _c === void 0 ? void 0 : _c.score, 'This indicator should have one more history data.').toBe(40);
    });
    it('should move to next score and update next reaction date', () => {
        ...
        // THEN
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.revoked, 'This indicator should not be revoked.').toBeUndefined();
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.x_opencti_score, 'This indicator should be updated to next score (100 -> 80).').toBe(80);
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_next_reaction_date, 'This indicator should have a new reaction date.').toBeDefined();
        expect((_a = patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_history) === null || _a === void 0 ? void 0 : _a.length, 'This indicator should have one more history data.').toBe(1);
        expect((_c = (_b = patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_history) === null || _b === void 0 ? void 0 : _b.at(0)) === null || _c === void 0 ? void 0 : _c.score, 'This indicator should have one more history data.').toBe(80);
    });
    it('should be revoked when revoke score is reached', () => {
        ...
        const patchResult = computeIndicatorDecayPatch(indicatorInput);
        // THEN
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.revoked, 'This indicator should be revoked.').toBeTruthy();
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.x_opencti_score, 'This indicator should be updated to revoke score.').toBe(10);
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_next_reaction_date, 'This indicator should not have a next reaction date.').toBeUndefined();
        expect((_a = patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_history) === null || _a === void 0 ? void 0 : _a.length, 'This indicator should have one more history data.').toBe(2);
    });
    it('should revoke when current score is already lower than revoke score', () => {
        ...
        // THEN
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.revoked, 'This indicator should be revoked.').toBeTruthy();
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.x_opencti_score, 'This indicator should be updated to revoke score.').toBe(20);
        expect(patchResult === null || patchResult === void 0 ? void 0 : patchResult.decay_next_reaction_date, 'This indicator should not have a next reaction date.').toBeUndefined();
    });
...
describe('Decay live detailed data testing (subset of indicatorDecayDetails query)', () => {
    it('should compute live score correctly', () => {
        ...
        const liveScore = computeLiveScore(indicator);
    ...
    it('should next reaction point be updated when score is lower than max reaction score', () => {
        ...
        const result = computeLivePoints(indicator);
...
describe('Decay chart data generation', () => {
    it('should compute score list correctly', () => {
        const result = computeScoreList(81);
    ...
    it('should compute live score serie correctly', () => {
        ...
        const result = computeChartDecayAlgoSerie(indicator, timeSerie);
