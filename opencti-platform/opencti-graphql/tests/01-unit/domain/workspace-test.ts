...
describe('workspace', () => {
  ...
  const cases = [
    ['../../data/20233010_octi_dashboard_Custom Dash_invalid_5.11.0_version.json', 'Invalid version of the platform. Please upgrade your OpenCTI. Minimal version required: 5.12.0'],
    ['../../data/20233010_octi_dashboard_Custom Dash_invalid_5.10.5_version.json', 'Invalid version of the platform. Please upgrade your OpenCTI. Minimal version required: 5.12.0'],
    ['../../data/20233010_octi_dashboard_Custom Dash_invalid_4.0.4_version.json', 'Invalid version of the platform. Please upgrade your OpenCTI. Minimal version required: 5.12.0'],
  ];
