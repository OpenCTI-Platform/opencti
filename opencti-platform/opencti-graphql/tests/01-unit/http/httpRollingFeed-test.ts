...
describe('buildCsvLines', () => {
  it('should convert elements to CSV lines and remove carriage return', () => {
    const expectedResultLines: string[] = [
      'CSV test;"Triggered risk rules:  |Rule|Severity|Score| |----|---|----| |Line 2| column 2| column 3| |Line 3| column 2| column 3|  **bold test**  *italic test* ~~test barré~~  virgule test"',
    ];
  ...
  it('should replace double quotes and separator in description and name with space', () => {
    ...
    const expectedResultLines: string[] = [
      'CSV test;"Triggered risk rules:  |Rule|Severity;|Score| |----|---|----| |Line 2| column"" 2| column 3| |Line 3| column 2| column 3|  **test  gras**  *italic test* ~~test barré~~  virgule test"',
    ];
