...
export const INFRASTRUCTURE_INSTANCE = {
  ...
  base_type: 'ENTITY',
  updated_at: '2025-08-01T16:00:00.000Z',
  ...
  externalReferences: [
    {
      ...
      i_relation: {
        ...
        sort: ['relationship-meta--00cb7c91-1eb8-45c3-a42e-7ce1aeef0c0c'],
        standard_id: 'relationship-meta--00cb7c91-1eb8-45c3-a42e-7ce1aeef0c0c',
        base_type: 'RELATION',
        entity_type: 'external-reference',
        internal_id: '754f8882-585d-470c-8765-e6b85cd2fc21',
        from: null,
        fromId: 'b2c3d4e5-f6a7-8901-bcde-f12345678901',
        fromRole: 'external-reference_from',
        fromName: 'Infrastructure Stix 2.0',
        fromType: 'Infrastructure',
        source_ref: 'infrastructure--temporary',
        to: null,
  ...
  killChainPhases: [
    {
      ...
      i_relation: {
        ...
        sort: ['relationship-meta--1d147529-d587-4ce7-a3fe-2235ba0328f7'],
  ...
  objectMarking: [
    {
      ...
      i_relation: {
        ...
        sort: ['relationship-meta--3247b925-458e-47e3-ab09-4ffb97056257'],
  ...
  createdBy: {
    ...
    name: 'ANSSI',
    creator_id: ['88ec0c6a-13ce-5e39-b486-354fe4a7084f'],
    x_opencti_stix_ids: ['identity--7b82b010-b1c0-4dae-981f-7756374a17df'],
    i_relation: {
      _index: 'opencti_stix_meta_relationships-000001',
      _id: 'c316e119-11cd-4104-895b-479bd341c9ce',
      id: 'c316e119-11cd-4104-895b-479bd341c9ce',
      sort: ['relationship-meta--8f8b7e68-7e33-438e-814e-04d06dea2b74'],
  ...
  objectLabel: [
    {
      ...
      i_relation: {
        ...
        sort: ['relationship-meta--a250b7a9-dcc0-4e2a-bdc0-57dff3836b10'],
