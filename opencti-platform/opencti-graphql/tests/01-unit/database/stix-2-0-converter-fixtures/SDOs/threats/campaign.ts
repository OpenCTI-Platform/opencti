...
export const CAMPAIGN_INSTANCE = {
  ...
  objectMarking: [
    {
      ...
      i_relation: {
        ...
        _id: '11111111-1111-4111-8111-000000000001',
        id: '11111111-1111-4111-8111-000000000001',
        sort: ['relationship-meta--11111111-1111-4111-8111-000000000001'],
        standard_id: 'relationship-meta--11111111-1111-4111-8111-000000000001',
        base_type: 'RELATION',
        entity_type: 'object-marking',
        internal_id: '11111111-1111-4111-8111-000000000001',
        from: null,
        fromId: '11111111-1111-4111-8111-111111111111',
        fromRole: 'object-marking_from',
        fromName: 'Campaign Stix 2.0',
        fromType: 'Campaign',
        source_ref: 'campaign--temporary',
        to: null,
  ...
  externalReferences: [
    {
      ...
      i_relation: {
        _index: 'opencti_stix_meta_relationships-000001',
        _id: '11111111-1111-4111-8111-000000000002',
        id: '11111111-1111-4111-8111-000000000002',
        sort: ['relationship-meta--11111111-1111-4111-8111-000000000002'],
        standard_id: 'relationship-meta--11111111-1111-4111-8111-000000000002',
        base_type: 'RELATION',
        entity_type: 'external-reference',
        internal_id: '11111111-1111-4111-8111-000000000002',
        from: null,
        fromId: '11111111-1111-4111-8111-111111111111',
  ...
  objectLabel: [
    {
      ...
      i_relation: {
        _index: 'opencti_stix_meta_relationships-000001',
        _id: '11111111-1111-4111-8111-000000000003',
        id: '11111111-1111-4111-8111-000000000003',
        sort: ['relationship-meta--11111111-1111-4111-8111-000000000003'],
        standard_id: 'relationship-meta--11111111-1111-4111-8111-000000000003',
        base_type: 'RELATION',
        entity_type: 'object-label',
        internal_id: '11111111-1111-4111-8111-000000000003',
        from: null,
        fromId: '11111111-1111-4111-8111-111111111111',
  ...
  createdBy: {
    ...
    i_relation: {
      _index: 'opencti_stix_meta_relationships-000001',
      _id: '11111111-1111-4111-8111-000000000004',
      id: '11111111-1111-4111-8111-000000000004',
      sort: ['relationship-meta--11111111-1111-4111-8111-000000000004'],
      standard_id: 'relationship-meta--11111111-1111-4111-8111-000000000004',
      base_type: 'RELATION',
      entity_type: 'created-by',
      internal_id: '11111111-1111-4111-8111-000000000004',
      from: null,
      fromId: '11111111-1111-4111-8111-111111111111',
