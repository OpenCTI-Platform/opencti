...
export const SYSTEM_INSTANCE = {
  id: '10000000-0000-4000-8000-000000000003',
  standard_id: 'identity--20000000-0000-4000-8000-000000000003',
  entity_type: 'System',
  created: '2026-03-01T00:00:00.000Z',
  modified: '2026-03-02T00:00:00.000Z',
  confidence: 60,
  revoked: false,
  name: 'System Stix 2.0',
  description: 'system description',
  identity_class: 'system',
  x_opencti_aliases: ['sys-1'],
...
export const EXPECTED_SYSTEM = {
  id: 'identity--20000000-0000-4000-8000-000000000003',
  type: 'identity',
  spec_version: '2.0',
  x_opencti_id: '10000000-0000-4000-8000-000000000003',
