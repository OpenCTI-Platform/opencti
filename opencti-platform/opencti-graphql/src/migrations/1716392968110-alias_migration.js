...
export const up = async (next) => {
  ...
  const total = await elCount(context, SYSTEM_USER, READ_DATA_INDICES, {
    filters,
  ...
  await elList(context, SYSTEM_USER, READ_DATA_INDICES_WITHOUT_INTERNAL_WITHOUT_INFERRED, {
    filters,
    noFiltersChecking: true,
    callback,
  });
