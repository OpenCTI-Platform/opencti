...
const message = '[MIGRATION] Attack Pattern / Course of Action standard_id case-insensitive duplicate merge fix';
// Merge entities that collide after the new (case-insensitive) x_mitre_id normalization,
// ensuring the merge target's standard_id matches the recomputed value.
