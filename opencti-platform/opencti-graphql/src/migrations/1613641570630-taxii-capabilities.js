...
import { createCapabilities, TAXII_CAPABILITIES } from '../database/data-initialization';
...
export const up = async (next) => {
  ...
  const inferenceCapabilityId = generateStandardId(ENTITY_TYPE_CAPABILITY, {
    name: 'SETTINGS_SETINFERENCES',
  });
  const element = await storeLoadById(
    context,
    SYSTEM_USER,
    inferenceCapabilityId,
