...
export const createQueryTask = async (context, user, input, notifications = false) => {
  const { actions, filters, excluded_ids = [], search = null } = input;
  await checkActionValidity(context, user, { actions, filters, notifications, taskType: 'query' });
