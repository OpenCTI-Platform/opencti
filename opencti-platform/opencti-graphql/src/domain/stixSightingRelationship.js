...
export const stixSightingRelationshipsNumber = (context, user, args) => ({
  count: elCount(
    ...
    assoc('types', [STIX_SIGHTING_RELATIONSHIP], args),
  ),
  total: elCount(
    context,
    user,
...
export const stixSightingRelationshipEditField = async (
  context,
  user,
  relationshipId,
  input,
...
// region relation ref
export const stixSightingRelationshipAddRelation = async (
  context,
  user,
...
export const stixSightingRelationshipAddRelations = async (
  context,
  user,
  stixSightingRelationshipId,
  input,
...
// region context
export const stixSightingRelationshipCleanContext = async (
  context,
  user,
  stixSightingRelationshipId,
) => {
  await delEditContext(user, stixSightingRelationshipId);
  const stixSightingRelationship = await storeLoadById(
    context,
    user,
    stixSightingRelationshipId,
    STIX_SIGHTING_RELATIONSHIP,
...
export const stixSightingRelationshipEditContext = async (
  context,
  user,
  stixSightingRelationshipId,
  input,
...
export const stixSightingRelationshipRemoveFromDraft = async (context, user, stixCoreObjectId) => {
  const stixSighting = await storeLoadById(
    context,
    user,
    stixCoreObjectId,
    STIX_SIGHTING_RELATIONSHIP,
  ...
  if (!stixSighting) {
    throw FunctionalError(
      'Cannot remove the object from draft, Stix-Sighting-Relationship cannot be found.',
      { id: stixCoreObjectId },
    );
  }
