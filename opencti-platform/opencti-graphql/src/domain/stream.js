...
export const findAll = (context, user, args) => {
  ...
  if (user && isUserHasCapability(user, TAXIIAPI)) {
    ...
    return listEntitiesPaginated(context, user, [ENTITY_TYPE_STREAM_COLLECTION], options);
  }
  ...
  return listEntitiesPaginated(context, SYSTEM_USER, [ENTITY_TYPE_STREAM_COLLECTION], publicArgs);
};
