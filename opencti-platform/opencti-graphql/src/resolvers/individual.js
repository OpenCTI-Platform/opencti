import {
  addIndividual,
  findIndividualPaginated,
  findById,
  isUser,
  partOfOrganizationsPaginated,
} from '../domain/individual';
import {
...
const individualResolvers = {
  ...
  Individual: {
    organizations: (individual, args, context) =>
      partOfOrganizationsPaginated(context, context.user, individual.id, args),
