...
import {
  findById,
  findStixObjectOrRelationshipsPaginated,
...
const stixObjectOrStixRelationshipResolvers = {
  Query: {
    ...
    stixObjectOrStixRelationships: (_, args, context) =>
      findStixObjectOrRelationshipsPaginated(context, context.user, args),
    stixCoreObjectOrStixCoreRelationship: (_, { id }, context) =>
