import {
  ...
  findNested,
  isDatable,
  schemaRefRelationships, schemaRefRelationshipsPossibleTypes,
...
const stixRefRelationshipResolvers = {
  Query: {
    ...
    stixSchemaRefRelationshipsPossibleTypes: (_, { type }, context) => schemaRefRelationshipsPossibleTypes(type),
