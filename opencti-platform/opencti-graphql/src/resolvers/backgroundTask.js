import { deleteTask, createQueryTask, findAllPaginated, findById } from '../domain/backgroundTask';
...
const taskResolvers = {
  Query: {
    ...
    backgroundTasks: (_, args, context) => findAllPaginated(context, context.user, args),
  },
  Mutation: {
