...
import {
  ...
  externalReferenceImportPushRef,
  findReferencesPaginated,
  findById,
  findReferencesForExternalIdPaginated,
...
const externalReferenceResolvers = {
  Query: {
    ...
    externalReferences: (_, args, context) => findReferencesPaginated(context, context.user, args),
  },
  ExternalReference: {
  ...
  Mutation: {
    externalReferenceEdit: (_, { id }, context) => ({
      ...
      importPushRef: (args) => externalReferenceImportPushRef(context, context.user, id, args.fileRef),
    }),
