import {
  addSector,
  childSectorsPaginated,
  findSectorPaginated,
  findById,
  isSubSector,
  parentSectorsPaginated,
...
const sectorResolvers = {
  ...
  Sector: {
    parentSectors: (sector, args, context) =>
      parentSectorsPaginated(context, context.user, sector.id, args),
    subSectors: (sector, args, context) =>
      childSectorsPaginated(context, context.user, sector.id, args),
    isSubSector: (sector, _, context) => isSubSector(context, context.user, sector.id),
    targetedOrganizations: (sector, _, context) =>
      targetedOrganizations(context, context.user, sector.id),
  },
  Mutation: {
