...
import { findAll } from '../../modules/internal/csvMapper/csvMapper-domain';
...
export const IMPORT_CSV_CONNECTOR: Connector = {
  ...
  name: 'ImportCsv',
  built_in: true,
  connector_schema_runtime_fn: (context: AuthContext, user: AuthUser) => findAll(context, user, { all: true, connectionFormat: false }),
};
