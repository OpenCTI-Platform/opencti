...
export const PasswordChangeRequired = (data) =>
...
export const LtsRequiredActivation = (data) =>
...
export const OtpRequiredActivation = (data) =>
...
export const ComplexSearchError = (reason, data) =>
...
export const AccessRequiredError = (reason, data) =>
...
export const EngineShardsError = (data) =>
  error(
    DATABASE_ERROR,
...
export const AlreadyDeletedError = (data) =>
...
export const ValidationError = (message, field, data) =>
...
export const ResourceNotFoundError = (reason, data) =>
...
export const LockTimeoutError = (data, reason) =>
...
export const DraftLockedError = (reason, data) =>
  error(
    DRAFT_LOCKED_ERROR,
