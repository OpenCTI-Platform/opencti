...
export const attachToConnectionInformationQuery = (id, field, itemIris) => {
  ...
  const { predicate } = connectionInformationPredicateMap[field];
  let statements;
...
<<<<<<< HEAD
  ...
  secure: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"^^xsd:boolean` : null, this.predicate, 'secure');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
...
>>>>>>> origin/develop
  ...
  host: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'host');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  port: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"^^xsd:positiveInteger` : null, this.predicate, 'port');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  query: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'query');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  query_initial: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'query_initial');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  query_index_field: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'query_index_field');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
...
<<<<<<< HEAD
    ...
    binding(iri, value) {
      return parameterizePredicate(
        iri,
        value ? `"${value}"^^xsd:positiveInteger` : null,
        this.predicate,
        'query_sleep_interval'
      );
    },
...
>>>>>>> origin/develop
  ...
  ca: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'ca');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  api_key: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'api_key');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  username: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'username');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  passphrase: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'passphrase');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  listen: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'listen');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  listen_exchange: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'listen_exchange');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  push: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'push');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
  ...
  push_exchange: {
    ...
    binding(iri, value) {
      return parameterizePredicate(iri, value ? `"${value}"` : null, this.predicate, 'push_exchange');
    },
    optional(iri, value) {
      return optionalizePredicate(this.binding(iri, value));
    },
