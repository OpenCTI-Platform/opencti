...
export const connectionInformationPredicateMap = {
  ...
  secure: {
    ...
    binding: function (iri, value) { return parameterizePredicate(iri, value ? `"${value}"^^xsd:boolean` : null,  this.predicate, "secure");},
    optional: function (iri, value) { return optionalizePredicate(this.binding(iri, value));},
  },
  host: {
  ...
  query_sleep_interval: {
    ...
    binding: function (iri, value) { return parameterizePredicate(iri, value ? `"${value}"^^xsd:positiveInteger` : null,  this.predicate, "query_sleep_interval");},
    optional: function (iri, value) { return optionalizePredicate(this.binding(iri, value));},
  },
  ca: {
