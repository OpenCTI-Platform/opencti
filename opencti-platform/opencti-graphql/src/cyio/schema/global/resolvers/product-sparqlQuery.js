...
export const productPredicateMap = {
  ...
  defanged: {
    ...
    binding: function (iri, value) { return parameterizePredicate(iri, value !== undefined ? `"${value}"^^xsd:boolean` : null, this.predicate, "defanged")},
    optional: function (iri, value) { return optionalizePredicate(this.binding(iri, value));}
  },
  cpe_identifier: {
  ...
  critical_software: {
    ...
    binding: function (iri, value) { return parameterizePredicate(iri, value !== undefined ? `"${value}"^^xsd:boolean` : null, this.predicate, "critical_software")},
    optional: function (iri, value) { return optionalizePredicate(this.binding(iri, value));}
  },
  software_type: {
    predicate: "<http://docs.oasis-open.org/ns/cti/stix/ext/ex14028#software_type>",
    binding: function (iri, value) { return parameterizePredicate(iri, value ? `"${value}"` : null,  this.predicate, "software_type")},
    optional: function (iri, value) { return optionalizePredicate(this.binding(iri, value));}
  },
}

export const productSingularizeSchema = { singularizeVariables: {
