...
import { isStixMetaObject, isStixMetaSpecObject } from './stixMetaObject';
...
export const isStixSpecificationObject = (type) =>
  isStixCoreObject(type) || isStixMetaSpecObject(type) || type === ABSTRACT_STIX_OBJECT;
