...
export const INPUT_CONTAINS = 'objectContains';
export const INPUT_RESOLVES_TO = 'resolvesTo';
export const INPUT_BELONGS_TO = 'belongsTo';
export const INPUT_FROM = 'objectFrom';
export const INPUT_SENDER = 'objectSender';
export const INPUT_TO = 'objectTo';
export const INPUT_CC = 'objectCc';
export const INPUT_BCC = 'objectBcc';
...
export const INPUT_SRC = 'objectSrc';
export const INPUT_DST = 'objectDst';
export const INPUT_SRC_PAYLOAD = 'srcPayload';
export const INPUT_DST_PAYLOAD = 'dstPayload';
export const INPUT_ENCAPSULATES = 'objectEncapsulates';
...
export const INPUT_IMAGE = 'objectImage';
export const INPUT_PARENT = 'objectParent';
export const INPUT_CHILD = 'objectChild';
export const INPUT_BODY_MULTIPART = 'bodyMultipart';
export const INPUT_VALUES = 'objectValues';
