...
export const isInternalObject = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ABSTRACT_INTERNAL_OBJECT) || type === ABSTRACT_INTERNAL_OBJECT;
export const isDatedInternalObject = (type) => DATED_INTERNAL_OBJECTS.includes(type);
export const isHistoryObject = (type) => HISTORY_OBJECTS.includes(type);
