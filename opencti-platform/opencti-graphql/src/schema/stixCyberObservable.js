...
export const isStixCyberObservableHashedObservable = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ABSTRACT_STIX_CYBER_OBSERVABLE_HASHED_OBSERVABLE)
    || type === ABSTRACT_STIX_CYBER_OBSERVABLE_HASHED_OBSERVABLE;
export const isStixCyberObservable = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ABSTRACT_STIX_CYBER_OBSERVABLE)
