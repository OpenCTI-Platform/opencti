...
export const openedConnections = {
...
export const STIX_REF_RELATIONSHIPS = [
    operatingSystems,
    samples,
    contains,
    resolvesTo,
...
export const objectOrganization = {
...
export const objectParticipant = {
...
// Register
schemaTypesDefinition.register(ABSTRACT_STIX_REF_RELATIONSHIP, [...STIX_REF_RELATIONSHIPS, ...META_RELATIONS].map((arr) => arr.databaseName));
export const isStixRefRelationship = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ABSTRACT_STIX_REF_RELATIONSHIP) || type === ABSTRACT_STIX_REF_RELATIONSHIP;
export const buildRelationRef = (relationRef, checker) => {
    return Object.assign(Object.assign({}, relationRef), { checker });
};
