...
export const buildRefRelationKey = (type, field = ID_INTERNAL) =>
  `${REL_INDEX_PREFIX}${type}.${field}`;
export const buildRefRelationSearchKey = (type, field = ID_INTERNAL) =>
  `${buildRefRelationKey(type, field)}.keyword`;
