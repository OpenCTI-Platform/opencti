...
const entityValidators = new Map<
  string,
  { validatorCreation?: ValidatorFn; validatorUpdate?: ValidatorFn }
>();
export const registerEntityValidator = (
  type: string,
  validators: { validatorCreation?: ValidatorFn; validatorUpdate?: ValidatorFn },
) => {
