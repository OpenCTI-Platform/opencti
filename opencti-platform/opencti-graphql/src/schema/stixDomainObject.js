import { ABSTRACT_INTERNAL_OBJECT, ABSTRACT_INTERNAL_RELATIONSHIP, ABSTRACT_STIX_DOMAIN_OBJECT, ABSTRACT_STIX_META_OBJECT, ABSTRACT_STIX_REF_RELATIONSHIP, ENTITY_TYPE_CONTAINER, ENTITY_TYPE_IDENTITY, ENTITY_TYPE_LOCATION, ENTITY_TYPE_THREAT_ACTOR } from './general';
import { ENTITY_TYPE_CONTAINER_GROUPING } from '../modules/grouping/grouping-types';
import { ENTITY_TYPE_TAXII_COLLECTION, ENTITY_TYPE_WORK } from './internalObject';
import { aliases, xOpenctiAliases } from './attribute-definition';
...
export const isStixDomainObjectContainer = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ENTITY_TYPE_CONTAINER)
    || type === ENTITY_TYPE_CONTAINER;
const STIX_DOMAIN_OBJECT_SHAREABLE_CONTAINERS = [
    ENTITY_TYPE_CONTAINER_OBSERVED_DATA,
    ENTITY_TYPE_CONTAINER_GROUPING,
    ENTITY_TYPE_CONTAINER_REPORT,
];
export const isStixDomainObjectShareableContainer = (type) => {
...
export const isStixDomainObjectLocation = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ENTITY_TYPE_LOCATION)
    || type === ENTITY_TYPE_LOCATION;
const STIX_DOMAIN_OBJECT_THREAT_ACTORS = [
    ENTITY_TYPE_THREAT_ACTOR_GROUP,
];
schemaTypesDefinition.register(ENTITY_TYPE_THREAT_ACTOR, STIX_DOMAIN_OBJECT_THREAT_ACTORS);
export const isStixDomainObjectThreatActor = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ENTITY_TYPE_THREAT_ACTOR)
...
export const isStixDomainObjectCase = (type) => schemaTypesDefinition.isTypeIncludedIn(type, ENTITY_TYPE_CONTAINER_CASE)
...
export const registerStixDomainAliased = (type) => {
