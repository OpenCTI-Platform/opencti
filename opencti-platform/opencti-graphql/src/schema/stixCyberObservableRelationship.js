...
import { RELATION_CREATED_BY } from './stixMetaRelationship';
...
export const INPUT_RELATION_CONTENT = 'content';
...
export const INPUT_CHILD = 'childs';
...
export const singleStixCyberObservableRelationshipsInputs = [
  INPUT_SAMPLE,
  INPUT_FROM,
  INPUT_SENDER,
  INPUT_RAW_EMAIL,
...
export const isSingleStixCyberObservableRelationshipInput = (input) =>
  R.includes(input, singleStixCyberObservableRelationshipsInputs);
