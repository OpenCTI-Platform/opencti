...
export const generateOpenBasScenario = async (
  ...
  if (totalTime > 120000) {
    logApp.warn(`[OPENCTI-MODULE][XTM] Long scenario generation time. Generating ${createAndInjectScenarioPromises.length} emails took ${totalTime} ms`, { simulationType });
  }
