...
export const findById: DomainFindById<BasicStoreEntityCaseTemplate> = (
  context: AuthContext,
  user: AuthUser,
  templateId: string,
) => {
...
export const findCaseTemplatePaginated = (
  context: AuthContext,
  user: AuthUser,
  opts: EntityOptions<BasicStoreEntityCaseTemplate>,
) => {
  return pageEntitiesConnection<BasicStoreEntityCaseTemplate>(
    context,
    user,
    [ENTITY_TYPE_CASE_TEMPLATE],
    opts,
...
export const taskTemplatesPaginated = async (
  context: AuthContext,
  user: AuthUser,
  caseId: string,
...
export const caseTemplateAdd = async (
  context: AuthContext,
  user: AuthUser,
...
export const caseTemplateDelete = async (
  context: AuthContext,
  user: AuthUser,
  caseTemplateId: string,
) => {
  const element = await deleteElementById<StoreEntityCase>(
    context,
    user,
    caseTemplateId,
    ENTITY_TYPE_CASE_TEMPLATE,
...
export const caseTemplateEdit = async (
  context: AuthContext,
  user: AuthUser,
  caseTemplateId: string,
  input: EditInput[],
...
export const caseTemplateAddRelation = async (
  context: AuthContext,
  user: AuthUser,
  caseTemplateId: string,
  input: StixRefRelationshipAddInput,
) => {
  const relation = await stixObjectOrRelationshipAddRefRelation(
    context,
    user,
    caseTemplateId,
    input,
...
export const caseTemplateDeleteRelation = async (
  context: AuthContext,
  user: AuthUser,
  caseTemplateId: string,
  toId: string,
  ...
  const caseTemplate = await stixObjectOrRelationshipDeleteRefRelation(
    context,
    user,
    caseTemplateId,
    toId,
  ...
  const task = (await storeLoadById(
    context,
    user,
    toId,
    ENTITY_TYPE_TASK_TEMPLATE,
  )) as BasicStoreEntityTaskTemplate;
  await publishUserAction({
    user,
    event_type: 'mutation',
    event_scope: 'delete',
    ...
    context_data: {
      id: caseTemplateId,
      entity_type: ENTITY_TYPE_CASE_TEMPLATE,
      input: { caseTemplateId, toId, relationshipType },
    },
  });
