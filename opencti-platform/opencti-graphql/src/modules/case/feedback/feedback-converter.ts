...
import { ENTITY_TYPE_CONTAINER_FEEDBACK, type StoreEntityFeedback, type StoreEntityStix2Feedback } from './types/store';
...
import type { StixFeedback as Stix2Feedback } from './types/stix-2-0';
