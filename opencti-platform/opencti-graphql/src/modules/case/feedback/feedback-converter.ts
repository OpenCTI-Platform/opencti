...
import { ENTITY_TYPE_CONTAINER_FEEDBACK, type StixFeedback, type StoreEntityFeedback, type Stix2Feedback } from './feedback-types';
...
export const convertFeedbackToStix_2_0 = (instance: StoreEntityFeedback): Stix2Feedback => {
  assertType(ENTITY_TYPE_CONTAINER_FEEDBACK, instance.entity_type);
