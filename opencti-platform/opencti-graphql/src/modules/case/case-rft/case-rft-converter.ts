...
import { ENTITY_TYPE_CONTAINER_CASE_RFT, type Stix2CaseRft, type StixCaseRft, type StoreEntityCaseRft } from './case-rft-types';
...
export const convertCaseRftToStix_2_0 = (instance: StoreEntityCaseRft): Stix2CaseRft => {
  assertType(ENTITY_TYPE_CONTAINER_CASE_RFT, instance.entity_type);
