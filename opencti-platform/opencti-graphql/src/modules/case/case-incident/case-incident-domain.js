...
export const findById = (context, user, caseIncidentId) => {
...
export const findAll = (context, user, opts) => {
    return listEntitiesPaginated(context, user, [ENTITY_TYPE_CONTAINER_CASE_INCIDENT], opts);
};
export const addCaseIncident = (context, user, caseIncidentAdd) => __awaiter(void 0, void 0, void 0, function* () {
    let caseToCreate = caseIncidentAdd.created ? caseIncidentAdd : Object.assign(Object.assign({}, caseIncidentAdd), { created: now() });
    ...
    const created = yield createEntity(context, user, caseToCreate, ENTITY_TYPE_CONTAINER_CASE_INCIDENT);
    if (caseTemplates) {
...
export const caseIncidentContainsStixObjectOrStixRelationship = (context, user, caseIncidentId, thingId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const caseIncidentFound = yield findAll(context, user, args);
