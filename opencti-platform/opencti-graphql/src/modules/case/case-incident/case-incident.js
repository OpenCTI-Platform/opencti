...
const CASE_INCIDENT_DEFINITION = {
    type: {
        id: 'case-incident',
    ...
    attributes: [
        ...
        { name: 'response_types', label: 'Incident type', type: 'string', format: 'short', mandatoryType: 'customizable', editDefault: true, multiple: true, upsert: true, isFilterable: true },
    ],
    relations: [],
