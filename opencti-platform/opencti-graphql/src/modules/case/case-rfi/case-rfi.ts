...
const CASE_RFI_DEFINITION: ModuleDefinition<StoreEntityCaseRfi, StixCaseRfi> = {
  ...
  attributes: [
    ...
    { name: 'x_opencti_request_access', label: 'Request access data as json field', type: 'string', format: 'text', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'ORGA_SHARING_REQUEST_FF' },
  ],
  relations: [],
