...
export const findById = (
  ...
  return storeLoadById(
    ...
    channelId,
    ENTITY_TYPE_CHANNEL,
  ) as unknown as BasicStoreEntityChannel;
};

export const findChannelPaginated = (
  context: AuthContext,
  user: AuthUser,
  opts: QueryChannelsArgs,
) => {
  return pageEntitiesConnection<BasicStoreEntityChannel>(
    context,
    user,
    [ENTITY_TYPE_CHANNEL],
    opts,
