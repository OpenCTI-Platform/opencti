...
import { ENTITY_TYPE_ATTACK_PATTERN, ENTITY_TYPE_IDENTITY_INDIVIDUAL, ENTITY_TYPE_IDENTITY_SECTOR, ENTITY_TYPE_INFRASTRUCTURE, ENTITY_TYPE_LOCATION_CITY, ENTITY_TYPE_LOCATION_COUNTRY, ENTITY_TYPE_LOCATION_POSITION, ENTITY_TYPE_LOCATION_REGION, ENTITY_TYPE_MALWARE, ENTITY_TYPE_TOOL, ENTITY_TYPE_VULNERABILITY } from '../../schema/stixDomainObject';
...
import { ENTITY_DOMAIN_NAME, ENTITY_HASHED_OBSERVABLE_STIX_FILE, ENTITY_HOSTNAME, ENTITY_MEDIA_CONTENT, ENTITY_TEXT, ENTITY_URL, ENTITY_USER_ACCOUNT } from '../../schema/stixCyberObservable';
...
export const CHANNEL_DEFINITION = {
    ...
    attributes: [
        ...
        { name: 'channel_types', label: 'Channel types', type: 'string', format: 'short', mandatoryType: 'customizable', editDefault: true, multiple: true, upsert: true, isFilterable: true },
    ],
    relations: [
        {
