 ...
 *
 * The two users are read through the domain resolver rather than the user cache: the cache is
 * refreshed asynchronously, so a merge started right after a rights change would report the
 * exposure of a stale projection.
 */
