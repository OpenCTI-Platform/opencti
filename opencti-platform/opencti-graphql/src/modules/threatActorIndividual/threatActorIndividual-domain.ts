...
export const findById: DomainFindById<BasicStoreEntityThreatActorIndividual> = (
  context: AuthContext,
  user: AuthUser,
  threatActorIndividualId: string,
) => {
  return storeLoadById<BasicStoreEntityThreatActorIndividual>(
    context,
    user,
...
export const findThreatActorIndividualPaginated = (
  context: AuthContext,
  user: AuthUser,
  opts: EntityOptions<BasicStoreEntityThreatActorIndividual>,
) => {
  return pageEntitiesConnection<BasicStoreEntityThreatActorIndividual>(
    context,
    user,
    [ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL],
    opts,
...
export const addThreatActorIndividual = async (
  context: AuthContext,
  user: AuthUser,
