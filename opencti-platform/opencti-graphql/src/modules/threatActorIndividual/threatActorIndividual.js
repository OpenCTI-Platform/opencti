...
import { RELATION_ATTRIBUTED_TO, RELATION_CITIZEN_OF, RELATION_COMPROMISES, RELATION_COOPERATES_WITH, RELATION_EMPLOYED_BY, RELATION_HOSTS, RELATION_IMPERSONATES, RELATION_LOCATED_AT, RELATION_NATIONAL_OF, RELATION_OWNS, RELATION_PART_OF, RELATION_PARTICIPATES_IN, RELATION_RESIDES_IN, RELATION_TARGETS, RELATION_USES } from '../../schema/stixCoreRelationship';
import { ENTITY_TYPE_ATTACK_PATTERN, ENTITY_TYPE_CAMPAIGN, ENTITY_TYPE_IDENTITY_INDIVIDUAL, ENTITY_TYPE_IDENTITY_SECTOR, ENTITY_TYPE_IDENTITY_SYSTEM, ENTITY_TYPE_INFRASTRUCTURE, ENTITY_TYPE_LOCATION_CITY, ENTITY_TYPE_LOCATION_COUNTRY, ENTITY_TYPE_LOCATION_POSITION, ENTITY_TYPE_LOCATION_REGION, ENTITY_TYPE_MALWARE, ENTITY_TYPE_THREAT_ACTOR_GROUP, ENTITY_TYPE_TOOL, ENTITY_TYPE_VULNERABILITY } from '../../schema/stixDomainObject';
...
const THREAT_ACTOR_INDIVIDUAL_DEFINITION = {
    type: {
