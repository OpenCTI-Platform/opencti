import { convertNarrativeToStix_2_0, convertNarrativeToStix_2_1 } from './narrative-converter';
import { NAME_FIELD, normalizeName } from '../../schema/identifier';
import {
  ENTITY_TYPE_NARRATIVE,
  type Stix2Narrative,
  type StixNarrative,
  type StoreEntityNarrative,
...
const NARRATIVE_DEFINITION: ModuleDefinition<StoreEntityNarrative, StixNarrative, Stix2Narrative> =
  {
    ...
    relations: [
      {
        ...
        targets: [{ name: ENTITY_TYPE_NARRATIVE, type: REL_NEW }],
      },
      {
        name: RELATION_DERIVED_FROM,
        targets: [{ name: ENTITY_TYPE_NARRATIVE, type: REL_BUILT_IN }],
      },
    ],
    ...
    converter_2_0: convertNarrativeToStix_2_0,
  };
