...
const stixCyberObservablesAttributes: { [k: string]: Array<AttributeDefinition> } = {
  ...
  [ENTITY_NETWORK_TRAFFIC]: [
    ...
    { name: 'src_port', type: 'numeric', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'dst_port', type: 'numeric', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'protocols', type: 'string', mandatoryType: 'no', multiple: true, upsert: true },
    { name: 'src_byte_count', type: 'numeric', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'dst_byte_count', type: 'numeric', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'src_packets', type: 'numeric', mandatoryType: 'no', multiple: false, upsert: true },
    { name: 'dst_packets', type: 'numeric', mandatoryType: 'no', multiple: false, upsert: true },
  ],
  [ENTITY_PROCESS]: [
    { name: 'extensions', type: 'string', mandatoryType: 'no', multiple: false, upsert: true },
  ...
  [ENTITY_WINDOWS_REGISTRY_KEY]: [
    ...
    { name: 'number_of_subkeys', type: 'numeric', mandatoryType: 'no', multiple: false, upsert: true },
  ],
  [ENTITY_WINDOWS_REGISTRY_VALUE_TYPE]: [
    { name: 'name', type: 'string', mandatoryType: 'no', multiple: false, upsert: true },
