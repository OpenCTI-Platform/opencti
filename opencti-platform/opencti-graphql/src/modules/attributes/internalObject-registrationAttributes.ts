...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition<any>> } = {
  [ENTITY_TYPE_SETTINGS]: [
    ...
    { name: 'data_sanity_configuration', label: 'Data sanity configuration', type: 'object', format: 'flat', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: false },
  ],
  [ENTITY_TYPE_MIGRATION_STATUS]: [
