...
const HistoryDefinition: AttributeDefinition[] = [
  ...
  { name: 'request_metadata', label: 'Http request metadata', type: 'string', format: 'text', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false, featureFlag: 'AUDIT_USER_AGENT' },
  {
    name: 'applicant_id',
    label: 'Applicant',
    type: 'string',
