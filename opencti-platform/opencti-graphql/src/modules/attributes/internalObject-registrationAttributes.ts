...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  [ENTITY_TYPE_SETTINGS]: [
    ...
    { name: 'xtm_hub_enrollment_user_id', label: 'XTM Hub registration User ID', type: 'string', format: 'id', entityTypes: [ENTITY_TYPE_USER], mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
    { name: 'xtm_hub_enrollment_user_name', label: 'XTM Hub registration User name', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
    ...
    { name: 'xtm_hub_enrollment_date', label: 'XTM Hub registration date', type: 'date', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
    { name: 'xtm_hub_enrollment_status', label: 'XTM Hub registration status', type: 'string', format: 'enum', values: ['enrolled', 'unenrolled', 'lost_connectivity'], editDefault: false, mandatoryType: 'no', multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
  ],
  [ENTITY_TYPE_MIGRATION_STATUS]: [
