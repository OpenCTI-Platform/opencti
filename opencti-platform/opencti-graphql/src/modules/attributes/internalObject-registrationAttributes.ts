...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition<any>> } = {
  [ENTITY_TYPE_SETTINGS]: [
    ...
    { name: 'platform_map_tile_server_mode', label: 'Map tile server mode', type: 'string', format: 'enum', values: ['bundled', 's3'], editDefault: false, mandatoryType: 'no', multiple: false, upsert: false, isFilterable: false },
