...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  ...
  [ENTITY_TYPE_CONNECTOR]: [
    ...
    { name: 'connector_status', label: 'Connector status FIXME is it connector_state ??', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
