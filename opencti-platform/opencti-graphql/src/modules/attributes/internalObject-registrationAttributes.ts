...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  [ENTITY_TYPE_SETTINGS]: [
    ...
    { name: 'analytics_google_analytics_v4', type: 'string', mandatoryType: 'no', multiple: false, upsert: false },
  ],
  [ENTITY_TYPE_MIGRATION_STATUS]: [
  ...
  [ENTITY_TYPE_FEED]: [
    ...
    { name: 'feed_date_attribute', type: 'date', mandatoryType: 'external', multiple: false, upsert: false },
