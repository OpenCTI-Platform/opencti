...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  [ENTITY_TYPE_SETTINGS]: [
    ...
    { name: 'xtm_hub_token', label: 'XTM Hub Token', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
    { name: 'xtm_hub_enrollment_user_id', label: 'XTM Hub enrollment User ID', type: 'string', format: 'id', entityTypes: [ENTITY_TYPE_USER], mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
    { name: 'xtm_hub_enrollment_user_name', label: 'XTM Hub enrollment User name', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
    ...
    { name: 'xtm_hub_enrollment_date', label: 'XTM Hub enrollment date', type: 'date', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
    { name: 'xtm_hub_enrollment_status', label: 'XTM Hub enrollment status', type: 'string', format: 'enum', values: ['enrolled', 'unenrolled', 'lost_connectivity'], editDefault: false, mandatoryType: 'no', multiple: false, upsert: false, isFilterable: false, featureFlag: 'OCTI_ENROLLMENT' },
  ],
  [ENTITY_TYPE_MIGRATION_STATUS]: [
  ...
  [ENTITY_TYPE_USER]: [
    ...
    { name: 'account_status', label: 'Account status', type: 'string', format: 'short', mandatoryType: 'external', editDefault: true, multiple: false, upsert: false, isFilterable: false },
    ...
    { name: 'user_service_account', label: 'User service account', type: 'boolean', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: true, featureFlag: 'SERVICE_ACCOUNT' },
  ],
  [ENTITY_TYPE_ROLE]: [
    { name: 'name', label: 'Name', type: 'string', format: 'short', mandatoryType: 'external', editDefault: true, multiple: false, upsert: false, isFilterable: true },
