...
// START- Define ContextDataDefinition which is normally under HistoryDefinition in master where we have substituted `ContextDataDefinition`
// Extracted to support LogSearch since it is required to be defined within `HistoryDefinition` and `ENTITY_TYPE_SEARCH`
const ContextDataDefinition: AttributeDefinition = {
  ...
  mappings: [
    ...
    { name: 'result_count', label: 'Result count', type: 'numeric', precision: 'integer', editDefault: false, mandatoryType: 'no', multiple: false, upsert: true, isFilterable: true },
    { name: 'organization', label: 'Organization', type: 'string', format: 'short', editDefault: false, mandatoryType: 'no', multiple: false, upsert: true, isFilterable: true },
    { name: 'search_location', label: 'Search location', type: 'string', format: 'short', editDefault: false, mandatoryType: 'no', multiple: false, upsert: true, isFilterable: true },
    { name: 'groups', label: 'Groups', type: 'string', format: 'short', editDefault: false, mandatoryType: 'no', multiple: false, upsert: true, isFilterable: true },
    changes,
  ],
};
// END - Define ContextDataDefinition which is normally under HistoryDefinition in master where we have substituted `ContextDataDefinition`

// START: Moved from below
...
// START- Define UserDefinition which is normally under ENTITY_TYPE_USER in master
// Extracted to support LogSearch since it is required to be defined within `ENTITY_TYPE_USER` and `ENTITY_TYPE_SEARCH`
...
// END - Define UserDefinition which is normally under ENTITY_TYPE_USER in master
