...
const HistoryDefinition: AttributeDefinition[] = [
  ...
  { name: 'timestamp', label: 'Timestamp', type: 'date', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: true },
  {
    ...
    mappings: [
      ...
      { name: 'object_marking_refs_definitions', label: 'Marking definition labels', type: 'string', format: 'short', editDefault: false, mandatoryType: 'no', multiple: true, upsert: true, isFilterable: false },
