...
const stixDomainObjectLocationAttributes: Array<AttributeDefinition> = [
  { name: 'name', label: 'Name', type: 'string', mandatoryType: 'external', editDefault: true, multiple: false, upsert: true, isFilterable: true },
  { name: 'description', label: 'Description', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true, isFilterable: true },
  { name: 'latitude', label: 'Latitude', type: 'numeric', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
  { name: 'longitude', label: 'Longitude', type: 'numeric', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
  { name: 'precision', label: 'Precision', type: 'numeric', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: true },
  entityLocationType,
];
...
const stixDomainObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  ...
  [ENTITY_TYPE_CONTAINER_NOTE]: [
    ...
    { name: 'likelihood', label: 'Likelihood', type: 'numeric', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true, isFilterable: true },
  ...
  [ENTITY_TYPE_CONTAINER_OBSERVED_DATA]: [
    ...
    { name: 'number_observed', label: 'Number observed', type: 'numeric', mandatoryType: 'external', editDefault: true, multiple: false, upsert: true, isFilterable: true },
  ...
  [ENTITY_TYPE_INDICATOR]: [
    ...
    { name: 'x_opencti_score', label: 'Score', type: 'numeric', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true, isFilterable: true },
  ...
  [ENTITY_TYPE_VULNERABILITY]: [
    ...
    { name: 'name', label: 'Name', type: 'string', mandatoryType: 'external', editDefault: true, multiple: false, upsert: true, isFilterable: true },
    { name: 'description', label: 'Description', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true, isFilterable: true },
    { name: 'x_opencti_base_score', label: 'Base score', type: 'numeric', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
