...
const stixDomainObjectAttributes: Array<AttributeDefinition> = [
  ...
  revoked,
  { ...files, update: true },
  { name: 'x_opencti_graph_data', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false },
...
const stixDomainObjectIdentityAttributes: Array<AttributeDefinition> = [
  ...
  { name: 'contact_information', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, label: 'Contact information' },
  identityClass,
  { name: 'roles', type: 'string', mandatoryType: 'no', editDefault: false, multiple: true, upsert: false },
];
...
const stixDomainObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  [ENTITY_TYPE_ATTACK_PATTERN]: [
    ...
    { name: 'x_mitre_permissions_required', type: 'string', mandatoryType: 'no', editDefault: false, multiple: true, upsert: true },
    { name: 'x_mitre_detection', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
    {
      name: 'x_mitre_id',
      type: 'string',
  ...
  [ENTITY_TYPE_CAMPAIGN]: [
    ...
    { name: 'objective', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false },
  ],
  [ENTITY_TYPE_CONTAINER_NOTE]: [
    ...
    { name: 'content', type: 'string', mandatoryType: 'external', editDefault: true, multiple: false, upsert: true },
    { name: 'authors', type: 'string', mandatoryType: 'no', editDefault: false, multiple: true, upsert: false },
    {
      name: 'note_types',
      type: 'string',
      mandatoryType: 'customizable',
  ...
  [ENTITY_TYPE_CONTAINER_OPINION]: [
    { name: 'explanation', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true },
    { name: 'authors', type: 'string', mandatoryType: 'no', editDefault: false, multiple: true, upsert: false },
    { name: 'opinion', type: 'string', mandatoryType: 'external', editDefault: true, multiple: false, upsert: true },
    { name: 'content', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true },
    { name: 'content_mapping', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
  ],
  [ENTITY_TYPE_CONTAINER_REPORT]: [
    ...
    xOpenctiReliability,
    { name: 'published', type: 'date', mandatoryType: 'external', editDefault: true, multiple: false, upsert: false },
    { name: 'content', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true },
    { name: 'content_mapping', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
  ],
  [ENTITY_TYPE_COURSE_OF_ACTION]: [
    ...
    { name: 'name', type: 'string', mandatoryType: 'external', editDefault: true, multiple: false, upsert: true },
    { name: 'description', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true },
    { name: 'x_mitre_id', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
    { name: 'x_opencti_threat_hunting', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
    { name: 'x_opencti_log_sources', type: 'string', mandatoryType: 'no', editDefault: false, multiple: true, upsert: true },
  ],
  [ENTITY_TYPE_IDENTITY_INDIVIDUAL]: [
    xOpenctiAliases,
    iAliasedIds,
    xOpenctiReliability,
    { name: 'x_opencti_firstname', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false },
    { name: 'x_opencti_lastname', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false },
  ],
  [ENTITY_TYPE_IDENTITY_SECTOR]: [
    xOpenctiAliases,
    iAliasedIds,
  ...
  [ENTITY_TYPE_MALWARE]: [
    ...
    { name: 'first_seen', type: 'date', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, label: 'First seen' },
    { name: 'last_seen', type: 'date', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, label: 'last seen' },
    { name: 'architecture_execution_envs', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: true, upsert: true, label: 'Architecture execution env.' },
    { name: 'implementation_languages', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: true, upsert: true, label: 'Implementation languages' },
    { name: 'capabilities', type: 'string', mandatoryType: 'no', editDefault: false, multiple: true, upsert: false },
  ],
  [ENTITY_TYPE_THREAT_ACTOR_GROUP]: [
    aliases,
    iAliasedIds,
  ...
  [ENTITY_TYPE_TOOL]: [
    ...
    { name: 'tool_version', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, label: 'Tool version' },
  ],
  [ENTITY_TYPE_VULNERABILITY]: [
    xOpenctiAliases,
    iAliasedIds,
    ...
    { name: 'x_opencti_availability_impact', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
    { name: 'x_opencti_confidentiality_impact', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
  ],
  [ENTITY_TYPE_INCIDENT]: [
    ...
    { name: 'source', type: 'string', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true },
    { name: 'first_seen', type: 'date', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, label: 'First seen' },
    { name: 'last_seen', type: 'date', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, label: 'last seen' },
    { name: 'objective', type: 'string', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
  ],
};
