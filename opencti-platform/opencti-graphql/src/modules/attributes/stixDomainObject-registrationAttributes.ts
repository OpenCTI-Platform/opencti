...
const stixDomainObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  ...
  [ENTITY_TYPE_VULNERABILITY]: [
    ...
    { name: 'x_opencti_base_severity', label: 'Base severity', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
    { name: 'x_opencti_attack_vector', label: 'Attack vector', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
    { name: 'x_opencti_integrity_impact', label: 'Integrity impact', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
    { name: 'x_opencti_availability_impact', label: 'Availability impact', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
    { name: 'x_opencti_confidentiality_impact', label: 'Confidentiality impact', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
  ],
  [ENTITY_TYPE_INCIDENT]: [
