...
const containerAttributes: Array<AttributeDefinition> = [
  { name: 'templates',
    ...
    mappings: [
      ...
      { name: 'template_widgets_ids', label: 'Template widgets IDs', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: true, upsert: false, isFilterable: false },
    ] },
