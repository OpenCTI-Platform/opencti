...
const stixMetaObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  [ENTITY_TYPE_MARKING_DEFINITION]: [
    { name: 'definition_type', type: 'string', mandatoryType: 'external', multiple: false, upsert: false, label: 'Type' },
    { name: 'definition', type: 'string', mandatoryType: 'external', multiple: false, upsert: true, label: 'Definition' },
    { name: 'x_opencti_order', type: 'numeric', mandatoryType: 'external', multiple: false, upsert: false, label: 'Order' },
    { name: 'x_opencti_color', type: 'string', mandatoryType: 'no', multiple: false, upsert: false, label: 'Color' },
  ],
  [ENTITY_TYPE_LABEL]: [
  ...
  [ENTITY_TYPE_KILL_CHAIN_PHASE]: [
    { name: 'kill_chain_name', type: 'string', mandatoryType: 'external', multiple: false, upsert: false, label: 'Kill chain name' },
    { name: 'phase_name', type: 'string', mandatoryType: 'external', multiple: false, upsert: false, label: 'Phase name' },
    { name: 'x_opencti_order', type: 'numeric', mandatoryType: 'external', multiple: false, upsert: true, label: 'Order' },
  ],
};
