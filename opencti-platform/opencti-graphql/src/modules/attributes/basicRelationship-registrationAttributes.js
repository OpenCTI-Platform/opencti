import { baseType, createdAt, creators, entityType, id, internalId, parentTypes, relationshipType, standardId, updatedAt } from '../../schema/attribute-definition';
...
const basicRelationshipAttributes = [
    id,
    internalId,
    standardId,
    parentTypes,
    ...
    { name: 'i_inference_weight', label: 'Inference weight', type: 'numeric', precision: 'integer', editDefault: false, mandatoryType: 'no', multiple: false, upsert: false, isFilterable: true },
    {
        ...
        isFilterable: true,
        mappings: [
            Object.assign(Object.assign({}, internalId), { isFilterable: true, associatedFilterKeys: [
