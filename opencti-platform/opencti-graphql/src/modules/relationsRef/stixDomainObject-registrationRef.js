...
import { createdBy, externalReferences, killChainPhases, objectAssignee, objectLabel, objectMarking, objectOrganization, objectParticipant, objects, operatingSystems, samples, xOpenctiLinkedTo } from '../../schema/stixRefRelationship';
import { ENTITY_TYPE_ATTACK_PATTERN, ENTITY_TYPE_CAMPAIGN, ENTITY_TYPE_CONTAINER_NOTE, ENTITY_TYPE_CONTAINER_OBSERVED_DATA, ENTITY_TYPE_CONTAINER_OPINION, ENTITY_TYPE_CONTAINER_REPORT, ENTITY_TYPE_COURSE_OF_ACTION, ENTITY_TYPE_INCIDENT, ENTITY_TYPE_INFRASTRUCTURE, ENTITY_TYPE_INTRUSION_SET, ENTITY_TYPE_MALWARE, ENTITY_TYPE_THREAT_ACTOR_GROUP, ENTITY_TYPE_TOOL, ENTITY_TYPE_VULNERABILITY } from '../../schema/stixDomainObject';
...
schemaRelationsRefDefinition.registerRelationsRef(ENTITY_TYPE_MALWARE, [
    Object.assign(Object.assign({}, samples), { checker: (_, toType) => [ENTITY_HASHED_OBSERVABLE_ARTIFACT, ENTITY_HASHED_OBSERVABLE_STIX_FILE].includes(toType) }),
    Object.assign(Object.assign({}, operatingSystems), { checker: (_, toType) => ENTITY_SOFTWARE === toType }),
    killChainPhases,
    objectOrganization
]);
...
schemaRelationsRefDefinition.registerRelationsRef(ENTITY_TYPE_CONTAINER_OBSERVED_DATA, [Object.assign(Object.assign({}, objects), { mandatoryType: 'external' }), objectOrganization]);
