...
import {
  ...
  type Stix2SecurityPlatform,
  type StixSecurityPlatform,
  type StoreEntitySecurityPlatform,
} from './securityPlatform-types';
import convertSecurityPlatformToStix, {
  convertSecurityPlatformToStix_2_0,
} from './securityPlatform-converter';
...
const SECURITY_PLATFORM_DEFINITION: ModuleDefinition<
  StoreEntitySecurityPlatform,
  StixSecurityPlatform,
  Stix2SecurityPlatform
> = {
  type: {
  ...
  identifier: {
    definition: {
      [ENTITY_TYPE_IDENTITY_SECURITY_PLATFORM]: [
        { src: NAME_FIELD },
        { src: 'identity_class', dependencies: [NAME_FIELD] },
      ],
    },
    resolvers: {
      name(data: object) {
  ...
  attributes: [
    ...
    },
    {
      ...
      type: 'string',
      format: 'vocabulary',
      vocabularyCategory: 'security_platform_type_ov',
