...
const THEME_DEFINITION: ModuleDefinition<StoreEntityTheme, StixTheme> = {
  ...
  attributes: [
    ...
    },
    {
      ...
      label: 'Theme login aside gradient start',
      type: 'string',
      format: 'short',
      mandatoryType: 'no',
      editDefault: false,
    ...
    },
    {
      ...
      label: 'Theme login aside gradient end',
      type: 'string',
      format: 'short',
      mandatoryType: 'no',
      editDefault: false,
