...
const THEME_DEFINITION: ModuleDefinition<StoreEntityTheme, StixTheme> = {
  ...
  attributes: [
    ...
    { name: 'theme_advanced_override', label: 'Theme advanced override', type: 'string', format: 'text', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
  ],
  relations: [],
