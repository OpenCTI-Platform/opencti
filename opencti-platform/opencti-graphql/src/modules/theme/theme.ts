...
export const THEME_DEFINITION: ModuleDefinition<StoreEntityTheme, StixTheme> = {
  ...
  attributes: [
    ...
    { name: 'theme_background', label: 'Theme background color', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
    ...
    { name: 'theme_accent', label: 'Theme accent color', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
