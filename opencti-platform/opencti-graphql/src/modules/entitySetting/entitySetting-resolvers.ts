import { entitySettingEditField, entitySettingsEditField, findAll, findById, findByType } from './entitySetting-domain';
...
const entitySettingResolvers: Resolvers = {
  ...
  Mutation: {
    entitySettingFieldPatch: (_, { id, input }, context) => {
      return entitySettingEditField(context, context.user, id, input);
    },
