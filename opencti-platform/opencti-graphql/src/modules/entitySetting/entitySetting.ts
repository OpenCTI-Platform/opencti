...
export const ENTITY_SETTING_DEFINITION: ModuleDefinition<StoreEntityEntitySetting, StixEntitySetting> = {
  ...
  attributes: [
    ...
    { name: 'sync_workflow_status_by_name', label: 'Sync workflow status by name', type: 'boolean', mandatoryType: 'external', editDefault: true, multiple: false, upsert: false, isFilterable: false },
