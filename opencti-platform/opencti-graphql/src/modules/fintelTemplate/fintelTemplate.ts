...
export const FINTEL_TEMPLATE_DEFINITION: ModuleDefinition<
  StoreEntityFintelTemplate,
  StixFintelTemplate
> = {
  type: {
    id: 'fintelTemplates',
  ...
  attributes: [
    ...
    {
      name: 'fintel_template_widgets',
      label: 'Fintel template widgets',
      type: 'object',
      format: 'flat',
      mandatoryType: 'external',
      editDefault: false,
