...
export const findCustomFieldStixFilterKeys = async (context: AuthContext, user: AuthUser, entityType?: string | null) => {
  return getCustomFieldDefinitions(context, user).then((definitions) => {
    if (!entityType) {
