...
export const findById = (
  ...
  ) as unknown as BasicStoreEntityLanguage;
};

export const findLanguagePaginated = (
  context: AuthContext,
  user: AuthUser,
  opts: QueryLanguagesArgs,
) => {
  return pageEntitiesConnection<BasicStoreEntityLanguage>(
    context,
    user,
    [ENTITY_TYPE_LANGUAGE],
    opts,
