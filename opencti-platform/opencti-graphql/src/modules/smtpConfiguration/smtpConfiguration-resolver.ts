...
const smtpConfigurationResolvers: Resolvers = {
  ...
  Mutation: {
    smtpConfigurationEdit: (_, { input }, context) =>
      smtpConfigurationEdit(context, context.user!, input),
    smtpConfigurationDelete: (_, __, context) => smtpConfigurationDelete(context, context.user!),
    smtpConfigurationTest: (_, { email }, context) =>
      smtpConfigurationTest(context, context.user!, email),
  },
};
