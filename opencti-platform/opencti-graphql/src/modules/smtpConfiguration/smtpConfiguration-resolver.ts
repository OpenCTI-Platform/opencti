...
import { smtpConfigurationAdd, getSmtpConfigurationForAdmin, smtpConfigurationDelete, smtpConfigurationTest, smtpConfigurationUpdate } from './smtpConfiguration-domain';
