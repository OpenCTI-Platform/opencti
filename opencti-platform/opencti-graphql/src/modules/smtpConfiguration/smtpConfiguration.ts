...
const SMTP_CONFIGURATION_DEFINITION: ModuleDefinition<StoreEntitySmtpConfiguration, StixSmtpConfiguration> = {
  ...
  attributes: [
    ...
    { name: 'password_encrypted', label: 'Password (encrypted)', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
