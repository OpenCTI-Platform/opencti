...
const DISSEMINATION_LIST_DEFINITION: ModuleDefinition<StoreEntityDisseminationList, StixDisseminationList> = {
  ...
  attributes: [
    { name: 'name', label: 'Name', type: 'string', format: 'short', mandatoryType: 'external', editDefault: false, multiple: false, upsert: false, isFilterable: true, featureFlag: 'DISSEMINATIONLISTS' },
    { name: 'emails', label: 'Emails', type: 'string', format: 'short', mandatoryType: 'external', editDefault: false, multiple: true, upsert: false, isFilterable: true, featureFlag: 'DISSEMINATIONLISTS' },
