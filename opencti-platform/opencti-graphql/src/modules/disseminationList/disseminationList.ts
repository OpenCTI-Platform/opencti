...
import { ENTITY_TYPE_DISSEMINATION_LIST } from './disseminationList-types';

const DISSEMINATION_LIST_DEFINITION: InternalObjectModuleDefinition = {
  type: {
...
registerInternalObjectDefinition(DISSEMINATION_LIST_DEFINITION);
