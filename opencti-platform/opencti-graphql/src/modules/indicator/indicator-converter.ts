...
import { buildKillChainPhases, buildMITREExtensions, buildStixDomain, cleanObject, convertToStixDate } from '../../database/stix-converter-2-1';
import { STIX_EXT_MITRE, STIX_EXT_OCTI } from '../../types/stix-2-1/stix-extensions';
