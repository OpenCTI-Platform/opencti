...
const INDICATOR_DEFINITION: ModuleDefinition<StoreEntityIndicator, StixIndicator, Stix2Indicator> = {
  ...
  attributes: [
    ...
    { name: 'x_opencti_detection', label: 'Is detected', type: 'boolean', mandatoryType: 'no', editDefault: false, defaultNullValue: false, multiple: false, upsert: true, isFilterable: true },
    { name: 'x_opencti_main_observable_type', label: 'Main observable type', type: 'string', format: 'short', mandatoryType: 'external', editDefault: true, defaultNullValue: 'Unknown', multiple: false, upsert: true, isFilterable: true },
