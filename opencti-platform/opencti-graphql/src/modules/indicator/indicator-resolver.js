import { addIndicator, findAll, findById, getDecayChartData, getDecayDetails, indicatorsDistributionByEntity, indicatorsNumber, indicatorsNumberByEntity, indicatorsTimeSeries, indicatorsTimeSeriesByEntity, observablesPaginated } from './indicator-domain';
...
const indicatorResolvers = {
    ...
    Indicator: {
        ...
        observables: (indicator, args, context) => observablesPaginated(context, context.user, indicator.id, args),
