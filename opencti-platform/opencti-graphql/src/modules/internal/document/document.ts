...
const attributes: Array<AttributeDefinition> = [
  ...
  { name: 'uploadStatus', label: 'Upload status', type: 'string', format: 'enum', values: Object.values(State), mandatoryType: 'internal', editDefault: false, multiple: false, upsert: false, isFilterable: true },
