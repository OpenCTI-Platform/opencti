...
const attributes: Array<AttributeDefinition> = [
  ...
  {
    name: 'lastModifiedSinceMin',
    label: 'Last modification since',
    type: 'numeric',
    precision: 'integer',
    mandatoryType: 'internal',
    editDefault: false,
  ...
  },
  {
    ...
    mappings: [
      ...
      },
      {
        ...
        label: 'Related external reference',
        type: 'string',
        format: 'short',
        mandatoryType: 'internal',
        editDefault: false,
      ...
      {
        name: 'analysis_content_source',
        label: 'Analysis content source',
        type: 'string',
        format: 'short',
        mandatoryType: 'internal',
        editDefault: false,
