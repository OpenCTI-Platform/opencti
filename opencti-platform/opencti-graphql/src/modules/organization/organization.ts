...
const ORGANIZATION_DEFINITION: ModuleDefinition<StoreEntityOrganization, StixOrganization> = {
  ...
  attributes: [
    ...
    { name: 'x_opencti_organization_type', label: 'Organization type', type: 'string', format: 'enum', values: ['Constituent', 'CSIRT', 'Partner', 'Vendor', 'Other'], mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true, isFilterable: true },
