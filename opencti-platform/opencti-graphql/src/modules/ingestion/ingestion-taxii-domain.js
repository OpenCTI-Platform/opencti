...
export const findById = (context, user, ingestionId) => {
    return storeLoadById(context, user, ingestionId, ENTITY_TYPE_INGESTION_TAXII);
};
export const findAllPaginated = (context, user, opts = {}) => __awaiter(void 0, void 0, void 0, function* () {
    return listEntitiesPaginated(context, user, [ENTITY_TYPE_INGESTION_TAXII], opts);
});
export const findAllTaxiiIngestions = (context, user, opts = {}) => __awaiter(void 0, void 0, void 0, function* () {
    return listAllEntities(context, user, [ENTITY_TYPE_INGESTION_TAXII], opts);
});
export const addIngestion = (context, user, input) => __awaiter(void 0, void 0, void 0, function* () {
    const { element, isCreation } = yield createEntity(context, user, input, ENTITY_TYPE_INGESTION_TAXII, { complete: true });
    if (isCreation) {
...
export const patchTaxiiIngestion = (context, user, id, patch) => __awaiter(void 0, void 0, void 0, function* () {
    const patched = yield patchAttribute(context, user, id, ENTITY_TYPE_INGESTION_TAXII, patch);
    return patched.element;
});
export const ingestionEditField = (context, user, ingestionId, input) => __awaiter(void 0, void 0, void 0, function* () {
    const { element } = yield updateAttribute(context, user, ingestionId, ENTITY_TYPE_INGESTION_TAXII, input);
    yield publishUserAction({
        user,
        event_type: 'mutation',
        event_scope: 'update',
...
export const ingestionDelete = (context, user, ingestionId) => __awaiter(void 0, void 0, void 0, function* () {
    const deleted = yield deleteElementById(context, user, ingestionId, ENTITY_TYPE_INGESTION_TAXII);
    yield publishUserAction({
        user,
        event_type: 'mutation',
        event_scope: 'delete',
