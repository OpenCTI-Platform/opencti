...
const INGESTION_JSON_DEFINITION: ModuleDefinition<StoreEntityIngestionJson, StixIngestionJson> = {
  ...
  attributes: [
    ...
    { name: 'headers', label: 'Headers', type: 'object', format: 'flat', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true, isFilterable: true },
    { name: 'query_attributes', label: 'Query attributes', type: 'object', format: 'flat', mandatoryType: 'customizable', editDefault: true, multiple: false, upsert: true, isFilterable: true },
