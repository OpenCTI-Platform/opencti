...
const INGESTION_JSON_DEFINITION: ModuleDefinition<StoreEntityIngestionJson, StixIngestionJson> = {
  ...
  attributes: [
    ...
    { name: 'ingestion_json_state', label: 'Ingestion state', type: 'object', format: 'flat', mandatoryType: 'external', editDefault: true, multiple: false, upsert: true, isFilterable: true },
