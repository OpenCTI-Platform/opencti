...
const INGESTION_JSON_DEFINITION: ModuleDefinition<StoreEntityIngestionJson, StixIngestionJson> = {
  ...
  attributes: [
    ...
    },
    {
      ...
      label: 'Sub pagination activation',
      type: 'boolean',
      mandatoryType: 'customizable',
      editDefault: true,
      multiple: false,
    ...
    {
      name: 'json_mapper_id',
      label: 'Json_mapper_id',
      type: 'string',
      format: 'id',
      entityTypes: [ENTITY_TYPE_JSON_MAPPER],
      mandatoryType: 'external',
      editDefault: true,
      multiple: false,
      upsert: true,
