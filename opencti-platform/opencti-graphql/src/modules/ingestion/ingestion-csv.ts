...
import {
  ...
  type StixIngestionCsv,
  type StoreEntityIngestionCsv,
...
const INGESTION_CSV_DEFINITION: ModuleDefinition<StoreEntityIngestionCsv, StixIngestionCsv> = {
  ...
  attributes: [
    ...
    },
    {
      ...
      type: 'string',
      format: 'id',
      entityTypes: [ENTITY_TYPE_CSV_MAPPER],
      mandatoryType: 'external',
      editDefault: true,
      multiple: false,
      upsert: true,
