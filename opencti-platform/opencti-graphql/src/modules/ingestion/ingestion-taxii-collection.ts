...
import {
  ...
  type StixIngestionTaxiiCollection,
...
const INGESTION_DEFINITION: ModuleDefinition<
...
> = {
  ...
  attributes: [
    ...
    },
    {
      ...
      label: 'Copy confidence level to OpenCTI scores for indicators',
      type: 'boolean',
      mandatoryType: 'no',
      editDefault: true,
      multiple: false,
