...
import { type Stix2Grouping, ENTITY_TYPE_CONTAINER_GROUPING, type StixGrouping, type StoreEntityGrouping } from './grouping-types';
...
export const convertGroupingToStix_2_0 = (instance: StoreEntityGrouping): Stix2Grouping => {
  assertType(ENTITY_TYPE_CONTAINER_GROUPING, instance.entity_type);
