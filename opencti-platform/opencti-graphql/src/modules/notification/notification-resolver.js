...
import { addTrigger, addTriggerActivity, getTriggerRecipients, myNotificationsFind, myUnreadNotificationsCount, notificationDelete, notificationEditRead, notificationGet, notificationsFind, triggerActivityEdit, triggerDelete, triggerEdit, triggerGet, triggersActivityFind, triggersGet, triggersKnowledgeCount, triggersKnowledgeFind, } from './notification-domain';
