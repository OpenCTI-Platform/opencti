...
const TAXII_COLLECTION_DEFINITION: ModuleDefinition<StoreEntityTaxiiCollection, StixTaxiiCollection> = {
  ...
  attributes: [
    ...
    { name: 'taxii_public_authorized_markings', label: 'Public taxii authorized markings', type: 'string', format: 'id', entityTypes: [ENTITY_TYPE_MARKING_DEFINITION], mandatoryType: 'no', editDefault: true, multiple: true, upsert: false, isFilterable: false },
