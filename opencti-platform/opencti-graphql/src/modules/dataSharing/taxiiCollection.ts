...
const TAXII_COLLECTION_DEFINITION: ModuleDefinition<
  StoreEntityTaxiiCollection,
  StixTaxiiCollection
> = {
  type: {
    id: 'taxii-collection',
  ...
  attributes: [
    ...
    },
    {
      ...
      label: 'Copy OpenCTI scores to confidence level for indicators',
      type: 'boolean',
      mandatoryType: 'no',
      editDefault: true,
      multiple: false,
