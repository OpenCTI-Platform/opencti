...
const TAXII_COLLECTION_DEFINITION: ModuleDefinition<StoreEntityTaxiiCollection, StixTaxiiCollection> = {
  ...
  attributes: [
    ...
    { name: 'taxii_public_user_id', label: 'Public taxii user id', type: 'string', format: 'id', mandatoryType: 'no', editDefault: true, multiple: false, upsert: false, isFilterable: false },
    { name: 'taxii_public_authorized_markings', label: 'Public taxii authorized markings', type: 'string', format: 'id', mandatoryType: 'no', editDefault: true, multiple: true, upsert: false, isFilterable: false },
