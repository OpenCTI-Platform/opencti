  ...
  attributes: [
    ...
    },
    {
      ...
      mappings: [
        ...
        {
          name: 'multi_match_strategy',
          label: 'Multi-match strategy',
          type: 'string',
          format: 'short',
          editDefault: false,
          mandatoryType: 'no',
        ...
        {
          name: 'multi_match_separator',
          label: 'Multi-match separator',
          type: 'string',
          format: 'short',
          editDefault: false,
          mandatoryType: 'no',
