...
export const PUBLIC_DASHBOARD_DEFINITION: ModuleDefinition<
  StoreEntityPublicDashboard,
  StixPublicDashboard
> = {
  type: {
    id: 'publicDashboards',
