...
import type { StixLocation } from '../../types/stix-2-1-sdo';
import type { ModuleDefinition } from '../../schema/module';
import { registerDefinition } from '../../schema/module';
import { entityLocationType } from '../../schema/attribute-definition';

const ADMINISTRATIVE_AREA_DEFINITION: ModuleDefinition<
  StoreEntityAdministrativeArea,
  StixLocation
> = {
  type: {
  ...
  relations: [
    ...
    },
    {
      ...
      targets: [{ name: ENTITY_TYPE_LOCATION_ADMINISTRATIVE_AREA, type: REL_BUILT_IN }],
    },
  ],
