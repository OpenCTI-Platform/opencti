...
import {
  ...
  playbookComponentDefinition,
  type StixPlaybook,
  type StoreEntityPlaybook,
} from './playbook-types';
...
const ENTITY_PLAYBOOK_DEFINITION: ModuleDefinition<StoreEntityPlaybook, StixPlaybook> = {
  ...
  attributes: [
    ...
    {
      name: 'playbook_definition',
      label: 'Playbook definition',
      type: 'string',
      format: 'json',
      mandatoryType: 'internal',
      editDefault: false,
      multiple: false,
      upsert: false,
      schemaDef: playbookComponentDefinition,
      isFilterable: false,
    },
