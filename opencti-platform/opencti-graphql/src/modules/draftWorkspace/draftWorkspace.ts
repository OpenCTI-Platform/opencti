...
import { authorizedMembers, authorizedMembersActivationDate, createdAt, creators, draftChange } from '../../schema/attribute-definition';
...
const DRAFT_WORKSPACE_DEFINITION: ModuleDefinition<StoreEntityDraftWorkspace, StixDraftWorkspace> = {
  ...
  attributes: [
    ...
    { ...creators, mandatoryType: 'customizable', editDefault: true },
