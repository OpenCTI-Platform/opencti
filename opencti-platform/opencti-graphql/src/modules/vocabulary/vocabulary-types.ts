...
export const vocabularyDefinitions: Record<VocabularyCategory, VocabularyDefinition> = {
  ...
  organization_type_ov: {
    description:
      'The various types of organizations playing a role in CTI, whether as a source of information or as a victim or source of attack, or even a way t segregate users in the platform.',
  ...
  reliability_ov: {
    description:
      'Reliability is an open vocabulary based on Admiralty code used to assess the reliability of a source.',
    entity_types: [
      ENTITY_TYPE_CONTAINER_REPORT,
  ...
  gender_ov: {
    description:
      'Gender describes the characteristics of men and women that are socially constructed. The definition of gender varies from society to society and can change over time.',
    entity_types: [ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL],
    fields: [
      {
        key: 'gender',
  ...
  marital_status_ov: {
    description:
      'Marital status describes the state of an intimate relationship a person has with one or more people, or none at all.',
    entity_types: [ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL],
    fields: [
      {
        key: 'marital_status',
