...
const VOCABULARY_DEFINITION: ModuleDefinition<StoreEntityVocabulary, StixVocabulary> = {
  ...
  attributes: [
    ...
    { name: 'order', type: 'numeric', precision: 'integer', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true },
    { name: 'builtIn', type: 'boolean', mandatoryType: 'no', editDefault: true, multiple: false, upsert: true },
  ],
  relations: [],
