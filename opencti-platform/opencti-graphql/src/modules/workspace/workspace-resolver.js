...
import { addWorkspace, editAuthorizedMembers, findAll, findById, getCurrentUserAccessRight, getOwnerId, duplicateWorkspace, objects, workspaceCleanContext, workspaceDelete, workspaceEditContext, workspaceEditField, workspaceImportConfiguration, workspaceImportWidgetConfiguration, generateWorkspaceExportConfiguration, generateWidgetExportConfiguration } from './workspace-domain';
