  ...
  try {
    ...
    switch (notifierConnectorId) {
      ...
      case NOTIFIER_CONNECTOR_EMAIL:
        await handleEmailNotification(storeSettings, notificationUser, notifierConfigurationString, assembledTemplateData);
        break;
      case NOTIFIER_CONNECTOR_SIMPLIFIED_EMAIL:
        await handleSimplifiedEmailNotification(storeSettings, notificationUser, notifierConfigurationString, assembledTemplateData);
        break;
