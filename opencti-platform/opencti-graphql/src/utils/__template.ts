// text //
import type { ResolvedWidgetAttribute, Template, TemplateWidget } from '../generated/graphql';
...
export const resolvedAttributesWidgets: ResolvedWidgetAttribute[] = [
...
export const usedTemplates: Template[] = [templateText, templateAttribute, templateList, templateGraph];
