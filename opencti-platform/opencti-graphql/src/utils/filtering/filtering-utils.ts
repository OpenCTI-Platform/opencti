...
const specialFilterKeysConvertor = new Map([
  ...
  [CONTEXT_SEARCH_TERM_FILTER, 'context_data.search'],
  [CONTEXT_RESULT_COUNT_FILTER, 'context_data.result_count'],
  [CONTEXT_ORGANIZATION_FILTER, 'context_data.organization'],
  [CONTEXT_SEARCH_LOCATION_FILTER, 'context_data.search_location'],
  [CONTEXT_GROUPS_FILTER, 'context_data.groups'],
]);
