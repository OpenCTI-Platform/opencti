...
export const hardcodedResolvedAttributesWidgets: ResolvedWidgetAttribute[] = [
  { template_widget_name: 'containerName', data: ['[Hardcoded report name]'] },
  { template_widget_name: 'reportPublicationDate', data: ['[Hardcoded publication date]'] },
  { template_widget_name: 'containerLabels', data: ['label1', 'label2', 'label3'] },
  ...
  { template_widget_name: 'container2Labels', data: ['sentinel, detection'] },
