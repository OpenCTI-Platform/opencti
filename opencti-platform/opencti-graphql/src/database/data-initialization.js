...
import { KNOWLEDGE_COLLABORATION, KNOWLEDGE_DELETE, KNOWLEDGE_MERGE, KNOWLEDGE_FRONTEND_EXPORT, KNOWLEDGE_MANAGE_AUTH_MEMBERS, KNOWLEDGE_UPDATE } from '../schema/general';
...
const createBasicRolesAndCapabilities = async (context) => {
  ...
  const connectorGroup = await addGroup(context, SYSTEM_USER, {
    ...
    auto_new_marking: true,
    ...(isFeatureEnabled('CSV_FEED') && { auto_integration_assignation: ['global'] })
  });
