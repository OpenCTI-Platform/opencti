...
export const convertStoreToStix = (
  instance: StoreCommon,
  version = Version.Stix_2_1,
): S.StixObject | S2.StixObject => {
  return version === Version.Stix_2_0
    ? convertStoreToStix_2_0(instance)
    : convertStoreToStix_2_1(instance);
};
