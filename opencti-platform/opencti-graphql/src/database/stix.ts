...
export const stixCoreRelationshipsMapping: RelationshipMappings = {
  ...
  [`${ENTITY_TYPE_INFRASTRUCTURE}_${ENTITY_SOFTWARE}`]: [RELATION_HOSTS, RELATION_CONSISTS_OF],
  [`${ENTITY_TYPE_INFRASTRUCTURE}_${ENTITY_TYPE_ATTACK_PATTERN}`]: [RELATION_DETECTS],
  // From INTRUSION_SET
