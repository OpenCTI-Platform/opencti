...
export const stixCoreRelationshipsMapping: RelationshipMappings = {
  ...
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_CHANNEL}`]: [
    { name: RELATION_USES, type: REL_BUILT_IN }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_NARRATIVE}`]: [
    { name: RELATION_USES, type: REL_BUILT_IN }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_CAMPAIGN}`]: [
    { name: RELATION_PARTICIPATES_IN, type: REL_NEW }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_GROUP}_${ENTITY_TYPE_IDENTITY_INDIVIDUAL}`]: [
    { name: RELATION_ATTRIBUTED_TO, type: REL_BUILT_IN },
  ...
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_IDENTITY_ORGANIZATION}`]: [
    { name: RELATION_ATTRIBUTED_TO, type: REL_BUILT_IN },
    { name: RELATION_IMPERSONATES, type: REL_BUILT_IN },
    { name: RELATION_TARGETS, type: REL_BUILT_IN },
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_IDENTITY_SECTOR}`]: [
    { name: RELATION_TARGETS, type: REL_BUILT_IN }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_IDENTITY_SYSTEM}`]: [
    { name: RELATION_TARGETS, type: REL_BUILT_IN }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_GROUP}_${ENTITY_TYPE_EVENT}`]: [
    { name: RELATION_TARGETS, type: REL_EXTENDED }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_INFRASTRUCTURE}`]: [
    { name: RELATION_COMPROMISES, type: REL_BUILT_IN },
    { name: RELATION_HOSTS, type: REL_BUILT_IN },
    { name: RELATION_OWNS, type: REL_BUILT_IN },
    { name: RELATION_USES, type: REL_BUILT_IN },
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_LOCATION_POSITION}`]: [
    { name: RELATION_LOCATED_AT, type: REL_BUILT_IN },
    { name: RELATION_TARGETS, type: REL_BUILT_IN },
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_LOCATION_CITY}`]: [
    { name: RELATION_LOCATED_AT, type: REL_BUILT_IN },
    { name: RELATION_TARGETS, type: REL_BUILT_IN },
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_LOCATION_ADMINISTRATIVE_AREA}`]: [
    { name: RELATION_LOCATED_AT, type: REL_BUILT_IN },
    { name: RELATION_TARGETS, type: REL_BUILT_IN },
  ],
  ...
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_LOCATION_REGION}`]: [
    { name: RELATION_LOCATED_AT, type: REL_BUILT_IN },
    { name: RELATION_TARGETS, type: REL_BUILT_IN },
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_MALWARE}`]: [
    { name: RELATION_USES, type: REL_BUILT_IN }
  ],
  ...
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_TOOL}`]: [
    { name: RELATION_USES, type: REL_BUILT_IN }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_VULNERABILITY}`]: [
    { name: RELATION_TARGETS, type: REL_BUILT_IN }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_HASHED_OBSERVABLE_STIX_FILE}`]: [
    { name: RELATION_USES, type: REL_EXTENDED }
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_THREAT_ACTOR_GROUP}`]: [
    { name: RELATION_EMPLOYED_BY, type: REL_NEW },
  ],
  [`${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}_${ENTITY_TYPE_IDENTITY_ORGANIZATION}`]: [
    { name: RELATION_EMPLOYED_BY, type: REL_NEW },
  ],
  ...
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_LOCATION_POSITION}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED }
  ],
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_LOCATION_CITY}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED }
  ],
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_LOCATION_ADMINISTRATIVE_AREA}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED }
  ],
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_LOCATION_COUNTRY}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED }
  ],
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_LOCATION_REGION}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED }
  ],
  // endregion
  // From USER_ACCOUNT
