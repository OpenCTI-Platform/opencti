...
export const stixCoreRelationshipsMapping: RelationshipMappings = {
  ...
  [`${ENTITY_FINANCIAL_ACCOUNT}_${ENTITY_TYPE_IDENTITY_INDIVIDUAL}`]: [
    { name: RELATION_BELONGS_TO, type: REL_EXTENDED }
  ],
  ...
  [`${ENTITY_FINANCIAL_ACCOUNT}_${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}`]: [
    { name: RELATION_BELONGS_TO, type: REL_EXTENDED }
  ],
  // endregion
  // region FINANCIAL_ASSET
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_IDENTITY_INDIVIDUAL}`]: [
    { name: RELATION_BELONGS_TO, type: REL_EXTENDED }
  ],
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_IDENTITY_ORGANIZATION}`]: [
    { name: RELATION_BELONGS_TO, type: REL_EXTENDED }
  ],
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_THREAT_ACTOR_GROUP}`]: [
    { name: RELATION_BELONGS_TO, type: REL_EXTENDED }
  ],
  [`${ENTITY_FINANCIAL_ASSET}_${ENTITY_TYPE_THREAT_ACTOR_INDIVIDUAL}`]: [
    { name: RELATION_BELONGS_TO, type: REL_EXTENDED }
  ],
