...
export const READ_INFERRED_INDICES = [READ_INDEX_INFERRED_ENTITIES, READ_INDEX_INFERRED_RELATIONSHIPS];
...
export const READ_RELATIONSHIPS_WITH_INFERENCES_INDICES = [
