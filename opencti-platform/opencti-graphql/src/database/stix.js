...
import {
  ...
  RELATION_RAW_EMAIL, RELATION_RESOLVES_TO,
  RELATION_SAMPLE,
  RELATION_SENDER,
  RELATION_SRC,
...
export const stixCoreRelationshipsMapping = {
  ...
  [`${ENTITY_TYPE_TOOL}_${ENTITY_TYPE_ATTACK_PATTERN}`]: [RELATION_USES, RELATION_DROPS, RELATION_DELIVERS],
  ...
  // targets_${ENTITY_TYPE_LOCATION_REGION}`]: [RELATION_LOCATED_AT],
  // targets_${ENTITY_TYPE_LOCATION_COUNTRY}`]: [RELATION_LOCATED_AT],
  // targets_${ENTITY_TYPE_LOCATION_CITY}`]: [RELATION_LOCATED_AT],
  // targets_${ENTITY_TYPE_LOCATION_POSITION}`]: [RELATION_LOCATED_AT],
};
...
export const stixCyberObservableRelationshipsMapping = {
  ...
  [`${ENTITY_DIRECTORY}_${ENTITY_HASHED_OBSERVABLE_ARTIFACT}`]: [RELATION_CONTAINS],
  [`${ENTITY_EMAIL_ADDR}_${ENTITY_USER_ACCOUNT}`]: ['belongs-to'],
  ...
  [`${ENTITY_EMAIL_MESSAGE}_${ENTITY_EMAIL_MIME_PART_TYPE}`]: [RELATION_BODY_MULTIPART],
  [`${ENTITY_EMAIL_MESSAGE}_${ENTITY_HASHED_OBSERVABLE_ARTIFACT}`]: [RELATION_RAW_EMAIL],
  [`${ENTITY_EMAIL_MIME_PART_TYPE}_${ENTITY_HASHED_OBSERVABLE_ARTIFACT}`]: [RELATION_BODY_RAW],
  [`${ENTITY_HASHED_OBSERVABLE_STIX_FILE}_${ENTITY_DIRECTORY}`]: [RELATION_PARENT_DIRECTORY],
  [`${ENTITY_HASHED_OBSERVABLE_STIX_FILE}_${ABSTRACT_STIX_CYBER_OBSERVABLE}`]: [RELATION_CONTENT],
  // [`${ENTITY_HASHED_OBSERVABLE_STIX_FILE}_${ENTITY_TYPE_CONTAINER_OBSERVED_DATA}`]: [RELATION_CONTENT],
  [`${ENTITY_HASHED_OBSERVABLE_STIX_FILE}_${ENTITY_HASHED_OBSERVABLE_ARTIFACT}`]: [RELATION_CONTENT],
  ...
  [`${ENTITY_PROCESS}_${ENTITY_USER_ACCOUNT}`]: [RELATION_CREATOR_USER],
  [`${ENTITY_PROCESS}_${ENTITY_HASHED_OBSERVABLE_STIX_FILE}`]: [RELATION_IMAGE],
  [`${ENTITY_PROCESS}_${ENTITY_PROCESS}`]: [RELATION_PARENT, RELATION_CHILD],
  [`${ENTITY_WINDOWS_REGISTRY_KEY}_${ENTITY_USER_ACCOUNT}`]: [RELATION_CREATOR_USER],
};
