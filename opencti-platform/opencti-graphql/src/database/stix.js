...
export const stixCoreRelationshipsMapping = {
  ...
  'IPv4-Addr_Autonomous-System': [RELATION_BELONGS_TO],
  'IPv6-Addr_Autonomous-System': [RELATION_BELONGS_TO],
  'IPv4-Addr_IPv4-Addr': ['communicates-with', 'beacons-to'],
  'Domain-Name_Domain-Name': [RELATION_RESOLVES_TO],
  'Domain-Name_IPv4-Addr': [RELATION_RESOLVES_TO],
  'Domain-Name_IPv6-Addr': [RELATION_RESOLVES_TO],
  'IPv4-Addr_Mac-Addr': [RELATION_RESOLVES_TO],
  'IPv6-Addr_Mac-Addr': [RELATION_RESOLVES_TO],
...
export const stixCyberObservableRelationshipsMapping = {
  ...
  'Email-Addr_User-Account': [OBS_RELATION_BELONGS_TO],
  'Email-Message_Email-Addr': ['from', 'sender', 'to', RELATION_BCC],
  ...
  'Domain-Name_Domain-Name': [OBS_RELATION_RESOLVES_TO],
  'Domain-Name_IPv4-Addr': [OBS_RELATION_RESOLVES_TO],
  'Domain-Name_IPv6-Addr': [OBS_RELATION_RESOLVES_TO],
  'IPv4-Addr_Mac-Addr': [OBS_RELATION_RESOLVES_TO],
  'IPv4-Addr_Autonomous-System': [OBS_RELATION_BELONGS_TO],
  'IPv6-Addr_Mac-Addr': [OBS_RELATION_RESOLVES_TO],
  'IPv6-Addr_Autonomous-System': [OBS_RELATION_BELONGS_TO],
