...
import {
  ...
  ENTITY_WINDOWS_REGISTRY_VALUE_TYPE, ENTITY_HASHED_OBSERVABLE_X509_CERTIFICATE, ENTITY_X509_V3_EXTENSIONS_TYPE,
...
import {
  ...
  RELATION_TO,
  RELATION_VALUES, RELATION_X509_V3_EXTENSIONS,
...
export const stixCyberObservableRelationshipsMapping = {
  ...
  [`${ENTITY_HASHED_OBSERVABLE_X509_CERTIFICATE}_${ENTITY_X509_V3_EXTENSIONS_TYPE}`]: [RELATION_X509_V3_EXTENSIONS],
};
