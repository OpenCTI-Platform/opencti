...
export const stixCyberObservableRelationshipsMapping = {
  ...
  [`${ENTITY_HASHED_OBSERVABLE_STIX_FILE}_${ENTITY_TYPE_CONTAINER_OBSERVED_DATA}`]: [OBS_RELATION_CONTENT],
  [`${ENTITY_HASHED_OBSERVABLE_STIX_FILE}_${ENTITY_HASHED_OBSERVABLE_ARTIFACT}`]: [RELATION_CONTAINS, OBS_RELATION_CONTENT],
