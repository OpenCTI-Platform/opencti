...
export default class NoteFormPage {
  ...
  abstractField = new TextFieldPageModel(this.page, 'Abstract', 'text', this.formLocator);
  contentField = new TextFieldPageModel(this.page, 'Content', 'text', this.formLocator);
