...
const AssetPopoverDeletionMutation = graphql`
  mutation AssetPopoverDeletionMutation($id: ID!) {
    financialAssetDelete(id: $id)
  }
`;

const AssetPopover = ({ id }: { id: string }) => {
  ...
  const [commit] = useMutation(AssetPopoverDeletionMutation);
  const queryRef = useQueryLoading<AssetEditionContainerQuery>(assetEditionQuery, { id });
  ...
  return (
    <div className={classes.container}>
      ...
      >
        <DialogContent>
          <DialogContentText>
            {t('Do you want to delete this asset?')}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
