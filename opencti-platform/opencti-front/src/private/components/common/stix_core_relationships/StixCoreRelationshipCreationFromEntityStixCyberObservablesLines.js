...
class StixCoreRelationshipCreationFromEntityStixCyberObservablesLinesContainer extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { t, classes, data, handleSelect, noPadding, targetEntities } = this.props;
...
export const stixCoreRelationshipCreationFromEntityStixCyberObservablesLinesQuery = graphql`
...
const StixCoreRelationshipCreationFromEntityStixCyberObservablesLines = createPaginationContainer(
