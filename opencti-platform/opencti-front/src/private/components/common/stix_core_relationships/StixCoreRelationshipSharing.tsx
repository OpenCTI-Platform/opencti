...
import { StixCoreRelationshipSharingQuery } from './__generated__/StixCoreRelationshipSharingQuery.graphql';
...
> = ({ elementId, variant }) => {
  ...
  const { stixCoreRelationship } = useLazyLoadQuery<StixCoreRelationshipSharingQuery>(
