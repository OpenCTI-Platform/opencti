...
const entityStixCoreRelationshipsTableStixCoreRelationshipDistributionQuery = graphql`
...
class EntityStixCoreRelationshipsTable extends Component {
  renderContent() {
    const {
      t,
      classes,
          ...
          if (
            ...
            return (
              <Table className={classes.table}>
                ...
                <TableBody>
                  {props.stixCoreRelationshipsDistribution.map((row) => (
...
EntityStixCoreRelationshipsTable.propTypes = {
