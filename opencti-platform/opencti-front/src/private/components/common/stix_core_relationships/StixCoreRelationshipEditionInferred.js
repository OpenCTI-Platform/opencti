...
class StixCoreRelationshipEditionInferred extends Component {
  render() {
    const {
      classes,
      t,
          ...
          <div className={classes.container}>
            ...
            {stixDomainObject ? (
              <Button
                ...
                color="primary"
                component={Link}
                to={`${link}/${stixDomainObject.id}/knowledge/relations/${stixCoreRelationshipId}`}
...
StixCoreRelationshipEditionInferred.propTypes = {
...
export default compose(
  inject18n,
  withStyles(styles),
)(StixCoreRelationshipEditionInferred);
