...
export const stixRelationCreationFromEntityStixDomainObjectsLinesQuery = graphql`
  query StixRelationCreationFromEntityStixDomainObjectsLinesQuery(
    $search: String
    $types: [String]
    $count: Int!
    $cursor: ID
    ...
    ...StixRelationCreationFromEntityStixDomainObjectsLines_data
      @arguments(
        search: $search
        types: $types
        count: $count
...
const StixRelationCreationFromEntityStixDomainObjectsLines = createPaginationContainer(
  StixRelationCreationFromEntityLinesContainer,
  {
    data: graphql`
      fragment StixRelationCreationFromEntityStixDomainObjectsLines_data on Query
        @argumentDefinitions(
          search: { type: "String" }
          types: { type: "[String]" }
...
export default compose(
  inject18n,
  withStyles(styles),
)(StixRelationCreationFromEntityStixDomainObjectsLines);
