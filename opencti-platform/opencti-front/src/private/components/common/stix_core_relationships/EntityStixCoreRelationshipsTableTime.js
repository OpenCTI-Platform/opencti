...
class EntityStixCoreRelationshipsTableTime extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <QueryRenderer
        ...
        render={({ props }) => {
          if (
            props
            && props.stixCoreRelationshipsTimeSeries
            && props.stixCoreRelationshipsTimeSeries.length > 0
          ) {
            const stixCoreRelationshipsTimeSeries = reverse(
              props.stixCoreRelationshipsTimeSeries,
            );
            return (
              <Table className={classes.table}>
                ...
                <TableBody>
                  {stixCoreRelationshipsTimeSeries.map((row) => {
                    let date;
...
EntityStixCoreRelationshipsTableTime.propTypes = {
