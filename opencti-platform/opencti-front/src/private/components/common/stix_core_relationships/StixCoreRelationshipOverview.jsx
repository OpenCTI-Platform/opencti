  ...
  submitDelete() {
    ...
    commitMutation({
      ...
      onCompleted: () => {
        ...
        this.props.navigate(location.pathname.replace(`/relations/${stixCoreRelationship.id}`, ''));
      },
    });
  }
    ...
    return (
      <div className={classes.container}>
          ...
          <Grid item xs={6}>
            <Card
              title={
                <>
                  {t('Relationship')}
                  {stixCoreRelationship.draftVersion && <DraftChip />}
                </>
              }
              action={
            ...
            >
              <Link to={!fromRestricted ? `${linkFrom}/${from.id}` : '#'}>
                <div
                  ...
                  style={{
                    border: `1px solid ${itemColor(!fromRestricted ? from.entity_type : 'Restricted')}`,
                    top: 20,
                    left: 20,
                  }}
                >
              ...
              <Link to={!toRestricted ? `${linkTo}/${to.id}` : '#'}>
                <div
                  className={classes.item}
                  style={{
                    border: `1px solid ${itemColor(!toRestricted ? to.entity_type : 'Restricted')}`,
                    top: 20,
                    right: 20,
                  }}
                >
                  ...
                  <div className={classes.content}>
                    <span className={classes.name}>
                      <Tooltip title={toText}>
                        {!toRestricted ? truncate(toText, TRUNCATE_CHARS_COUNT) : t('Restricted')}
                      </Tooltip>
              ...
              <Stack gap={2}>
                ...
                <Grid container={true} spacing={2}>
                  <Grid item xs={6}>
                    ...
                    <Label sx={{ marginTop: 2 }}>{t('Start time')}</Label>
                    {nsdt(stixCoreRelationship.start_time)}
                    <Label sx={{ marginTop: 2 }}>{t('Stop time')}</Label>
                  ...
                  <Grid item xs={6}>
                    ...
                    <StixCoreRelationshipSharing elementId={stixCoreRelationship.id} />
            ...
            <Card title={t('Details')}>
              <Grid container={true} spacing={2}>
                <Grid item xs={6}>
                  ...
                  {stixCoreRelationship.x_opencti_inferences === null && (
                    <div>
                      ...
                      <ItemAuthor createdBy={R.propOr(null, 'createdBy', stixCoreRelationship)} />
                    </div>
                  )}
                ...
                <Grid item xs={6}>
                  ...
                  <ItemCreators creators={stixCoreRelationship.creators ?? []} />
                </Grid>
              </Grid>
            </Card>
          </Grid>
        ...
        <div>
          {stixCoreRelationship.x_opencti_inferences !== null && (
            <div style={{ margin: '50px 0 0 0' }}>
              <CardTitle>
                {t('Inference explanation')} ({stixCoreRelationship.x_opencti_inferences.length})
              </CardTitle>
              {R.take(expanded ? 200 : 1, stixCoreRelationship.x_opencti_inferences).map(
                (inference) => (
        ...
        <Dialog
          ...
          size="small"
        >
          <DialogContentText>{t('Do you want to delete this relationship?')}</DialogContentText>
          <DialogActions>
            <Button onClick={this.handleCloseDelete.bind(this)} disabled={this.state.deleting}>
              {t('Cancel')}
            </Button>
            <Button
              color="secondary"
