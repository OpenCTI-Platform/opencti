...
const StixRelationEditionContainer = ({
  ...
  const handleChangeCreatedBy = (name, value) => {
    const currentCreatedBy = {
      label: pathOr(null, ['createdBy', 'node', 'name'], stixRelation),
      value: pathOr(null, ['createdBy', 'node', 'id'], stixRelation),
      relation: pathOr(null, ['createdBy', 'relation', 'id'], stixRelation),
    };
  ...
  const createdBy = pathOr(null, ['createdBy', 'node', 'name'], stixRelation) === null
    ? ''
    : {
      label: pathOr(null, ['createdBy', 'node', 'name'], stixRelation),
      value: pathOr(null, ['createdBy', 'node', 'id'], stixRelation),
      ...
      <div className={classes.container}>
        ...
        {stixDomainObject ? (
          <Button
            ...
            color="primary"
            component={Link}
            to={`${link}/${stixDomainObject.id}/knowledge/relations/${stixRelation.id}`}
