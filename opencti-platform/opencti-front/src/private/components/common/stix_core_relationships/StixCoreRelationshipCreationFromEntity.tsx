              ...
              <>
                <ListLines
                  ...
                  additionalFilterKeys={{
                    ...
                    filtersRestrictions: { preventRemoveFor: ['entity_type'], preventLocalModeSwitchingFor: ['entity_type'], preventFilterValuesRemoveFor: new Map([['entity_type', actualTypeFilterValues]]) } }
                  }
                >
                  <QueryRenderer
