...
import SimpleEntityStixCoreRelationshipsLines, {
  simpleEntityStixCoreRelationshipsLinesQuery,
} from './SimpleEntityStixCoreRelationshipsLines';
...
class SimpleEntityStixCoreRelationships extends Component {
  render() {
    const {
      t,
      classes,
