...
const ImportFilesStepper = () => {
  ...
  const { canSelectImportMode, activeStep, setActiveStep, files, importMode, selectedFormId } =
  ...
  return (
    ...
    >
      ...
      <Step
        key="import_options_or_fill_form"
        disabled={importMode === 'form' ? !hasSelectedForm : !hasSelectedFiles}
      >
