...
export const StixObservablesExportCreationMutation = graphql`
  mutation StixObservablesExportCreationMutation(
    $format: String!
    $exportType: String!
...
class StixObservablesExportCreationComponent extends Component {
  constructor(props) {
    super(props);
...
const StixObservablesExportCreations = createFragmentContainer(
  StixObservablesExportCreationComponent,
  {
    data: graphql`
      fragment StixObservablesExportCreation_data on Query {
        connectorsForExport {
          id
          name
          active
...
StixObservablesExportCreations.propTypes = {
...
export default compose(
  inject18n,
  withStyles(styles),
)(StixObservablesExportCreations);
