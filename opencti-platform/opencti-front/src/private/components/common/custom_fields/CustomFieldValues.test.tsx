...
describe.each(['Report', 'stix-core-relationship', 'stix-sighting-relationship'])('%s custom-field creation', (entityType) => {
  beforeEach(() => {
...
describe.each(['Report', 'stix-core-relationship', 'stix-sighting-relationship'])('%s custom-field edition and display', (entityType) => {
