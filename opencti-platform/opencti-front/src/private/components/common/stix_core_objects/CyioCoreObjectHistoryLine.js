...
class CyioCoreObjectHistoryLineComponent extends Component {
  constructor(props) {
    super(props);
...
CyioCoreObjectHistoryLineComponent.propTypes = {
...
const CyioCoreObjectHistoryLine = createFragmentContainer(
  CyioCoreObjectHistoryLineComponent,
  {
    node: graphql`
      fragment CyioCoreObjectHistoryLine_node on Log {
        id
        event_type
        timestamp
        user {
