...
import CyioCoreObjectHistoryLine from './CyioCoreObjectHistoryLine';
...
CyioCoreObjectHistoryLinesComponent.propTypes = {
...
export const cyioCoreObjectHistoryLinesQuery = graphql`
  query CyioCoreObjectHistoryLinesQuery(
    ...
    ...CyioCoreObjectHistoryLines_data
  }
`;

const CyioCoreObjectHistoryLines = createRefetchContainer(
  CyioCoreObjectHistoryLinesComponent,
  {
    data: graphql`
      fragment CyioCoreObjectHistoryLines_data on Query {
        logs(
          first: $first
          orderBy: $orderBy
          orderMode: $orderMode
          ...
          edges {
            node {
              id
              ...CyioCoreObjectHistoryLine_node
            }
          }
        }
      }
