  ...
  const renderForm = () => {
    return (
      <>
        ...
        >
          {t_i18n('This feature will be enhanced in the future to cover more types of entities.')}
        </Alert>
        {!hasAttackPatterns && (
          <Alert
            severity="warning"
        ...
        {(!enabled || !configured || !isEnterpriseEdition) && (
          <Alert
            severity="warning"
            variant="outlined"
            style={{ position: 'relative' }}
          >
            {t_i18n('Simulated emails are only available with an EE license and AI activated.')}
          </Alert>
        )}
        <FormControl style={fieldSpacingContainerStyle}>
          ...
          >
            ...
            <MenuItem value="simulated" disabled={ !enabled || !configured || !isEnterpriseEdition}>{t_i18n('Simulated emails (generated by AI)')}{!isEnterpriseEdition && <EEChip />}</MenuItem>
