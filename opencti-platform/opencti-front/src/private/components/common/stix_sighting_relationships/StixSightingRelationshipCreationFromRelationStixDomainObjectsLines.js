...
class StixSightingRelationshipCreationFromRelationLinesContainer extends Component {
  constructor(props) {
    super(props);
...
StixSightingRelationshipCreationFromRelationLinesContainer.propTypes = {
...
export const stixSightingRelationshipCreationFromRelationStixDomainObjectsLinesQuery = graphql`
  query StixSightingRelationshipCreationFromRelationStixDomainObjectsLinesQuery(
    $search: String
    $types: [String]
    $count: Int!
    $cursor: ID
    ...
    ...StixSightingRelationshipCreationFromRelationStixDomainObjectsLines_data
      @arguments(
        search: $search
        types: $types
        count: $count
...
const StixSightingRelationshipCreationFromRelationStixDomainObjectsLines = createPaginationContainer(
  ...
  {
    data: graphql`
      fragment StixSightingRelationshipCreationFromRelationStixDomainObjectsLines_data on Query
        @argumentDefinitions(
          search: { type: "String" }
          types: { type: "[String]" }
