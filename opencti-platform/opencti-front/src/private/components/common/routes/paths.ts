...
export const PATH_ATTACK_PATTERN = (attackPatternId: string) =>
  `${PATH_ATTACK_PATTERNS}/${attackPatternId}`;
...
export const PATH_DATA_COMPONENT = (dataComponentId: string) =>
  `${PATH_DATA_COMPONENTS}/${dataComponentId}`;
...
export const PATH_COURSE_OF_ACTION = (courseOfActionId: string) =>
  `${PATH_COURSES_OF_ACTION}/${courseOfActionId}`;
...
export const PATH_MALWARE_ANALYSE = (malwareAnalysisId: string) =>
  `${PATH_MALWARE_ANALYSES}/${malwareAnalysisId}`;
...
export const PATH_SECURITY_COVERAGE = (securityCoverageId: string) =>
  `${PATH_SECURITY_COVERAGES}/${securityCoverageId}`;
...
export const PATH_VULNERABILITY = (vulnerabilityId: string) =>
  `${PATH_VULNERABILITIES}/${vulnerabilityId}`;
...
export const PATH_ADMINISTRATIVE_AREA = (administrativeAreaId: string) =>
  `${PATH_ADMINISTRATIVE_AREAS}/${administrativeAreaId}`;
...
export const PATH_INFRASTRUCTURE = (infrastructureId: string) =>
  `${PATH_INFRASTRUCTURES}/${infrastructureId}`;
...
export const PATH_OBSERVED_DATA = (observedDataId: string) =>
  `${PATH_OBSERVED_DATAS}/${observedDataId}`;
...
export const PATH_THREAT_ACTORS_GROUP = (threatActorGroupId: string) =>
  `${PATH_THREAT_ACTORS_GROUPS}/${threatActorGroupId}`;
export const PATH_THREAT_ACTORS_INDIVIDUALS = `${PATH_DASHBOARD}/threats/threat_actors_individual`;
export const PATH_THREAT_ACTORS_INDIVIDUAL = (threatActorIndividualId: string) =>
  `${PATH_THREAT_ACTORS_INDIVIDUALS}/${threatActorIndividualId}`;
export const PATH_INTRUSION_SETS = `${PATH_DASHBOARD}/threats/intrusion_sets`;
export const PATH_INTRUSION_SET = (intrusionSetId: string) =>
  `${PATH_INTRUSION_SETS}/${intrusionSetId}`;
...
export const PATH_ORGANIZATION = (organizationId: string) =>
  `${PATH_ORGANIZATIONS}/${organizationId}`;
export const PATH_SECURITY_PLATFORMS = `${PATH_DASHBOARD}/entities/security_platforms`;
export const PATH_SECURITY_PLATFORM = (securityPlatformId: string) =>
  `${PATH_SECURITY_PLATFORMS}/${securityPlatformId}`;
...
export const PATH_CASE_INCIDENT = (caseIncidentId: string) =>
  `${PATH_CASE_INCIDENTS}/${caseIncidentId}`;
