...
import { stixDomainEntitiesLinesSearchQuery } from './StixDomainEntitiesLines';
...
class StixDomainEntityDetectDuplicate extends Component {
  constructor(props) {
    super(props);
    this.state = {
      potentialDuplicates: [],
...
StixDomainEntityDetectDuplicate.propTypes = {
