...
import {
  StixDomainObjectBookmarksListQuery,
  StixDomainObjectsOrdering,
} from '@components/common/stix_domain_objects/__generated__/StixDomainObjectBookmarksListQuery.graphql';
...
const StixDomainObjectBookmarksListComponent = ({
  ...
  return edges.length === 0 ? <WidgetNoData /> : <WidgetBookmarks bookmarks={edges} />;
};
...
const buildQueryVariables = (resolvedDataSelection: WidgetDataSelection[]) => {
  ...
  ) as StixDomainObjectsOrdering | null | undefined;
  ...
  const renderContent = () => {
    ...
    return (
      <Suspense fallback={<Loader variant={LoaderVariant.inElement} />}>
        <StixDomainObjectBookmarksListComponent queryRef={queryRef} />
      </Suspense>
    );
  };
