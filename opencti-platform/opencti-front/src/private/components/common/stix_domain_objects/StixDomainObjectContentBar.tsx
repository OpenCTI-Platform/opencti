...
import { CloudDownloadOutlined, EditOutlined, ZoomInOutlined, ZoomOutOutlined } from '@mui/icons-material';
...
const StixDomainObjectContentBar: FunctionComponent<StixDomainObjectContentBarProps> = ({
  handleZoomIn,
  handleZoomOut,
  currentZoom,
  handleDownload,
