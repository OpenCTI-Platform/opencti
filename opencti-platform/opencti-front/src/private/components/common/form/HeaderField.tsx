...
export const individualHeaderMutation = graphql`
  mutation HeaderFieldIndividualMutation($id: ID!, $input: [EditInput]!) {
...
interface HeaderFieldEditProps {
  id: string;
  name: string;
...
export const HeaderFieldEdit: FunctionComponent<HeaderFieldEditProps> = ({
  name,
  id,
  values,
  containerStyle,
