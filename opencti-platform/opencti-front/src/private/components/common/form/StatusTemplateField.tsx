...
const StatusTemplateField: FunctionComponent<StatusTemplateFieldProps> = ({
  ...
  const [statusTemplateCreation, setStatusTemplateCreation] =
  ...
  const handleOpenStatusTemplateCreation = () =>
    setStatusTemplateCreation(true);

  const handleCloseStatusTemplateCreation = () =>
    setStatusTemplateCreation(false);
