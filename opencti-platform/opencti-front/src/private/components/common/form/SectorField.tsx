...
const SectorField = ({
  ...
  return (
    <Field
      ...
      options={options}
      // The query leaves on the keystroke and on nothing else: `select`, `clear` and `reset` all reach this
      // callback too, and firing on them is what the pre-library sites guarded against by testing for a DOM event.
