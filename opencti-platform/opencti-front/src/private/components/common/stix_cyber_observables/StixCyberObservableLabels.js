...
const StixCyberObservableMutationRelationsAdd = graphql`
  mutation StixCyberObservableLabelsRelationsAddMutation(
    $id: ID!
...
class StixCyberObservableLabels extends Component {
  constructor(props) {
    super(props);
    this.state = {
      openAdd: false,
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    ...
    commitMutation({
      mutation: StixCyberObservableMutationRelationsAdd,
      variables: {
        id: this.props.id,
        input: {
          toIds: labelsIds,
...
StixCyberObservableLabels.propTypes = {
