...
const EnterpriseEditionAgreement: FunctionComponent<EnterpriseEditionAgreementProps> = ({
  open,
  onClose,
  settingsId,
}) => {
  ...
  const [commitMutation] = useApiMutation(EnterpriseEditionAgreementMutationFieldPatch);
  ...
  return (
    ...
    >
      <Alert severity="info" style={{ marginTop: 15 }}>
        {t_i18n(
          'OpenCTI Enterprise Edition requires a license key to be enabled. Filigran provides a free-to-use license for development and research purposes as well as for charity organizations.',
        )}
        <br />
        <br />
        ...
        .
        <br />
        {t_i18n('You just need to try?')} Get right now{' '}
        <a href="https://filigran.io/enterprise-editions-trial/" target="_blank" rel="noreferrer">
          {t_i18n('your trial license online')}
        </a>
        .
      </Alert>
      ...
      <div style={{ marginTop: 15 }}>
        {t_i18n(
          'By enabling the OpenCTI Enterprise Edition, you (and your organization) agrees to the OpenCTI Enterprise Edition (EE) ',
        )}
        <a
      ...
      <DialogActions>
        ...
        <Button onClick={enableEnterpriseEdition} disabled={isEmptyField(enterpriseLicense)}>
          {t_i18n('Enable')}
        </Button>
      </DialogActions>
    </Dialog>
