...
const ExternalReferenceCreation: FunctionComponent<ExternalReferenceCreationProps> = ({
  ...
  const [commit] = useApiMutation<ExternalReferenceCreationMutation>(
    ...
    undefined,
    { successMessage: `${translateEntityType('External-Reference')} ${t_i18n('successfully created')}` },
  );
  ...
  const renderClassic = () => {
    return (
      <Drawer
        title={t_i18n('', { id: 'Create ...', values: { entity_type: translateEntityType('External-Reference') } })}
