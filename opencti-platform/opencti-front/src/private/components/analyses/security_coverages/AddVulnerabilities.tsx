...
import { SecurityCoverageVulnerabilities_securityCoverage$data } from '@components/analyses/security_coverages/__generated__/SecurityCoverageVulnerabilities_securityCoverage.graphql';
