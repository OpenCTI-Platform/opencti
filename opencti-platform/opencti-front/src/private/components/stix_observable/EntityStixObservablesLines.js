...
class EntityStixObservablesLines extends Component {
  ...
  _rowRenderer({ index, key, style }) {
    ...
    const stixDomainEntity = stixRelationNode.node.from;
    const stixObservable = stixRelationNode.node.to;
    return (
      <div key={key} style={style}>
        <EntityStixObservableLine
          key={stixRelation.id}
      ...
      data: graphql`
        fragment EntityStixObservablesLines_data on Query
          ...
          stixRelations(
            ...
            edges {
              node {
                ...EntityStixObservableLine_stixRelation
                from {
                  ...EntityStixObservableLine_stixDomainEntity
                }
                to {
                  ...EntityStixObservableLine_stixObservable
                }
              }
            }
          }
