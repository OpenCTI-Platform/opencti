...
export const dashboardCustomDashboardQuery = graphql`
...
class Dashboard extends Component {
  constructor(props) {
    ...
    this.state = {
      dashboard: R.propOr('default', 'dashboard', params),
  ...
  render() {
    ...
    const { timeField, dashboard } = this.state;
    return (
      <div className={classes.root}>
        ...
        {dashboard === 'default' ? (
          ...
          <Security
            needs={[EXPLORE]}
            placeholder={t(
              'You do not have any access to the expore part of this OpenCTI instance.',
            )}
          >
            <QueryRenderer
