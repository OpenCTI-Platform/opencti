...
const DecayExclusionDialogContent: FunctionComponent<DecayExclusionDialogContentProps> = ({
  open = false,
  indicator,
  onClose,
}) => {
  ...
  return (
    ...
    >
      <Typography>
        {t_i18n('This indicator is currently impacted by a Decay Exclusion Rule.')}
      </Typography>
      <Typography>
        {t_i18n('This mean that the indicator is not managed by the platform.')}
      </Typography>
      <Typography style={{ marginTop: 20 }}>
        {t_i18n(
          'Please contact your administrator to have more details about this rule & why this indicator is impacted.',
        )}
      </Typography>
      <Alert
        content={t_i18n(
          'This IOC might be impacted by an Exclusion Rule with criteria not matching anymore this IOC: once a rule is applied to an IOC, the rule does not change.',
        )}
        severity="warning"
        style={{
          marginTop: 40,
