      ...
      >
        ...
        <MenuList component="nav">
          <MenuItem
            ...
            selected={
              location.pathname
              === `/dashboard/locations/positions/${positionId}/knowledge/overview`
            }
            dense={false}
          ...
          <MenuItem
            component={Link}
            to={`/dashboard/locations/positions/${positionId}/knowledge/threats`}
            selected={
              location.pathname
              === `/dashboard/locations/positions/${positionId}/knowledge/threats`
            }
            dense={false}
            classes={{ root: classes.item }}
          >
