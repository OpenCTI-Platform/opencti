...
export const CountryCreationForm: FunctionComponent<CountryFormProps> = ({
  ...
  const [commit] = useApiMutation<CountryCreationMutation>(countryMutation, undefined, {
      ...
      {({ submitForm, handleReset, isSubmitting, setFieldValue, values, resetForm }) => (
        <>
          ...
          <Form>
            ...
            />
            <ConfidenceField entityType="Country" containerStyle={fieldSpacingContainerStyle} />
            <CreatedByField
              name="createdBy"
