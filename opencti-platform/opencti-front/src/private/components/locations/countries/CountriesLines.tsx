...
const CountriesLines: FunctionComponent<CountriesLinesProps> = ({ setNumberOfElements, queryRef, dataColumns, paginationOptions }) => {
  const {
    data,
    hasMore,
    loadMore,
    isLoadingMore,
  } = usePreloadedPaginationFragment<CountriesLinesPaginationQuery, CountriesLines_data$key>({
