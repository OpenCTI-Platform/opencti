...
export const AdministrativeAreaCreationForm: FunctionComponent<AdministrativeAreaFormProps> = ({
  ...
  const [commit] = useApiMutation<AdministrativeAreaCreationMutation>(
    ...
    undefined,
    { successMessage: `${translateEntityType('Administrative-Area')} ${t_i18n('successfully created')}` },
  );
  const {
    bulkCommit,
    bulkCount,
...
const AdministrativeAreaCreation = ({
  ...
  return (
    <Drawer
      title={t_i18n('', { id: 'Create ...', values: { entity_type: translateEntityType('Administrative-Area') } })}
