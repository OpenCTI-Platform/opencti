...
const AdministrativeAreasLines: FunctionComponent<AdministrativeAreasLinesProps> = ({ setNumberOfElements, dataColumns, queryRef, paginationOptions }) => {
  const {
    data,
    hasMore,
    loadMore,
    isLoadingMore,
  } = usePreloadedPaginationFragment<AdministrativeAreasLinesPaginationQuery, AdministrativeAreasLines_data$key>({
