...
const AdministrativeArea = ({ administrativeAreaData }: { administrativeAreaData: AdministrativeArea_administrativeArea$key }) => {
  const classes = useStyles();

  const administrativeArea = useFragment<AdministrativeArea_administrativeArea$key>(administrativeAreaFragment, administrativeAreaData);
