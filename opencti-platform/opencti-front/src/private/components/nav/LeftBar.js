          ...
          <Collapse in={openDrawer}>
            <MenuList component="nav" disablePadding={true}>
              ...
              <MenuItem
                ...
                selected={location.pathname.includes('/activities/vulnerability_assessment')}
                dense={false}
                classes={{ root: classes.menuItemNested }}
              >
                <ListItemIcon style={{ minWidth: 35 }}>
              ...
              <FeatureFlag tag={'RISK_ASSESSMENT'}>
                <MenuItem
                  component={Link}
                  to="/activities/risk_assessment"
                  selected={location.pathname.includes('/activities/risk_assessment')}
                  dense={false}
                  classes={{ root: classes.menuItemNested }}
                >
                  <ListItemIcon style={{ minWidth: 35 }}>
                  ...
                  <ListItemText primary={t('Risk Assessment')} data-cy='risk_assessment' />
                </MenuItem>
              </FeatureFlag>
            </MenuList>
          </Collapse>
