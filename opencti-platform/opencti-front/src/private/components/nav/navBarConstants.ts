...
/**
 * Persists the rail state and notifies both kinds of listener that exist in the application: components subscribed
 * to `MESSAGING$.toggleNav`, and components listening for a `storage` event.
 */
