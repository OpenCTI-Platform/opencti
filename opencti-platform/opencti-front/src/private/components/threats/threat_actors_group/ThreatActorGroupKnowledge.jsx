...
const ThreatActorGroupKnowledgeComponent = ({ threatActorGroupData, relatedRelationshipTypes }) => {
  const threatActorGroup = useFragment(threatActorGroupKnowledgeFragment, threatActorGroupData);
    ...
    <div data-testid="threat-actor-group-knowledge">
      <Routes>
        <Route
          ...
          element={<StixCoreRelationship entityId={threatActorGroup.id} paddingRight={true} />}
        />
        <Route
          path="/sightings/:sightingId"
          element={<StixSightingRelationship entityId={threatActorGroup.id} paddingRight={true} />}
        />
        <Route
          path="/overview"
          element={
