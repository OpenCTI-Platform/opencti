...
class RootIntrusionSet extends Component {
  constructor(props) {
    ...
    this.state = {
      forceUpdate: String(new Date()),
    };
  }

  handleForceUpdate() {
    this.setState({ forceUpdate: String(new Date()) });
  }
                    ...
                    <div style={{ paddingRight }} data-testid="intrusionSet-details-page">
                      ...
                      >
                        ...
                        <BulkRelationDialogContainer
                          ...
                          handleRefetch={this.handleForceUpdate.bind(this)}
                        />
                        )}
                        {isOverview && (
                      ...
                      <Routes>
                        ...
                        <Route
                          path="/knowledge/*"
                          element={
                            <div data-testid="instrusionSet-knowledge" key={this.state.forceUpdate}>
