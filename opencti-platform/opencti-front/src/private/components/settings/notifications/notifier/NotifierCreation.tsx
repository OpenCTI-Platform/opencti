...
type NotifierFormikHelpers = Pick<FormikHelpers<NotifierAddInput>, 'setErrors' | 'setSubmitting' | 'resetForm'>;

export const NotifierCreationForm: FunctionComponent<NotifierFormProps> = ({ updater, onReset, inputValue, onCompleted }) => {
  ...
  const submitForm = (
    ...
    notifierValidation(t).validate(values).then(() => {
  ...
  return <Formik<NotifierAddInput>
