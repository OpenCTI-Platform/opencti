  ...
  return (
    <>
      ...
      >
        <DialogContent>
          <DialogContentText>
            {t_i18n('Activating this inference rule will automatically generate new relationships on your existing and future data. Please be aware that enabling this rule may impact your platform\'s data and performance.')}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
      ...
      >
        <DialogContent>
          <DialogContentText>
            {t_i18n('Deactivating this inference rule will automatically remove the relationships previously generated by the rule. Please be aware that disabling this rule may impact your platform\'s data and performance.')}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
