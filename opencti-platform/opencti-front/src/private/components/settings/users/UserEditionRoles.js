...
const userMutationRelationAdd = graphql`
  mutation UserEditionRolesRelationAddMutation(
    $id: ID!
...
const userMutationRelationDelete = graphql`
  mutation UserEditionRolesRelationDeleteMutation($id: ID!, $relationId: ID!) {
    userEdit(id: $id) {
...
const UserEditionGroups = createFragmentContainer(UserEditionGroupsComponent, {
  user: graphql`
    fragment UserEditionRoles_user on User {
      id
      groups {
        edges {
          node {
