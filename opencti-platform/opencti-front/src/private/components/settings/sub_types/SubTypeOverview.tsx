...
import GlobalWorkflowSettings from '@components/settings/sub_types/global_workflow_request_access/GlobalWorkflowSettings';
import RequestAccessSettings from '@components/settings/sub_types/global_workflow_request_access/RequestAccessSettings';
