      ...
      {ticks.map((tick, index) => (
        <div key={index} className={classes.tickContainer}>
          <div className={classes.tickValue}>
            <span
              style={{
                color: `${index === 0 ? theme.palette.designSystem.tertiary.grey[400] : tick.color}`,
              }}
            >
              {tick.value}
            </span>
          ...
          <div>
            <span
              ...
              style={{
                backgroundColor: `${tick.color ? tick.color : theme.palette.designSystem.tertiary.blue[500]}`,
              }}
            ></span>
          </div>
