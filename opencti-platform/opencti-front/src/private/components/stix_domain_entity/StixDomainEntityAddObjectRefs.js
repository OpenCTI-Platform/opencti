...
import StixDomainEntityAddObjectRefsLines, {
  stixDomainEntityAddObjectRefsLinesQuery,
} from './StixDomainEntityAddObjectRefsLines';
...
class StixDomainEntityAddObjectRefs extends Component {
  constructor(props) {
    super(props);
                ...
                if (props) {
                  return (
                    <StixDomainEntityAddObjectRefsLines
                      ...
                      stixDomainEntityObjectRefs={stixDomainEntityObjectRefs}
                      data={props}
                    />
                  );
                }
...
StixDomainEntityAddObjectRefs.propTypes = {
