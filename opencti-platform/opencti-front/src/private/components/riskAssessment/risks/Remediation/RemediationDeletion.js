...
import { remediationEditionQuery, remediationEditionDarkLightQuery } from './RemediationEdition';
...
const RemediationDeletionDarkLightMutation = graphql`
  mutation RemediationDeletionDarkLightMutation($id: ID!) {
...
class RemediationDeletion extends Component {
  ...
  submitDelete() {
    ...
    CM(environmentDarkLight, {
      ...
      onError: (err) => console.log('RemediationDeletionDarkLightMutationError', err),
    });
    // commitMutation({
    //   mutation: RemediationDeletionDarkLightMutation,
    //   variables: {
