...
import {
  assoc, compose, map, pipe, over, lensProp, defaultTo,
} from 'ramda';
...
const exportCoursesOfActionQuery = graphql`
  query CoursesOfActionExportCoursesOfActionQuery(
    $count: Int!
    $cursor: ID
...
class CoursesOfAction extends Component {
  ...
  handleGenerateCSV() {
    ...
    fetchQuery(exportCoursesOfActionQuery, {
      count: 90000,
      ...paginationOptions,
    }).then((data) => {
