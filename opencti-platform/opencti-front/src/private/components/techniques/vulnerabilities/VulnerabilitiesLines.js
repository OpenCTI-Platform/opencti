...
class VulnerabilitiesLines extends Component {
  ...
  _isRowLoaded({ index }) {
    ...
    const list = this.filterList(
      pathOr([], ['vulnerabilities', 'edges'], this.props.data),
    );
  ...
  _rowRenderer({ index, key, style }) {
    ...
    const vulnerabilityNode = list[index];
    if (!vulnerabilityNode) {
      return <div key={key}>&nbsp;</div>;
    }
    const vulnerability = vulnerabilityNode.node;
    return (
      <div key={key} style={style}>
        <VulnerabilityLine
          ...
          vulnerabilities(
            ...
            edges {
              node {
                ...
                name
                description
                ...VulnerabilityLine_vulnerability
              }
            }
          }
        }
