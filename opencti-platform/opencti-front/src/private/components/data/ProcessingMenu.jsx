...
import useGranted, { KNOWLEDGE_KNUPDATE, SETTINGS_SETACCESSES, INGESTION_SETCSVMAPPERS } from '../../../utils/hooks/useGranted';
...
const ProcessingMenu = () => {
  ...
  const isCsvMapperUpdater = useGranted([INGESTION_SETCSVMAPPERS]);
  return (
    <Drawer
      variant="permanent"
      anchor="right"
