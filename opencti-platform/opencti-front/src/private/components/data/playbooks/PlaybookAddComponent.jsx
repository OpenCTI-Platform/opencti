...
class PlaybookAddComponent extends Component {
  constructor(props) {
    super(props);
  ...
  getPaginationOptions() {
    ...
    if (
      ...
      && PlaybookAddComponent.isTypeObservable(
        targetStixCoreObjectTypes,
      )
    ) {
      orderBy = 'created_at';
  ...
  renderSearchTypeFilter(paginationOptions) {
    ...
    if (
      types.length === 1
      && (PlaybookAddComponent.isTypeDomainObject(types)
        || PlaybookAddComponent.isTypeObservable(types))
    ) {
      return null;
    }
    const { t } = this.props;
      ...
      <div>
        ...
        >
          <div className={classes.header}>
            ...
            {(PlaybookAddComponent.isTypeDomainObject(
...
PlaybookAddComponent.propTypes = {
