...
export type CsvMapperRepresentationAttribute =
  CsvMapperEditionContainerFragment_csvMapper$data['representations'][number]['attributes'][number];

export type CsvMapperRepresentationAttributeEdit = Omit<
