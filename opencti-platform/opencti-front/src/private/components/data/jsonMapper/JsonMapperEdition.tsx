...
const JsonMapperEdition: FunctionComponent<JsonMapperEditionProps> = ({ jsonMapper, onClose }) => {
  ...
  const onSubmit: FormikConfig<JsonMapperFormData>['onSubmit'] = (values, { setSubmitting }) => {
