            ...
            <ListItemText
              primary={(
                ...
                >
                  ...
                  <SortConnectorsHeader field="is_managed" label={t_i18n('Manager deployment')} isSortable orderAsc={orderAsc} sortBy={sortBy} reverseBy={reverseBy} sx={{ textAlign: 'center' }} />
                </div>
              )}
            />
          </ListItem>
