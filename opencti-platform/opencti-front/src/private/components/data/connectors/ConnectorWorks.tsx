...
import ConnectorWorksErrorLine, { ParsedWorkMessage, testMessage } from './ConnectorWorksErrorLine';
...
const ConnectorWorksComponent: FunctionComponent<ConnectorWorksComponentProps> = ({
  ...
  const parseErrors = (errorsList: WorkMessages[]): testMessage[] => {
      ...
      try {
        ...
        return {
          ...
          parsedError: {
            ...
            entityId: entityId,
            entityName: getMainRepresentative(JSON.parse(error.source), entityId),
            entityType: JSON.parse(error.source).type,
          },
          rawError: error,
        };
      } catch (_) {
