        ...
        <FormControl fullWidth variant="standard" style={{ marginTop: 20 }} disabled={field.isMandatory && !isInParsedMode}>
          ...
          <Select
            ...
            onChange={(e) => {
              ...
              // Auto-fill label with attribute label
              if (selectedAttribute && !field.label) {
              ...
              // Determine and set the appropriate field type
              ...
              if (compatibleTypes.length > 0) {
                // Check if it's an OpenVocab field first
                ...
                } else if (selectedAttribute?.defaultValues && selectedAttribute.defaultValues.length > 0) {
                  // If attribute has vocabulary, use select/multiselect based on multiplicity
