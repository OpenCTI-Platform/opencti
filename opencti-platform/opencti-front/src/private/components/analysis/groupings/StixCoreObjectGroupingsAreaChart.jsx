...
const stixCoreObjectGroupingsAreaChartTimeSeriesQuery = graphql`
  query StixCoreObjectGroupingsAreaChartTimeSeriesQuery(
    $objectId: String
    $authorId: String
...
class StixCoreObjectGroupingsAreaChart extends Component {
  renderContent() {
    const {
      t,
      fsd,
...
StixCoreObjectGroupingsAreaChart.propTypes = {
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(StixCoreObjectGroupingsAreaChart);
