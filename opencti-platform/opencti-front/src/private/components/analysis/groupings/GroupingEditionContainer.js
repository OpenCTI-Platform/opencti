...
class GroupingEditionContainer extends Component {
  render() {
    const { t, classes, handleClose, grouping } = this.props;
...
GroupingEditionContainer.propTypes = {
