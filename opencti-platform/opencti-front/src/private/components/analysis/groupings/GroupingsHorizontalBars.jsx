...
const groupingsHorizontalBarsDistributionQuery = graphql`
  query GroupingsHorizontalBarsDistributionQuery(
    $field: String!
...
class GroupingsHorizontalBars extends Component {
  renderContent() {
...
GroupingsHorizontalBars.propTypes = {
