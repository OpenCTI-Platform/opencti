  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Route
          exact
          path="/dashboard/analysis/groupings/:groupingId/knowledge/graph"
          render={() => (
            <QueryRenderer
        ...
        <Route
          exact
          path="/dashboard/analysis/groupings/:groupingId/knowledge/correlation"
          render={() => (
            <QueryRenderer
        ...
        <Route
          exact
          path="/dashboard/analysis/groupings/:groupingId/knowledge/matrix"
          render={() => (
            <QueryRenderer
