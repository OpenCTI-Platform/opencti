...
type CaseRftsProps = Record<string, never>;
...
export const LOCAL_STORAGE_KEY_CASE_RFTS = 'caseRfts';
    ...
    <div data-testid="rfts-page">
      ...
      {queryRef && (
        <DataTable
          ...
          storageKey={LOCAL_STORAGE_KEY_CASE_RFTS}
