...
interface IncidentKnowledgeGraphComponentProps {
  mode: string
  enableReferences: boolean
  incident: IncidentKnowledgeGraph_fragment$data
}

const IncidentKnowledgeGraphComponent = ({
  enableReferences,
  incident,
  mode,
}: IncidentKnowledgeGraphComponentProps) => {
