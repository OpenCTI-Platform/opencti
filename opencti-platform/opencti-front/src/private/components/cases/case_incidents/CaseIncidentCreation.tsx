...
export const CaseIncidentCreationForm: FunctionComponent<IncidentFormProps> = ({
  ...
  const [commit] = useApiMutation<CaseIncidentCreationCaseMutation>(
    ...
    undefined,
    { successMessage: `${translateEntityType('Case-Incident')} ${t_i18n('successfully created')}` },
  );
...
const CaseIncidentCreation = ({
  ...
  return (
    <Drawer
      title={t_i18n('', { id: 'Create ...', values: { entity_type: translateEntityType('Case-Incident') } })}
