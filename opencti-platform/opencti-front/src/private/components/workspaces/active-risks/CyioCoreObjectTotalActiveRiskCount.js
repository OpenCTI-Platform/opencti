...
const cyioCoreObjectTotalActiveRiskCountQuery = graphql`
  query CyioCoreObjectTotalActiveRiskCountQuery(
    $type: String
    $field: String!
    $match: [String]
...
class CyioCoreObjectTotalActiveRiskCount extends Component {
  renderContent() {
    const {
      t,
      title,
...
CyioCoreObjectTotalActiveRiskCount.propTypes = {
  t: PropTypes.func,
};
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(CyioCoreObjectTotalActiveRiskCount);
