...
const cyioCoreObjectRiskOccurrencesAreaChartQuery = graphql`
  query CyioCoreObjectRiskOccurrencesAreaChartQuery(
    $type: String
    $field: String!
    $match: [String]
...
class CyioCoreObjectRiskOccurrencesAreaChart extends Component {
  renderContent() {
    const {
      t,
      md,
    ...
    return (
      <QueryRenderer
        query={cyioCoreObjectRiskOccurrencesAreaChartQuery}
        variables={riskTimeSeriesVariables}
        render={({ props }) => {
...
CyioCoreObjectRiskOccurrencesAreaChart.propTypes = {
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(CyioCoreObjectRiskOccurrencesAreaChart);
