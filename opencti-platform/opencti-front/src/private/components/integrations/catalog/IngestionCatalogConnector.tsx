...
import IngestionCatalogConnectorHeader from '@components/integrations/catalog/IngestionCatalogConnectorHeader';
    ...
    <>
      <Breadcrumbs
        elements={[
          ...
          { label: t_i18n('Available'), link: '/dashboard/integrations/available' },
