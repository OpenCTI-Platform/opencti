...
import { networkEditionQuery } from './NetworkEdition';
...
const NetworkPopoverDeletionMutation = graphql`
  mutation NetworkPopoverDeletionMutation($id: ID!) {
...
class NetworkPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  submitDelete() {
    ...
    commitMutation({
      mutation: NetworkPopoverDeletionMutation,
      variables: {
        id: this.props.id,
      },
      onCompleted: () => {
