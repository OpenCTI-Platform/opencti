...
const stixCoreObjectSoftwareAreaChartTimeSeriesQuery = graphql`
  query StixCoreObjectSoftwareAreaChartTimeSeriesQuery(
    $objectId: String
    $field: String!
...
class StixCoreObjectSoftwareAreaChart extends Component {
  renderContent() {
    const {
      t,
      md,
...
StixCoreObjectSoftwareAreaChart.propTypes = {
...
export default compose(
  ...
  withTheme,
  withStyles(styles),
)(StixCoreObjectSoftwareAreaChart);
