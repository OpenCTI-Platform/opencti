...
import { softwareEditionQuery } from './SoftwareEdition';
...
const SoftwarePopoverDeletionMutation = graphql`
  mutation SoftwarePopoverDeletionMutation($id: ID!) {
    campaignEdit(id: $id) {
      delete
    }
  }
...
class SoftwarePopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  submitDelete() {
    ...
    commitMutation({
      mutation: SoftwarePopoverDeletionMutation,
      variables: {
        id: this.props.id,
      },
      onCompleted: () => {
