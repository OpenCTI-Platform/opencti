...
const softwareMutation = graphql`
  mutation SoftwareCreationMutation($input: CampaignAddInput!) {
      ...
      <div>
        ...
        >
          <div className={classes.header}>
            ...
            <Typography variant="h6">{t('Create a software')}</Typography>
          </div>
