...
const networkArchitectureCreationMutation = graphql`
  mutation NetworkArchitectureCreationMutation($input: DescriptionBlockInput!) {
...
class NetworkArchitectureCreation extends Component {
  onReset() {
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    commitMutation({
      mutation: networkArchitectureCreationMutation,
      variables: {
        input: values,
      },
      setSubmitting,
...
NetworkArchitectureCreation.propTypes = {
  t: PropTypes.func,
  fldt: PropTypes.func,
...
export default compose(inject18n, withStyles(styles))(NetworkArchitectureCreation);
