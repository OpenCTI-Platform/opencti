...
import PersonEditionOverview from './PersonEditionOverview';
    ...
    return (
      <div>
        ...
        <div className={classes.container}>
          <PersonEditionOverview person={this.props.person} context={editContext}/>
        </div>
      </div>
    );
  }
...
const PersonEditionFragment = createFragmentContainer(PersonEditionContainer, {
  person: graphql`
    fragment PersonEditionContainer_person on User {
      id
