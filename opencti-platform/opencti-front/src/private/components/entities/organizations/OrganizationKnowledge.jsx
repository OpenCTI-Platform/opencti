...
const OrganizationKnowledgeComponent = ({ organizationData, viewAs }) => {
  const organization = useFragment(organizationKnowledgeFragment, organizationData);
    ...
    <div data-testid="organization-knowledge">
      <Routes>
        <Route
          ...
          element={<StixCoreRelationship entityId={organization.id} paddingRight={true} />}
        />
        <Route
          path="/sightings/:sightingId"
          element={<StixSightingRelationship entityId={organization.id} paddingRight={true} />}
        />
        <Route
          path="/overview"
          element={
