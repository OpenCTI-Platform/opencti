...
class OrganizationPopover extends Component {
  ...
  render() {
    ...
    return (
      <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE, KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Organization'>
        <>
          <ToggleButton
            value="popover"
            size="small"
          ...
          >
            ...
            <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Organization'>
...
export default compose(inject18n, withRouter)(OrganizationPopover);
