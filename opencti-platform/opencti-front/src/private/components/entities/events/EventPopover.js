...
class EventPopover extends Component {
  ...
  submitDelete() {
    ...
    commitMutation({
      mutation: EventPopoverDeletionMutation,
      variables: {
        id: this.props.id,
      },
      onCompleted: () => {
        ...
        this.handleClose();
        this.props.history.push('/dashboard/entities/events');
      },
    });
  }
...
export default compose(inject18n, withRouter, withStyles(styles))(EventPopover);
