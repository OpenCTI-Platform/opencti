...
import { EntityNoteLine, EntityNoteLineDummy } from './EntityNoteLine';
import { setNumberOfElements } from '../../../../../utils/Number';

const nbOfRowsToLoad = 50;

class EntitiesNotesLines extends Component {
  constructor(props) {
    super(props);
    this.state = { offset: 0 };
  }
  ...
  render() {
    ...
    return (
      <ListLinesContent
        ...
        offset={this.state.offset}
        LineComponent={<EntityNoteLine />}
        DummyLineComponent={<EntityNoteLineDummy />}
        selectAll={selectAll}
...
export const entitiesNotesLinesQuery = graphql`
  query EntitiesNotesLinesPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment EntitiesNotesLines_data on Query
      @argumentDefinitions(
        search: { type: "String" }
