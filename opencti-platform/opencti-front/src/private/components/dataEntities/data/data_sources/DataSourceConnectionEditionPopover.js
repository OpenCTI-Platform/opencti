...
const DataSourceConnectionEditionPopover = createFragmentContainer(
  DataSourceConnectionPopoverComponent,
  {
    dataSource: graphql`
      fragment DataSourceConnectionEditionPopover_data on DataSource {
...
export default compose(inject18n, withStyles(styles))(DataSourceConnectionEditionPopover);
