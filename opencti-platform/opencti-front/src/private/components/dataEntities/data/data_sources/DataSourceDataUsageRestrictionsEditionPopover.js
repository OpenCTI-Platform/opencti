...
const DataSourceDataUsageRestrictionsEditionPopover = createFragmentContainer(
  DataSourceDataUsageRestrictionsPopoverComponent,
  {
    dataSource: graphql`
      fragment DataSourceDataUsageRestrictionsEditionPopover_dataSource on DataSource {
        iep {
          id
          name
          tlp
...
export default compose(inject18n, withStyles(styles))(DataSourceDataUsageRestrictionsEditionPopover);