...
const dataSourceAssessmentPlatformsCreationMutation = graphql`
  mutation DataSourceAssessmentPlatformsCreationMutation($input: AssessmentPlatformAddInput) {
...
class DataSourceAssessmentPlatformsCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    ...
    commitMutation({
      mutation: dataSourceAssessmentPlatformsCreationMutation,
      variables: {
        input: finalValues,
      },
      setSubmitting,
...
DataSourceAssessmentPlatformsCreation.propTypes = {
...
)(DataSourceAssessmentPlatformsCreation);
