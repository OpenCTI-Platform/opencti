...
class EntitiesAssessmentPlatformsPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
EntitiesAssessmentPlatformsPopover.propTypes = {
...
export default compose(inject18n, withStyles(styles))(EntitiesAssessmentPlatformsPopover);
