...
class EntityAssessmentPlatformCardComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      openMenu: false,
...
EntityAssessmentPlatformCardComponent.propTypes = {
...
const EntityAssessmentPlatformCardFragment = createFragmentContainer(
  EntityAssessmentPlatformCardComponent,
  {
    node: graphql`
...
export const EntityAssessmentPlatformCard = compose(
  inject18n,
  withStyles(styles),
)(EntityAssessmentPlatformCardFragment);

class EntityAssessmentPlatformCardDummyComponent extends Component {
  render() {
...
EntityAssessmentPlatformCardDummyComponent.propTypes = {
  classes: PropTypes.object,
};

export const EntityAssessmentPlatformCardDummy = compose(
  inject18n,
  withStyles(styles),
)(EntityAssessmentPlatformCardDummyComponent);
