...
import { EntityResponsiblePartyCard, EntityResponsiblePartyCardDummy } from './EntityResponsiblePartyCard';
...
class EntitiesResponsiblePartiesCards extends Component {
  constructor(props) {
    super(props);
    this.state = {
      bookmarks: [],
...
EntitiesResponsiblePartiesCards.propTypes = {
...
export const entitiesResponsiblePartiesCardsQuery = graphql`
  query EntitiesResponsiblePartiesCardsPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
    ...
    ...EntitiesResponsiblePartiesCards_data
      @arguments(
        search: $search
        first: $first
        offset: $offset
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment EntitiesResponsiblePartiesCards_data on Query
      @argumentDefinitions(
        search: { type: "String" }
        ...
        oscalResponsibleParties(
          ...
          edges {
            node {
              id
              ...EntityResponsiblePartyCard_node
            }
          }
          pageInfo {
            endCursor
