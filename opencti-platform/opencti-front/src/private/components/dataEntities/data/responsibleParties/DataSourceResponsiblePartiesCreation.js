...
const dataSourceResponsiblePartiesCreationMutation = graphql`
  mutation DataSourceResponsiblePartiesCreationMutation($input: OscalResponsiblePartyAddInput) {
...
class DataSourceResponsiblePartiesCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    ...
    commitMutation({
      mutation: dataSourceResponsiblePartiesCreationMutation,
      variables: {
        input: finalValues,
      },
      setSubmitting,
...
DataSourceResponsiblePartiesCreation.propTypes = {
...
)(DataSourceResponsiblePartiesCreation);
