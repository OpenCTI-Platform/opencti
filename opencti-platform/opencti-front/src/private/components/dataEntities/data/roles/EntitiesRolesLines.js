...
import { EntityRoleLine, EntityRoleLineDummy } from './EntityRoleLine';
import { setNumberOfElements } from '../../../../../utils/Number';

const nbOfRowsToLoad = 50;

class EntitiesRolesLines extends Component {
  constructor(props) {
    super(props);
    this.state = { offset: 0 };
  }
...
export const entitiesRolesLinesQuery = graphql`
  query EntitiesRolesLinesPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment EntitiesRolesLines_data on Query
      @argumentDefinitions(
        search: { type: "String" }
