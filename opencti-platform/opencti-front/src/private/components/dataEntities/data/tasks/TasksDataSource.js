...
class TasksDataSource extends Component {
  constructor(props) {
    super(props);
  ...
  handleRefresh() {
    this.props.history.push('/data/data source/tasks');
  }
...
TasksDataSource.propTypes = {
  t: PropTypes.func,
  history: PropTypes.object,
  location: PropTypes.object,
};

export default R.compose(inject18n, withRouter)(TasksDataSource);
