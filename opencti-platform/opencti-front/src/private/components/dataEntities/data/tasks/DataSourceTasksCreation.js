...
const dataSourceTasksCreationMutation = graphql`
  mutation DataSourceTasksCreationMutation($input: OscalTaskAddInput) {
...
class DataSourceTasksCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    ...
    commitMutation({
      mutation: dataSourceTasksCreationMutation,
      variables: {
        input: finalValues,
      },
      setSubmitting,
...
DataSourceTasksCreation.propTypes = {
