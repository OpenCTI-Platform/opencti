...
const dataSourceExternalReferencesCreationMutation = graphql`
  mutation DataSourceExternalReferencesCreationMutation($input: OscalRoleAddInput) {
...
class DataSourceExternalReferencesCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    ...
    commitMutation({
      mutation: dataSourceExternalReferencesCreationMutation,
      variables: {
        input: finalValues,
      },
      setSubmitting,
...
DataSourceExternalReferencesCreation.propTypes = {
...
)(DataSourceExternalReferencesCreation);
