...
class EntitiesExternalReferencesPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
EntitiesExternalReferencesPopover.propTypes = {
...
export default compose(inject18n, withStyles(styles))(EntitiesExternalReferencesPopover);
