...
const DataSourcePartiesDeletionMutation = graphql`
  mutation DataSourcePartiesDeletionMutation($id: ID!) {
...
class DataSourcePartiesDeletion extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
        ...
        >
            <DialogContent>
              <Typography style={{
                ...
                {t('Are you sure you’d like to delete this Party?')}
              </Typography>
              <DialogContentText>
...
DataSourcePartiesDeletion.propTypes = {
  id: PropTypes.string,
