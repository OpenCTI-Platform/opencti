...
export const EntityPartyLine = compose(
  inject18n,
  withStyles(styles),
)(EntityPartyLineFragment);

class EntityPartyLineDummyComponent extends Component {
  render() {
...
EntityPartyLineDummyComponent.propTypes = {
  classes: PropTypes.object,
  dataColumns: PropTypes.object,
};

export const EntityPartyLineDummy = compose(
  inject18n,
  withStyles(styles),
)(EntityPartyLineDummyComponent);
