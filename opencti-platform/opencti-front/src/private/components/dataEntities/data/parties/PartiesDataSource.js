...
class PartiesDataSource extends Component {
  constructor(props) {
    super(props);
  ...
  handleRefresh() {
    this.props.history.push('/data/data source/parties');
  }

  handleDisplayEdit(selectedElements) {
    const partyId = Object.entries(selectedElements)[0][1].id;
    this.props.history.push({
      pathname: `/activities/risk_assessment/risks/${partyId}`,
      openEdit: true,
    });
  }
...
PartiesDataSource.propTypes = {
  t: PropTypes.func,
  history: PropTypes.object,
  location: PropTypes.object,
};

export default R.compose(inject18n, withRouter)(PartiesDataSource);
