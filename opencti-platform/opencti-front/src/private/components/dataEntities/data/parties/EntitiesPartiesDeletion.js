...
class EntitiesPartiesDeletion extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  submitDelete() {
    const partyIds = this.props.id.map((value) => (Array.isArray(value) ? value[0] : value));
...
EntitiesPartiesDeletion.propTypes = {
  id: PropTypes.array,
