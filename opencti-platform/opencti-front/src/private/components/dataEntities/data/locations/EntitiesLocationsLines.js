...
import { EntityLocationLine, EntityLocationLineDummy } from './EntityLocationLine';
import { setNumberOfElements } from '../../../../../utils/Number';

const nbOfRowsToLoad = 50;

class EntitiesLocationsLines extends Component {
  constructor(props) {
    super(props);
    this.state = { offset: 0 };
  }
...
export const entitiesLocationsLinesQuery = graphql`
  query EntitiesLocationsLinesPaginationQuery(
    $search: String
    $first: Int!
    $offset: Int!
    $cursor: ID
...
export default createPaginationContainer(
  ...
  {
    data: graphql`
      fragment EntitiesLocationsLines_data on Query
      @argumentDefinitions(
        search: { type: "String" }
