...
class EntitiesLocationsPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
...
EntitiesLocationsPopover.propTypes = {
...
export default compose(inject18n, withStyles(styles))(EntitiesLocationsPopover);
