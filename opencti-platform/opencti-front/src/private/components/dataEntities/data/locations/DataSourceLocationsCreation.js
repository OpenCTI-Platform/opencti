...
const dataSourceLocationsCreationMutation = graphql`
  mutation DataSourceLocationsCreationMutation($input: OscalLocationAddInput) {
...
class DataSourceLocationsCreation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  onSubmit(values, { setSubmitting, resetForm }) {
    ...
    commitMutation({
      mutation: dataSourceLocationsCreationMutation,
      variables: {
        input: finalValues,
      },
      setSubmitting,
...
DataSourceLocationsCreation.propTypes = {
