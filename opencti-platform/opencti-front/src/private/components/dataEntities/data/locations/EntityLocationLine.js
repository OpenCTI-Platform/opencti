...
class EntityLocationLineComponent extends Component {
  render() {
    const {
      t,
      fd,
...
const EntityLocationLineFragment = createFragmentContainer(
  EntityLocationLineComponent,
  {
    node: graphql`
...
export const EntityLocationLine = compose(
  inject18n,
  withStyles(styles),
)(EntityLocationLineFragment);

class EntityLocationLineDummyComponent extends Component {
  render() {
...
EntityLocationLineDummyComponent.propTypes = {
  classes: PropTypes.object,
  dataColumns: PropTypes.object,
};

export const EntityLocationLineDummy = compose(
  inject18n,
  withStyles(styles),
)(EntityLocationLineDummyComponent);
