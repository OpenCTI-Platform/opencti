...
import { CK_FONT_SIZE_MAP } from './TextStyle';

/**
 * Extends TipTap's FontSize to read font size from CKEditor classes when no
        ...
        attributes: {
          fontSize: {
            ...
            parseHTML: (element: HTMLElement) => {
              for (const [cls, size] of Object.entries(CK_FONT_SIZE_MAP)) {
