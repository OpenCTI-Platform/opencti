...
const EntitiesDetailsRightsBar = () => {
  ...
  return (
    <Drawer
      ...
      variant="permanent"
      anchor="right"
      // A tab-scoped bar is layer 1 like the Knowledge and Content bars it sits beside; the class and
      // `layerInputVars` share the node so the fields inside resolve at that layer instead of at the root.
    ...
    >
      ...
      <div style={{ display: 'flex' }}>
        {/* The FormControl/InputLabel/Select triple collapses into the library compound: SelectLabel replaces
            InputLabel and carries the association, so the hand-rolled `labelId`/`label` pair goes with it. */}
