...
vi.mock(
  '../../private/components/common/stix_domain_objects/StixDomainObjectBookmarksList',
  () => ({
...
vi.mock(
  '../../private/components/common/stix_core_objects/StixCoreObjectsDistributionList',
  () => ({
    default: () => <div data-testid="stix-distribution-list" />,
  }),
);
vi.mock(
  '../../private/components/common/stix_core_objects/StixCoreObjectsMultiVerticalBars',
  () => ({
...
vi.mock(
  '../../private/components/common/stix_core_objects/StixCoreObjectsMultiHorizontalBars',
  () => ({
...
describe('DashboardEntitiesViz', () => {
  it('renders DraftsNumber for number widget with DraftWorkspace filter', () => {
    ...
    const { getByTestId } = testRender(<DashboardEntitiesViz widget={widget} config={config} />);
