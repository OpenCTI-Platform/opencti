...
const relationsTypesMapping = {
  ...
  'Campaign_Threat-Actor-Individual': ['attributed-to'],
  Campaign_Tool: ['uses'],
  ...
  'Domain-Name_Organization': ['belongs-to'],
  'Domain-Name_Individual': ['belongs-to'],
  ...
  'IPv6-Addr_Organization': ['belongs-to'],
  'IPv6-Addr_Individual': ['belongs-to'],
  ...
  'Incident_Threat-Actor-Individual': ['attributed-to'],
  Incident_Tool: ['uses'],
  ...
  'Indicator_Threat-Actor-Individual': ['indicates'],
  ...
  'Intrusion-Set_Threat-Actor-Individual': ['attributed-to'],
  ...
  'Malware_Threat-Actor-Individual': ['authored-by'],
  ...
  'Threat-Actor-Group_Channel': ['uses'],
  'Threat-Actor-Group_Narrative': ['uses'],
  ...
  'Threat-Actor-Group_Campaign': ['participates-in'],
  ...
  'Threat-Actor-Group_Threat-Actor-Individual': ['part-of', 'cooperates-with'],
  'Threat-Actor-Group_Threat-Actor-Group': ['part-of', 'cooperates-with'],
  'Threat-Actor-Group_Tool': ['uses'],
  'Threat-Actor-Group_Vulnerability': ['targets'],
  'Threat-Actor-Group_StixFile': ['uses'],
  'Threat-Actor-Group_Event': ['targets'],
  'Threat-Actor-Individual_Attack-Pattern': ['uses'],
  'Threat-Actor-Individual_Channel': ['uses'],
  'Threat-Actor-Individual_Narrative': ['uses'],
  'Threat-Actor-Individual_City': ['located-at', 'targets'],
  'Threat-Actor-Individual_Country': ['located-at', 'targets'],
  'Threat-Actor-Individual_Individual': ['attributed-to', 'impersonates', 'targets'],
  'Threat-Actor-Individual_Infrastructure': ['compromises', 'hosts', 'owns', 'uses'],
  'Threat-Actor-Individual_Malware': ['uses'],
  'Threat-Actor-Individual_Campaign': ['participates-in'],
  'Threat-Actor-Individual_Organization': ['attributed-to', 'impersonates', 'targets'],
  'Threat-Actor-Individual_Position': ['located-at', 'targets'],
  'Threat-Actor-Individual_Region': ['located-at', 'targets'],
  'Threat-Actor-Individual_Sector': ['targets'],
  'Threat-Actor-Individual_Threat-Actor-Group': ['part-of', 'cooperates-with'],
  'Threat-Actor-Individual_Threat-Actor-Individual': ['part-of', 'cooperates-with'],
  'Threat-Actor-Individual_Tool': ['uses'],
  'Threat-Actor-Individual_Vulnerability': ['targets'],
  'Threat-Actor-Individual_StixFile': ['uses'],
  'Threat-Actor-Individual_Event': ['targets'],
