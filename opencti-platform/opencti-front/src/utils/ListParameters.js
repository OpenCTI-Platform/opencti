...
export const buildViewParamsFromUrlAndStorage = (
  ...
  if (finalParams.selectFreeRectangle) {
    finalParams.selectFreeRectangle = finalParams.selectFreeRectangle.toString() === 'true';
  }
  if (finalParams.selectModeFree) {
    finalParams.selectModeFree = finalParams.selectModeFree.toString() === 'true';
  }
  if (finalParams.selectFree) {
    finalParams.selectFree = finalParams.selectFree.toString() === 'true';
  }
  if (finalParams.showTimeRange) {
    finalParams.showTimeRange = finalParams.showTimeRange.toString() === 'true';
  }
  if (finalParams.withForces) {
    finalParams.withForces = finalParams.withForces.toString() === 'true';
  }
