 ...
 * /!\ Relies on the id uniqueness invariant enforced by `ensureFilterIds` (filtersUtils.tsx):
 * a duplicated id would make a single edit (or a `removeFilterGroupUtil` deletion) fan out to
 * every group sharing it.
 */
