...
import setTableFullWidth, { defaultTableLayout, getMaxTableColumnCount } from './utils/pdfTableWidth';
...
export const htmlToPdfReport = async (
  ...
  const containsWideTable = maxTableColumnCount >= 8;
  const containsVeryWideTable = maxTableColumnCount >= 12;
