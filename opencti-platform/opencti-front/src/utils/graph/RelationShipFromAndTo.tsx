...
const RelationShipFromAndToComponent: FunctionComponent<RelationShipFromAndToComponentProps> = ({ queryRef, direction }) => {
  const classes = useStyles();
  const { t } = useFormatter();

  const entity = usePreloadedQuery<RelationShipFromAndToQuery>(relationShipFromAndToQuery, queryRef);
...
const RelationShipFromAndTo: FunctionComponent<Omit<RelationShipFromAndToProps, 'queryRef'>> = ({ id, direction }) => {
