...
const useFormEditor = (data: GenericData, enableReferences: boolean, queries: Queries) => {
  ...
  return { changeMarking, changeCreated, changeFocus, fieldPatch: commitFieldPatch };
};
