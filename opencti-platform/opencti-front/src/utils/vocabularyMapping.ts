...
export const OPENVOCAB_FIELD_MAPPINGS: VocabularyMapping[] = [
  ...
  {
    attribute: 'x_mitre_platforms',
    vocabularyType: 'platforms_ov',
    label: 'Platforms',
    multiple: true,
  },
  {
    attribute: 'x_mitre_permissions_required',
    vocabularyType: 'permissions-ov',
  ...
  {
    attribute: 'threat_actor_types',
    vocabularyType: 'threat-actor-group-type-ov',
    label: 'Threat actor types',
    multiple: true,
  },
  {
    attribute: 'sophistication',
    vocabularyType: 'threat-actor-group-sophistication-ov',
    label: 'Sophistication',
    multiple: false,
  },
  {
    attribute: 'resource_level',
    vocabularyType: 'attack-resource-level-ov',
    label: 'Resource level',
    multiple: false,
  },
  {
    attribute: 'primary_motivation',
    vocabularyType: 'attack-motivation-ov',
  ...
  {
    attribute: 'goals',
    vocabularyType: 'threat-actor-group-goals-ov',
    label: 'Goals',
    multiple: true,
  },
  {
    attribute: 'roles',
    vocabularyType: 'threat-actor-group-role-ov',
    label: 'Roles',
    multiple: true,
  },
  ...
  { attribute: 'eye_color', vocabularyType: 'eye-color-ov', label: 'Eye color', multiple: false },
  {
    ...
    vocabularyType: 'hair-color-ov',
    label: 'Hair color',
    multiple: false,
  },
  {
    attribute: 'marital_status',
    vocabularyType: 'marital-status-ov',
  ...
  // Malware attributes
  {
    ...
    vocabularyType: 'malware-type-ov',
    label: 'Malware types',
    multiple: true,
  },
  {
    attribute: 'architecture_execution_envs',
    vocabularyType: 'processor-architecture-ov',
    label: 'Architecture execution env.',
    multiple: true,
  },
  {
    attribute: 'implementation_languages',
    vocabularyType: 'implementation-language-ov',
    label: 'Implementation languages',
    multiple: true,
  },
  {
    attribute: 'capabilities',
    vocabularyType: 'malware-capabilities-ov',
    label: 'Capabilities',
    multiple: true,
  },
  ...
  { attribute: 'priority', vocabularyType: 'case_priority_ov', label: 'Priority', multiple: false },
  {
    ...
    vocabularyType: 'incident_response_types_ov',
    label: 'Response types',
    multiple: true,
  },
  {
    attribute: 'request_for_information_types',
    vocabularyType: 'request_for_information_types_ov',
    label: 'Request for information types',
    multiple: true,
  },
  {
    attribute: 'request_for_takedown_types',
    vocabularyType: 'request_for_takedown_types_ov',
  ...
  // Report attributes
  {
    ...
    vocabularyType: 'report_types_ov',
    label: 'Report types',
    multiple: true,
  },
  ...
  {
    attribute: 'context',
    vocabularyType: 'grouping-context-ov',
    label: 'Context',
    multiple: false,
  },
  ...
  // Incident attributes
  {
    ...
    vocabularyType: 'incident-type-ov',
    label: 'Incident type',
    multiple: false,
  },
  ...
  // Infrastructure attributes
  {
    ...
    vocabularyType: 'infrastructure_type_ov',
  ...
  // Indicator attributes
  {
    ...
    vocabularyType: 'pattern_type_ov',
    label: 'Pattern type',
    multiple: false,
  },
  {
    attribute: 'indicator_types',
    vocabularyType: 'indicator_type_ov',
  ...
  {
    attribute: 'collection_layers',
    vocabularyType: 'collection_layers_ov',
    label: 'Layers',
    multiple: true,
  },
  ...
  // Channel attributes
  {
    ...
    vocabularyType: 'channel_types_ov',
    label: 'Channel types',
    multiple: true,
  },
  ...
  // Organization attributes
  {
    ...
    vocabularyType: 'organization_type_ov',
  ...
  {
    attribute: 'security_platform_type',
    vocabularyType: 'security_platform_type_ov',
    label: 'Security platform type',
    multiple: false,
  },
  ...
  {
    attribute: 'result_name',
    vocabularyType: 'malware_result_ov',
    label: 'Result name',
    multiple: false,
  },
  ...
  {
    attribute: 'ingestion_running',
    vocabularyType: 'ingestion_running_ov',
 ...
 */
export const getVocabularyMappingByAttribute = (
  attribute: string,
): VocabularyMapping | undefined => {
