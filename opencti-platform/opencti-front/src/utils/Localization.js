const i18n = {
  messages: {
    'es-es': {
      ...
      'start investigation from report': 'Iniciar investigación desde el informe',
    ...
    'ja-jp': {
      ...
      'start investigation from report': 'レポートから調査を開始する',
      Periodicity: '周期',
      Period: '時代',
      Time: '時間',
      month: '月',
    ...
    'zh-cn': {
      ...
      'start investigation from report': '从报告开始调查',
      Periodicity: '周期性',
      Period: '時期',
      Time: '時間',
      month: '月',
