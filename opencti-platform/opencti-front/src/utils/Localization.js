const i18n = {
  messages: {
    ...
    'fr-fr': {
      ...
      'Each tick value must be between min and max value': 'Chaque valeur de tick doit être comprise entre la valeur min et max',
    ...
    'ja-jp': {
      ...
      'Each tick value must be between min and max value': '各ティック値は最小値と最大値の間にある必要があります',
