const i18n = {
  messages: {
    'es-es': {
      ...
      'Use these options if we know what you are doing': 'Utilice estas opciones si sabemos lo que está haciendo',
    ...
    'fr-fr': {
      ...
      'Use these options if we know what you are doing': 'Utilisez ces options si vous savez ce que vous faites',
    ...
    'ja-jp': {
      ...
      'Use these options if we know what you are doing': 'あなたが何をしているのかわかっている場合は、これらのオプションを使用してください',
    ...
    'zh-cn': {
      ...
      'Use these options if we know what you are doing': '如果我們知道您在做什麼，請使用這些選項',
