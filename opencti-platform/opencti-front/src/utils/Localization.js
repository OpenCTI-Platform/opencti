const i18n = {
  messages: {
    'es-es': {
      ...
      Expired: 'Caducada',
      'Locked (security)': 'Bloqueado (seguridad)',
      'Locked (training)': 'Bloqueado (entrenamiento)',
    },
    'fr-fr': {
      // Titles
      'OpenCTI - Cyber threat intelligence platform':
      ...
      Expired: 'Expiré',
      'Locked (security)': 'Verrouillé (sécurité)',
      'Locked (training)': 'Verrouillé (formation)',
    },
    'ja-jp': {
      // Titles
      'OpenCTI - Cyber threat intelligence platform':
      ...
      Expired: '期限切れ',
      'Locked (security)': '施錠済み（セキュリティ)',
      'Locked (training)': 'ロック済み (トレーニング)',
    },
    'zh-cn': {
      // Titles
      'OpenCTI - Cyber threat intelligence platform':
      ...
      Expired: '已到期',
      'Locked (security)': '锁定（安全',
      'Locked (training)': '锁定（训练',
    },
    'en-us': {
      gt: 'Greater than',
      ...
      Inactive: 'Inactive',
      Expired: 'Expired',
      'Locked (security)': 'Locked (security)',
      'Locked (training)': 'Locked (training)',
    },
  },
};
