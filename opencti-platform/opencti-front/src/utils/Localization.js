const i18n = {
  messages: {
    'es-es': {
      ...
      filter_labelledBy_uneq: 'Sin Etiqueta',
    ...
    'fr-fr': {
      ...
      filter_labelledBy_uneq: 'Sans Label',
    ...
    'en-us': {
      ...
      filter_labelledBy: 'Label',
      filter_labelledBy_uneq: 'Without Label',
