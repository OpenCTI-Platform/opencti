const i18n = {
  messages: {
    fr: {
      ...
      'Create a individual': 'Créer une individualne',
      'Update a individual': 'Modifier une individualne',
      ...
      'observable_email-address': 'Email - Adresse email',
      'observable_email-subject': 'Email - Sujet',
      observable_mutex: 'Mutex',
      'observable_file-name': 'Fichier - Nom',
      'observable_file-path': 'Fichier - Chemin',
      'observable_file-md5': 'Fichier - Hash (MD5)',
      'observable_file-sha1': 'Fichier - Hash (SHA1)',
      'observable_file-sha256': 'Fichier - Hash (SHA256)',
      'observable_registry-key': 'Clé de registre - Clé',
      'observable_registry-key-value': 'Clé de registre - Valeur',
      'observable_pdb-path': 'PDB - Chemin',
      'observable_cryptocurrency-wallet': 'Cryptocurrency - Wallet',
      'observable_cryptographic-key': 'Cryptographie - Clé',
      observable_directory: 'Dossier',
      observable_text: 'Texte',
      observable_hostname: "Nom d'hôte",
      'observable_mac-addr': 'Adresse MAC',
      observable_process: 'Processus',
      'observable_user-account': 'Compte utilisateur',
      ...
      'motivation_organizational-gain': 'Avanlabele concurrentiel',
      'motivation_individualal-gain': 'Gain individuel',
      'motivation_individualal-satisfaction': 'Satisfaction individualnelle',
    ...
    en: {
      ...
      'observable_registry-key': 'Registry key - Key',
      'observable_registry-key-value': 'Registry key - Value',
      'observable_pdb-path': 'PDB - Path',
      'observable_cryptocurrency-wallet': 'Cryptocurrency - Wallet',
      'observable_cryptographic-key': 'Cryptography - Key',
      observable_directory: 'Directory',
      observable_text: 'Text',
      observable_hostname: 'Hostname',
      'observable_mac-addr': 'MAC Address',
      observable_process: 'Process',
      'observable_user-account': 'User account',
      'observable_user-agent': 'User agent',
      'observable_windows-scheduled-task': 'Win. scheduled task',
      'observable_windows-service-name': 'Win. service name',
      'observable_windows-service-display-name': 'Win. service display name',
      'observable_x509-certificate-issuer': 'X509 cert. - Issuer',
      'observable_x509-certificate-serial-number': 'X509 cert. - Serial num.',
      // Relations
