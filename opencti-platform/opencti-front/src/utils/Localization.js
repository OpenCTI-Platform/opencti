const i18n = {
  messages: {
    'es-es': {
      ...
      'Update an account': 'Actualizar una cuenta',
      'Do you want to delete this account?': '¿Quieres eliminar esta cuenta?',
      'Asset Name': 'Nombre del activo',
      'Asset Type': 'Tipo de activo',
      'Asset Value': 'Valor del activo',
      'Create a financial asset': 'Crear un activo financiero',
      'Update an asset': 'Actualizar un activo',
      'Do you want to delete this asset?': '¿Quieres eliminar este activo?',
      // Financial Account Types
      'Credit card': 'Tarjeta de crédito',
      'Cash management': 'Gestión de efectivo',
      'Certificate of deposit (CD)': 'Certificado de depósito (CD)',
      Checking: 'Comprobación',
      'Electronic benefit transfer (EBT)': 'Transferencia electrónica de beneficios (EBT)',
      'Health Savings Account (Depository) (HSA)': 'Cuenta de Ahorros de Salud (Depósito) (HSA)',
      'Money market': 'Mercado de dinero',
      'Prepaid debit card': 'Tarjeta de débito prepago',
      Savings: 'Ahorros',
      ...
      529: '529',
      Brokerage: 'Corretaje',
      'Cash individual savings account (ISA)': 'Cuenta de ahorro individual en efectivo (ISA)',
      'Education savings account': 'Cuenta de ahorro para la educación',
      'Fixed annuity': 'Anualidad fija',
      'Guaranteed investment certificate (GIC)': 'Certificado de inversión garantizado (GIC)',
      'Health reimbursement arrangement': 'Acuerdo de reembolso de salud',
      'Health savings account (Investment) (HSA)': 'Cuenta de ahorro para la salud (Inversión) (HSA)',
      'Individual retirement account (IRA)': 'Cuenta de retiro individual (IRA)',
      'Individual savings account (ISA)': 'Cuenta de ahorro individual (ISA)',
      Keogh: 'Keogh',
      'Life income fund (LIF)': 'Fondo de renta vitalicia (LIF)',
      'Life insurance': 'Seguro de vida',
      'Locked-in-retirement account (LIRA)': 'Cuenta de jubilación bloqueada (LIRA)',
      'Locked-in-retirement income fund (LRIF)': 'Fondo de ingresos de jubilación bloqueado (LRIF)',
      'Locked-in-retirement savings plan (LRSP)': 'Plan de ahorro para la jubilación bloqueado (LRSP)',
      'Mutual fund': 'Fondo de inversión',
      'Non-taxable brokerage account': 'Cuenta de corretaje no sujeta a impuestos',
      'Other annuity': 'Otra anualidad',
      'Other insurance': 'Otros seguros',
      'Other Investment': 'Otra inversión',
      Pension: 'Pensión',
      'Prescribed registered retirement income fund (PRIF)': 'Fondo de pensiones prescrito registrado (PRIF)',
      'Profit sharing plan': 'Plan de reparto de utilidades',
      'Qualifying share account (QSHR)': 'Cuenta de acciones calificadas (QSHR)',
      'Registered disability savings plan (RDSP)': 'Plan de ahorro por discapacidad registrado (RDSP)',
      'Registered education savings plan (RESP)': 'Plan de ahorro educativo registrado (RESP)',
      'Registered retirement income fund (RRIF)': 'Fondo registrado de rentas para el retiro (RRIF)',
      'Registered retirement savings plan (RRSP)': 'Plan de ahorro para el retiro registrado (RRSP)',
      'Restricted life income fund (RLIF)': 'Fondo de Renta Vitalicia Restringida (RLIF)',
      Retirement: 'Jubilación',
      'Roth 401k': 'Roth 401k',
      Roth: 'Roth',
      'Salary reduction simplified employee pension plan (SARSEP)': 'Plan simplificado de pensiones para empleados con reducción de salario (SARSEP)',
      'Self-invested personal pension (SIPP)': 'Pensión personal autoinvertida (SIPP)',
      'Simple individual retirement account (IRA)': 'Cuenta de Retiro Individual Simple (IRA)',
      'Simplified employee pension (SEP) individual retirement account (IRA)': 'Cuenta Individual de Retiro (IRA) de Pensión Simplificada de Empleados (SEP)',
      'Stock plan': 'plan de existencias',
      'Tax free savings account (TFSA)': 'Cuenta de ahorro libre de impuestos (TFSA)',
      'Thrift savings plan (TSP)': 'Plan de ahorro de ahorro (TSP)',
      Trust: 'Confianza',
      'Uniform gift to minors act (UGMA)': 'Ley uniforme de regalo a menores (UGMA)',
      'Uniform transfers to minors act (UTMA)': 'Ley Uniforme de Transferencias a Menores (UTMA)',
      'Variable annuity': 'Anualidad variable',
      'Auto loan': 'Auto préstamo',
      'Business loan': 'préstamo comercial',
      'Commercial loan': 'Préstamo comercial',
      'Construction loan': 'Préstamo de construcción',
      'Consumer loan': 'Créditos de consumo',
      'Home equity loan': 'Préstamo con garantía hipotecaria',
      'Line of credit': 'Línea de crédito',
      Loan: 'Préstamo',
      Mortgage: 'Hipoteca',
      'Other loan': 'Otro préstamo',
      Overdraft: 'Sobregiro',
      'Student loan': 'Préstamo estudiantil',
      Payroll: 'Nómina de sueldos',
      Recurring: 'Periódico',
      Rewards: 'Recompensas',
      'Safe deposit': 'Deposito de seguridad',
    ...
    'fr-fr': {
      ...
      Accounts: 'Comptes',
      Assets: 'Actifs',
      'The value must be a positive number': 'La valeur doit être un nombre positif',
      'As of Date': 'À la date',
      Balance: 'Équilibre',
      ...
      'Create a financial asset': 'Créer un actif financier',
      'Update an asset': 'Mettre à jour un actif',
      'Do you want to delete this asset?': 'Voulez-vous supprimer cet élément?',
      // Financial Account Types
      'Credit card': 'Carte de crédit',
      'Cash management': 'Gestion de la trésorerie',
      'Certificate of deposit (CD)': 'Certificat de dépôt (CD)',
      Checking: 'Vérification',
      'Electronic benefit transfer (EBT)': 'Transfert électronique des prestations (EBT)',
      'Health Savings Account (Depository) (HSA)': 'Compte d\'épargne santé (dépôt) (HSA)',
      'Money market': 'Marché monétaire',
      'Prepaid debit card': 'Carte de débit prépayée',
      ...
      529: '529',
      Brokerage: 'Courtage',
      'Cash individual savings account (ISA)': 'Cash Individual Savings Account (ISA)',
      'Education savings account': 'Compte d\'épargne-études',
      'Fixed annuity': 'rente fixe',
      'Guaranteed investment certificate (GIC)': 'Certificat de placement garanti (CPG)',
      'Health reimbursement arrangement': 'Modalité de remboursement santé',
      'Health savings account (Investment) (HSA)': 'Compte d\'épargne santé (Investissement) (HSA)',
      'Individual retirement account (IRA)': 'Compte de retraite individuel (IRA)',
      'Individual savings account (ISA)': 'Compte d\'épargne individuel (ISA)',
      Keogh: 'Keogh',
      'Life income fund (LIF)': 'Fonds de revenu viager (FRV)',
      'Life insurance': 'Assurance-vie',
      'Locked-in-retirement account (LIRA)': 'Compte de retraite immobilisé (CRI)',
      'Locked-in-retirement income fund (LRIF)': 'Fonds de revenu de retraite immobilisé (FRRI)',
      'Locked-in-retirement savings plan (LRSP)': 'Régime d\'épargne-retraite immobilisé (RERI)',
      'Mutual fund': 'Fonds communs de placement',
      'Non-taxable brokerage account': 'Compte de courtage non imposable',
      'Other annuity': 'Autre rente',
      'Other insurance': 'Autre assurance',
      'Other Investment': 'Autre investissement',
      Pension: 'Pension',
      'Prescribed registered retirement income fund (PRIF)': 'Fonds enregistré de revenu de retraite (FRRP) prescrit',
      'Profit sharing plan': "Régime d'intéressement",
      'Qualifying share account (QSHR)': 'Compte d\'actions éligibles (QSHR)',
      ...
      'Restricted life income fund (RLIF)': 'Fonds de revenu viager restreint (FRVR)',
      Retirement: 'Retraite',
      'Roth 401k': 'Roth 401k',
      Roth: 'Roth',
      'Salary reduction simplified employee pension plan (SARSEP)': 'Régime simplifié de retraite des salariés par réduction de salaire (SARSEP)',
      'Self-invested personal pension (SIPP)': 'Retraite personnelle auto-investie (SIPP)',
      'Simple individual retirement account (IRA)': 'Compte individuel de retraite simple (IRA)',
      'Simplified employee pension (SEP) individual retirement account (IRA)': 'Simplified Employee Pension (SEP) Compte de retraite individuel (IRA)',
      'Stock plan': 'Plan d\'actions',
      'Tax free savings account (TFSA)': 'Compte d\'épargne libre d\'impôt (CELI)',
      'Thrift savings plan (TSP)': 'Plan d\'épargne d\'épargne (TSP)',
      Trust: 'Confiance',
      'Uniform gift to minors act (UGMA)': 'Loi uniforme sur la donation aux mineurs (UGMA)',
      'Uniform transfers to minors act (UTMA)': 'Loi uniforme sur les transferts aux mineurs (UTMA)',
      'Variable annuity': 'rente variable',
      'Auto loan': 'Prêt automatique',
      'Business loan': 'Prêt commercial',
      'Commercial loan': 'Prêt commercial',
      'Construction loan': 'Prêt à la construction',
      'Consumer loan': 'Prêt à la consommation',
      'Home equity loan': 'Prêt sur valeur domiciliaire',
      'Line of credit': 'Ligne de credit',
      Loan: 'Prêt',
      Mortgage: 'Hypothèque',
      'Other loan': 'Autre prêt',
      Overdraft: 'Découvert',
      'Student loan': 'Prêt étudiant',
      Payroll: 'Paie',
      Recurring: 'Récurrent',
      Rewards: 'Récompenses',
      'Safe deposit': 'Coffre-fort',
    ...
    'ja-jp': {
      ...
      Accounts: 'アカウント',
      Assets: '資産',
      'The value must be a positive number': '値は正の数である必要があります',
      'As of Date': '日付現在',
      Balance: 'バランス',
      'Add Balance': '残高を追加',
      'Currency Code': '通貨コード',
      ...
      'Update an account': 'アカウントを更新する',
      'Do you want to delete this account?': 'このアカウントを削除しますか?',
      'Asset Name': 'アセット名',
      'Asset Type': '資産タイプ',
      'Asset Value': '資産価値',
      'Create a financial asset': '金融資産を作成する',
      'Update an asset': 'アセットを更新する',
      'Do you want to delete this asset?': 'このアセットを削除しますか?',
      // Financial Account Types
      'Credit card': 'クレジットカード',
      'Cash management': '現金管理',
      'Certificate of deposit (CD)': '預金証書（CD）',
      Checking: 'チェック中',
      'Electronic benefit transfer (EBT)': '電子特典移転 (EBT)',
      'Health Savings Account (Depository) (HSA)': '健康貯蓄口座 (預金口座) (HSA)',
      'Money market': '金融市場',
      'Prepaid debit card': 'プリペイドデビットカード',
      Savings: '貯蓄',
      ...
      529: '529',
      Brokerage: '仲介',
      'Cash individual savings account (ISA)': '現金個人普通預金口座 (ISA)',
      'Education savings account': '教育貯蓄口座',
      'Fixed annuity': '定額年金',
      'Guaranteed investment certificate (GIC)': '投資保証証書（GIC）',
      'Health reimbursement arrangement': '健康保険の払い戻しの取り決め',
      'Health savings account (Investment) (HSA)': '健康貯蓄口座 (投資) (HSA)',
      'Individual retirement account (IRA)': '個人退職金口座 (IRA)',
      'Individual savings account (ISA)': '個人普通預金口座 (ISA)',
      Keogh: 'キーオ',
      'Life income fund (LIF)': 'ライフインカムファンド（LIF）',
      'Life insurance': '生命保険',
      'Locked-in-retirement account (LIRA)': 'ロックイン退職口座 (LIRA)',
      'Locked-in-retirement income fund (LRIF)': 'ロックイン退職所得基金 (LRIF)',
      'Locked-in-retirement savings plan (LRSP)': 'ロックイン退職貯蓄プラン (LRSP)',
      'Mutual fund': '投資信託',
      'Non-taxable brokerage account': '非課税の証券口座',
      'Other annuity': 'その他の年金',
      'Other insurance': 'その他の保険',
      'Other Investment': 'その他の投資',
      Pension: '年金',
      'Prescribed registered retirement income fund (PRIF)': '所定の登録退職所得基金 (PRIF)',
      'Profit sharing plan': '利益分配計画',
      'Qualifying share account (QSHR)': '適格株式口座 (QSHR)',
      'Registered disability savings plan (RDSP)': '登録障害者貯蓄プラン (RDSP)',
      'Registered education savings plan (RESP)': '登録型教育貯蓄プラン (RESP)',
      'Registered retirement income fund (RRIF)': '登録退職所得基金 (RRIF)',
      'Registered retirement savings plan (RRSP)': '登録退職貯蓄プラン (RRSP)',
      'Restricted life income fund (RLIF)': '制限付き生涯収入基金 (RLIF)',
      Retirement: '退職',
      'Roth 401k': 'ロス401k',
      Roth: 'ロス',
      'Salary reduction simplified employee pension plan (SARSEP)': '給与軽減型簡易厚生年金制度（SARSEP）',
      'Self-invested personal pension (SIPP)': '自己投資型個人年金（SIPP）',
      'Simple individual retirement account (IRA)': '簡易個人退職金口座（IRA）',
      'Simplified employee pension (SEP) individual retirement account (IRA)': '簡易厚生年金（SEP）個人退職金口座（IRA）',
      'Stock plan': 'ストックプラン',
      'Tax free savings account (TFSA)': '免税普通預金口座 (TFSA)',
      'Thrift savings plan (TSP)': '倹約貯蓄プラン (TSP)',
      Trust: '信頼',
      'Uniform gift to minors act (UGMA)': '未成年者への制服贈与法 (UGMA)',
      'Uniform transfers to minors act (UTMA)': '未成年者への制服移転法 (UTMA)',
      'Variable annuity': '変額年金',
      'Auto loan': 'オートローン',
      'Business loan': 'ビジネスローン',
      'Commercial loan': '商業ローン',
      'Construction loan': '建設融資',
      'Consumer loan': '消費者金融',
      'Home equity loan': 'ホームエクイティローン',
      'Line of credit': '信用限度額',
      Loan: 'ローン',
      Mortgage: 'モーゲージ',
      'Other loan': 'その他のローン',
      Overdraft: '当座貸越',
    ...
    'zh-cn': {
      ...
      Accounts: '账户',
      Assets: '资产',
      'The value must be a positive number': '该值必须是正数',
      'As of Date': '截至日期',
      Balance: '平衡',
      'Add Balance': '添加余额',
      'Currency Code': '货币代码',
      ...
      'Account Type': '帐户类型',
      'Account Number': '帐号',
      'International Bank Account Number': '国际银行帐号',
      IBAN: '国际银行账号',
      'Account Balances': '账户余额',
      'Update an account': '更新帐户',
      'Do you want to delete this account?': '您想删除该帐户吗？',
      'Asset Name': '资产名称',
      'Asset Type': '资产类型',
      'Asset Value': '资产值',
      'Create a financial asset': '创建金融资产',
      'Update an asset': '更新资产',
      'Do you want to delete this asset?': '您想删除该资产吗？',
      // Financial Account Types
      'Credit card': '信用卡',
      'Cash management': '现金管理',
      'Certificate of deposit (CD)': '存款证 (CD)',
      Checking: '检查',
      'Electronic benefit transfer (EBT)': '电子福利转移 (EBT)',
      'Health Savings Account (Depository) (HSA)': '健康储蓄账户 (存款) (HSA)',
      'Money market': '货币市场',
      'Prepaid debit card': '预付借记卡',
      Savings: '储蓄',
      'Digital Wallet': '数字钱包',
      '401a': '401a',
      '401k': '401k',
      ...
      529: '529',
      Brokerage: '经纪业务',
      'Cash individual savings account (ISA)': '现金个人储蓄账户 (ISA)',
      'Education savings account': '教育储蓄账户',
      'Fixed annuity': '固定年金',
      'Guaranteed investment certificate (GIC)': '担保投资证书 (GIC)',
      'Health reimbursement arrangement': '医疗报销安排',
      'Health savings account (Investment) (HSA)': '健康储蓄账户 (投资) (HSA)',
      'Individual retirement account (IRA)': '个人退休账户 (IRA)',
      'Individual savings account (ISA)': '个人储蓄账户 (ISA)',
      Keogh: '基奥',
      'Life income fund (LIF)': '人寿收入基金 (LIF)',
      'Life insurance': '人寿保险',
      'Locked-in-retirement account (LIRA)': '锁定退休账户 (LIRA)',
      'Locked-in-retirement income fund (LRIF)': '锁定退休收入基金 (LRIF)',
      'Locked-in-retirement savings plan (LRSP)': '锁定退休储蓄计划 (LRSP)',
      'Mutual fund': '共同基金',
      'Non-taxable brokerage account': '免税经纪账户',
      'Other annuity': '其他年金',
      'Other insurance': '其他保险',
      'Other Investment': '其他投资',
      Pension: '养老金',
      'Prescribed registered retirement income fund (PRIF)': '规定的注册退休收入基金 (PRIF)',
      'Profit sharing plan': '利润分享计划',
      'Qualifying share account (QSHR)': '合格股票账户 (QSHR)',
      'Registered disability savings plan (RDSP)': '注册残障储蓄计划 (RDSP)',
      'Registered education savings plan (RESP)': '注册教育储蓄计划 (RESP)',
      'Registered retirement income fund (RRIF)': '注册退休收入基金 (RRIF)',
      'Registered retirement savings plan (RRSP)': '注册退休储蓄计划 (RRSP)',
      'Restricted life income fund (RLIF)': '限制性终身收入基金 (RLIF)',
      Retirement: '退休',
      'Roth 401k': '罗斯401k',
      Roth: '罗斯',
      'Salary reduction simplified employee pension plan (SARSEP)': '减薪简化雇员养老金计划 (SARSEP)',
      'Self-invested personal pension (SIPP)': '自投资个人养老金 (SIPP)',
      'Simple individual retirement account (IRA)': '简单个人退休账户 (IRA)',
      'Simplified employee pension (SEP) individual retirement account (IRA)': '简化雇员养老金 (SEP)个人退休账户 (IRA)',
      'Stock plan': '股票计划',
      'Tax free savings account (TFSA)': '免税储蓄账户 (TFSA)',
      'Thrift savings plan (TSP)': '节俭储蓄计划 (TSP)',
      Trust: '相信',
      'Uniform gift to minors act (UGMA)': '向未成年人提供统一礼物法案 (UGMA)',
      'Uniform transfers to minors act (UTMA)': '未成年人统一转让法案 (UTMA)',
...
export function valToKey(value, dict, preset = 'Unknown') {
  return Object.values(dict)[Object.keys(dict).indexOf(value)] || preset;
}
