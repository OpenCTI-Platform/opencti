const i18n = {
  messages: {
    'es-es': {
      ...
      'Create a dashboard': 'Crear un cuadro de mando',
      'Create an investigation': 'Crear una investigación',
    ...
    'fr-fr': {
      ...
      'Create an investigation': 'Créer une investigation',
    ...
    'ja-jp': {
      ...
      'Create a dashboard': 'ダッシュボードの作成',
      'Create an investigation': '調査を行う',
